# [A-295] Intelligence: PersonalRanker.swift expressiveness
...
Expressiveness in `PersonalRanker.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `CitationVerifierTests.swift`.
