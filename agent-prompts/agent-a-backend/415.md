# [A-415] Regression: ActionExtractor.swift edge case #415
...
Regression hardening for `ActionExtractor.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `IngestIndexTests.swift` edge case #415. Must fail on prior commit, pass now.
