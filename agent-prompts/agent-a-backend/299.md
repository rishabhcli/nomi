# [A-299] Intelligence: ResponseStyle.swift expressiveness
...
Expressiveness in `ResponseStyle.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `IngestIndexTests.swift`.
