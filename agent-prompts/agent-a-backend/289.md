# [A-289] Intelligence: QueryRewriter.swift expressiveness
...
Expressiveness in `QueryRewriter.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `CommandParserTests.swift`.
