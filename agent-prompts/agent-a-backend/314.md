# [A-314] Intelligence: Router.swift expressiveness
...
Expressiveness in `Router.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `SpanResolverTests.swift`.
