# [A-025] Foundation audit: Profile.swift
...
Add doc comment to every public type in `Profile.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/CharSpanTests.swift`
