# [A-003] Foundation audit: RouterEscalator.swift
...
Verify `RouterEscalator.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `StateMachineTests.swift`.
