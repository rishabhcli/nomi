# [A-458] Beats-Siri: Provenance.swift offline synthesis
...
Beats-Siri gate for `Provenance.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #458.
