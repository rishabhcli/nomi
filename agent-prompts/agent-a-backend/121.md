# [A-121] Grounding: IngestGate.swift citation integrity
...
Raise retrieval/citation quality in `IngestGate.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `CitationVerifierTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/IngestGate.swift`
