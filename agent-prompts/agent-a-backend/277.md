# [A-277] Consolidation: IngestGate.swift dreaming safety
...
Consolidation pass in `IngestGate.swift`: dreaming must not duplicate syntheses, must cite constituents, and must remain subject to M5 verification. Regression in `EgressHostAndCitationTests.swift`.
