# [A-246] Consolidation: TimelineBuilder.swift dreaming safety
...
Consolidation pass in `TimelineBuilder.swift`: dreaming must not duplicate syntheses, must cite constituents, and must remain subject to M5 verification. Regression in `InspectorTests.swift`.
