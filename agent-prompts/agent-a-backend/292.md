# [A-292] Intelligence: AdaptiveEffort.swift expressiveness
...
Expressiveness in `AdaptiveEffort.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `QueryLifecycleTests.swift`.
