# [A-408] Regression: EntityExtractor.swift edge case #408
...
Regression hardening for `EntityExtractor.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `QueryLifecycleTests.swift` edge case #408. Must fail on prior commit, pass now.
