# [A-311] Intelligence: ActionExtractor.swift expressiveness
...
Expressiveness in `ActionExtractor.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `IntelligenceTests.swift`.
