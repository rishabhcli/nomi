# [A-005] Foundation audit: EngineClient.swift
...
Add doc comment to every public type in `EngineClient.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/CitationVerifierTests.swift`
