# [A-431] Regression: OllamaClient.swift edge case #431
...
Regression hardening for `OllamaClient.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `CharSpanTests.swift` edge case #431. Must fail on prior commit, pass now.
