# [A-309] Intelligence: Coverage.swift expressiveness
...
Expressiveness in `Coverage.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `HelpfulnessTests.swift`.
