# [A-033] Foundation audit: AnswerCache.swift
...
Verify `AnswerCache.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `RouterTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/RouterTests.swift`
