# [A-320] Intelligence: SpanResolver.swift expressiveness
...
Expressiveness in `SpanResolver.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `QueryServiceTests.swift`.
