# [A-468] Beats-Siri: CorpusSuggester.swift offline synthesis
...
Beats-Siri gate for `CorpusSuggester.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #468.
