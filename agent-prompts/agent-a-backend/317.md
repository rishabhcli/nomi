# [A-317] Intelligence: EngineClient.swift expressiveness
...
Expressiveness in `EngineClient.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `ProfileTests.swift`.
