# [A-402] Regression: TimelineBuilder.swift edge case #402
...
Regression hardening for `TimelineBuilder.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `CharSpanTests.swift` edge case #402. Must fail on prior commit, pass now.
