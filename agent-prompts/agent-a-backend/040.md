# [A-040] Foundation audit: FollowUp.swift
...
Add doc comment to every public type in `FollowUp.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
