# [A-319] Intelligence: CitationVerifier.swift expressiveness
...
Expressiveness in `CitationVerifier.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `NotchReducerTests.swift`.
