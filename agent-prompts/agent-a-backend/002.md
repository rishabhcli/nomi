# [A-002] Foundation audit: Router.swift
...
Audit `Router.swift` for force-unwraps, `try!`, and silent empty catch blocks — eliminate any that could surface as empty UI on the query path.
