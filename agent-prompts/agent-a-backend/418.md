# [A-418] Regression: Router.swift edge case #418
...
Regression hardening for `Router.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `MemoryDynamicsTests.swift` edge case #418. Must fail on prior commit, pass now.
