# [A-291] Intelligence: ScopeClassifier.swift expressiveness
...
Expressiveness in `ScopeClassifier.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `QueryServiceTests.swift`.
