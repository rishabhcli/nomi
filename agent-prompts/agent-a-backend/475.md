# [A-475] Beats-Siri: CitationVerifier.swift offline synthesis
...
Beats-Siri gate for `CitationVerifier.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #475.
