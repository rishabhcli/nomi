# [A-300] Intelligence: FollowUp.swift expressiveness
...
Expressiveness in `FollowUp.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `IngestGateTests.swift`.
