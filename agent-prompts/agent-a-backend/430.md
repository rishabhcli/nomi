# [A-430] Regression: Prompt.swift edge case #430
...
Regression hardening for `Prompt.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `SpanResolverTests.swift` edge case #430. Must fail on prior commit, pass now.
