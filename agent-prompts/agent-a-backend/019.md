# [A-019] Foundation audit: ContentHash.swift
...
Ensure `ContentHash.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/HelpfulnessTests.swift`
