# [A-004] Foundation audit: EvidenceGathering.swift
...
Ensure `EvidenceGathering.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
