# [A-147] Grounding: CommandParser.swift citation integrity
...
Raise retrieval/citation quality in `CommandParser.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `QueryLifecycleTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/CommandParser.swift`
