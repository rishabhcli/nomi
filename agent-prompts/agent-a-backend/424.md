# [A-424] Regression: SpanResolver.swift edge case #424
...
Regression hardening for `SpanResolver.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `BugfixRegressionTests.swift` edge case #424. Must fail on prior commit, pass now.
