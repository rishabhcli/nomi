# [A-414] Regression: Highlight.swift edge case #414
...
Regression hardening for `Highlight.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `AgenticGrepTests.swift` edge case #414. Must fail on prior commit, pass now.
