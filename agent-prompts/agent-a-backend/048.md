# [A-048] Fix: 38% engine documents in error state
...
Surface per-document extraction failures and retry policy without blocking interactive queries.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/HelpfulnessTests.swift`
