# [A-293] Intelligence: AnswerCache.swift expressiveness
...
Expressiveness in `AnswerCache.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `StateMachineTests.swift`.
