# [A-056] Beats-Siri: EvidenceGathering.swift offline synthesis

| Field | Value |
|-------|-------|
| **Queue position** | 56 of 500 (chronological — do not skip) |
| **Agent** | A — Backend / Orchestrator |
| **Phase** | P0/P1 Correctness — Fix data-loss risks, grounding bugs, egress edge cases |
| **Priority** | P1 |
...
Beats-Siri gate for `EvidenceGathering.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #56.
