# [A-420] Regression: EvidenceGathering.swift edge case #420
...
Regression hardening for `EvidenceGathering.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `InspectorTests.swift` edge case #420. Must fail on prior commit, pass now.
