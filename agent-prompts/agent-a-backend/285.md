# [A-285] Intelligence: Profile.swift expressiveness
...
Expressiveness in `Profile.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `SpanResolverTests.swift`.
