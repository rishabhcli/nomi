# [A-436] Regression: MemoryDynamics.swift edge case #436
...
Regression hardening for `MemoryDynamics.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `QueryServiceTests.swift` edge case #436. Must fail on prior commit, pass now.
