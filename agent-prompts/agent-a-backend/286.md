# [A-286] Intelligence: EgressGuard.swift expressiveness
...
Expressiveness in `EgressGuard.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `CharSpanTests.swift`.
