# [A-158] Grounding: Router.swift citation integrity
...
Raise retrieval/citation quality in `Router.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `ConsolidationTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/Router.swift`
