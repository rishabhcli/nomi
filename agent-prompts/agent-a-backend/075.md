# [A-075] Beats-Siri: LLMSynthesizer.swift offline synthesis
...
Beats-Siri gate for `LLMSynthesizer.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #75.
