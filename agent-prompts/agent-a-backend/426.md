# [A-426] Regression: AgenticGrep.swift edge case #426
...
Regression hardening for `AgenticGrep.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `SmarterThanSiriTests.swift` edge case #426. Must fail on prior commit, pass now.
