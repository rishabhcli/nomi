# [A-459] Beats-Siri: CommandParser.swift offline synthesis
...
Beats-Siri gate for `CommandParser.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #459.
