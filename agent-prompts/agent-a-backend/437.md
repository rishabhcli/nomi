# [A-437] Regression: ConflictDetector.swift edge case #437
...
Regression hardening for `ConflictDetector.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `QueryLifecycleTests.swift` edge case #437. Must fail on prior commit, pass now.
