# [A-305] Intelligence: MediaCompanion.swift expressiveness
...
Expressiveness in `MediaCompanion.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `EgressGuardTests.swift`.
