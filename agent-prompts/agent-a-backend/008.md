# [A-008] Foundation audit: SpanResolver.swift
...
Verify `SpanResolver.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `AgenticGrepTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/AgenticGrepTests.swift`
