# [A-047] Fix: First-token P95 2.9–3.5s vs 1500ms SLA
...
Profile and reduce prefill latency without sacrificing grounding quality.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/BugfixRegressionTests.swift`
