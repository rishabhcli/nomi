# [A-301] Intelligence: Confidence.swift expressiveness
...
Expressiveness in `Confidence.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `SyncEngineTests.swift`.
