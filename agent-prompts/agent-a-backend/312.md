# [A-312] Intelligence: CorpusSuggester.swift expressiveness
...
Expressiveness in `CorpusSuggester.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `ExpressivenessTests.swift`.
