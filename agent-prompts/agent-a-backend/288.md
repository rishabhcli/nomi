# [A-288] Intelligence: NotchReducer.swift expressiveness
...
Expressiveness in `NotchReducer.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `ProfileTests.swift`.
