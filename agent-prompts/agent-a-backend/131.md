# [A-131] Grounding: WorkScheduler.swift citation integrity
...
Raise retrieval/citation quality in `WorkScheduler.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `EgressGuardTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/WorkScheduler.swift`
