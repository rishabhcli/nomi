# [A-029] Foundation audit: QueryRewriter.swift
...
Ensure `QueryRewriter.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/NotchReducerTests.swift`
