# [A-412] Regression: Preferences.swift edge case #412
...
Regression hardening for `Preferences.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `EngineClientTests.swift` edge case #412. Must fail on prior commit, pass now.
