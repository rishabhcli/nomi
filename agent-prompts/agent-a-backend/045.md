# [A-045] Fix: QueryService abs(q0.hashValue) traps on Int.min
...
Replace with overflow-safe hashing for cache keys.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/EgressHostAndCitationTests.swift`
