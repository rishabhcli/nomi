# [A-024] Foundation audit: Inspector.swift
...
Ensure `Inspector.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/SpanResolverTests.swift`
