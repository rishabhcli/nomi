# [A-058] Beats-Siri: EngineIntegration.swift offline synthesis
...
Beats-Siri gate for `EngineIntegration.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #58.
