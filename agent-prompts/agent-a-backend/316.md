# [A-316] Intelligence: EvidenceGathering.swift expressiveness
...
Expressiveness in `EvidenceGathering.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `DocumentsTests.swift`.
