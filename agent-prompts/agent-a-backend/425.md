# [A-425] Regression: CharSpan.swift edge case #425
...
Regression hardening for `CharSpan.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `HelpfulnessTests.swift` edge case #425. Must fail on prior commit, pass now.
