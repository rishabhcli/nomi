# [A-446] Beats-Siri: QueryDecomposer.swift offline synthesis
...
Beats-Siri gate for `QueryDecomposer.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #446.
