# [A-039] Foundation audit: ResponseStyle.swift
...
Ensure `ResponseStyle.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
