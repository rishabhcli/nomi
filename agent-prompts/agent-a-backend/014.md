# [A-014] Foundation audit: Prompt.swift
...
Ensure `Prompt.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/InspectorTests.swift`
