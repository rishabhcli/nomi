# [A-306] Intelligence: LocalExtractor.swift expressiveness
...
Expressiveness in `LocalExtractor.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `EgressHostAndCitationTests.swift`.
