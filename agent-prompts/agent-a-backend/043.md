# [A-043] Fix: LexicalContradiction only handles location/employment predicates
...
Extend contradiction detection to temporal, numeric, and relationship predicates without false-positive supersession storms.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/InspectorTests.swift`
