# [A-294] Intelligence: QueryHistory.swift expressiveness
...
Expressiveness in `QueryHistory.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `RouterTests.swift`.
