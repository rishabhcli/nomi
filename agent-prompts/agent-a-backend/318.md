# [A-318] Intelligence: EngineIntegration.swift expressiveness
...
Expressiveness in `EngineIntegration.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `CommandParserTests.swift`.
