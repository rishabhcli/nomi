# [A-042] Fix: SuppressionLedger exact-text match resurrects re-ingested facts
...
Implement normalized/fuzzy keying so semantically identical facts stay suppressed after re-extraction with different wording.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/ConsolidationTests.swift`
