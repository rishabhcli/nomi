# [A-046] Fix: AgenticGrep returns (unknown) filepaths from SMFS
...
Map SMFS semantic hits to real filesystem paths via ingest index.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/SchedulerTests.swift`
