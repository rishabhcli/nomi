# [A-409] Regression: MediaCompanion.swift edge case #409
...
Regression hardening for `MediaCompanion.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `StateMachineTests.swift` edge case #409. Must fail on prior commit, pass now.
