# [A-030] Foundation audit: QueryDecomposer.swift
...
Add doc comment to every public type in `QueryDecomposer.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
