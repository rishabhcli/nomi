# [A-015] Foundation audit: OllamaClient.swift
...
Add doc comment to every public type in `OllamaClient.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/EgressGuardTests.swift`
