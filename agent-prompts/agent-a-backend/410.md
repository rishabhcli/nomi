# [A-410] Regression: LocalExtractor.swift edge case #410
...
Regression hardening for `LocalExtractor.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `RouterTests.swift` edge case #410. Must fail on prior commit, pass now.
