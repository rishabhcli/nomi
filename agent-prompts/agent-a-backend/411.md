# [A-411] Regression: Digest.swift edge case #411
...
Regression hardening for `Digest.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `CitationVerifierTests.swift` edge case #411. Must fail on prior commit, pass now.
