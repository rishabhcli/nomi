# [A-287] Intelligence: WorkScheduler.swift expressiveness
...
Expressiveness in `WorkScheduler.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `DocumentsTests.swift`.
