# [A-401] Regression: TimeWindow.swift edge case #401
...
Regression hardening for `TimeWindow.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `SpanResolverTests.swift` edge case #401. Must fail on prior commit, pass now.
