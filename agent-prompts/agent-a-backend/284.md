# [A-284] Intelligence: Inspector.swift expressiveness
...
Expressiveness in `Inspector.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `HopPlannerTests.swift`.
