# [A-023] Foundation audit: LLMSynthesizer.swift
...
Verify `LLMSynthesizer.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `HopPlannerTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/HopPlannerTests.swift`
