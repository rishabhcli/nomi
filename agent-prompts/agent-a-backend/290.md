# [A-290] Intelligence: QueryDecomposer.swift expressiveness
...
Expressiveness in `QueryDecomposer.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `NotchReducerTests.swift`.
