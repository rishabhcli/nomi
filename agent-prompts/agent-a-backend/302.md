# [A-302] Intelligence: Provenance.swift expressiveness
...
Expressiveness in `Provenance.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `MemoryDynamicsTests.swift`.
