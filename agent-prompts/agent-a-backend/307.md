# [A-307] Intelligence: Digest.swift expressiveness
...
Expressiveness in `Digest.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `SchedulerTests.swift`.
