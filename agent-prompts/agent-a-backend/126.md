# [A-126] Grounding: Consolidation.swift citation integrity
...
Raise retrieval/citation quality in `Consolidation.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `IngestGateTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/Consolidation.swift`
