# [A-421] Regression: EngineClient.swift edge case #421
...
Regression hardening for `EngineClient.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `EgressGuardTests.swift` edge case #421. Must fail on prior commit, pass now.
