# [A-152] Grounding: Preferences.swift citation integrity
...
Raise retrieval/citation quality in `Preferences.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `EngineIntegrationTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/Preferences.swift`
