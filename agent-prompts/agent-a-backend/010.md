# [A-010] Foundation audit: AgenticGrep.swift
...
Add doc comment to every public type in `AgenticGrep.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/IngestGateTests.swift`
