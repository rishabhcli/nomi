# [A-028] Foundation audit: NotchReducer.swift
...
Verify `NotchReducer.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `CommandParserTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/CommandParserTests.swift`
