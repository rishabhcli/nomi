# [A-406] Regression: Provenance.swift edge case #406
...
Regression hardening for `Provenance.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `NotchReducerTests.swift` edge case #406. Must fail on prior commit, pass now.
