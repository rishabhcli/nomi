# [A-432] Regression: Ingestion.swift edge case #432
...
Regression hardening for `Ingestion.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `DocumentsTests.swift` edge case #432. Must fail on prior commit, pass now.
