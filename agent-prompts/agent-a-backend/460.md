# [A-460] Beats-Siri: EntityExtractor.swift offline synthesis
...
Beats-Siri gate for `EntityExtractor.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #460.
