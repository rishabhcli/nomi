# [A-283] Intelligence: LLMSynthesizer.swift expressiveness
...
Expressiveness in `LLMSynthesizer.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `ExpressivenessTests.swift`.
