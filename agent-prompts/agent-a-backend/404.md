# [A-404] Regression: FollowUp.swift edge case #404
...
Regression hardening for `FollowUp.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `ProfileTests.swift` edge case #404. Must fail on prior commit, pass now.
