# [A-413] Regression: Coverage.swift edge case #413
...
Regression hardening for `Coverage.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `EngineIntegrationTests.swift` edge case #413. Must fail on prior commit, pass now.
