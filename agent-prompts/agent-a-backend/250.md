# [A-250] Consolidation: Provenance.swift dreaming safety
...
Consolidation pass in `Provenance.swift`: dreaming must not duplicate syntheses, must cite constituents, and must remain subject to M5 verification. Regression in `BugfixRegressionTests.swift`.
