# [A-154] Grounding: Highlight.swift citation integrity
...
Raise retrieval/citation quality in `Highlight.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `IngestIndexTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/Highlight.swift`
