# [A-282] Intelligence: Consolidation.swift expressiveness
...
Expressiveness in `Consolidation.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `IntelligenceTests.swift`.
