# [A-315] Intelligence: RouterEscalator.swift expressiveness
...
Expressiveness in `RouterEscalator.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `CharSpanTests.swift`.
