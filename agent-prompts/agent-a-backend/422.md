# [A-422] Regression: EngineIntegration.swift edge case #422

| Field | Value |
|-------|-------|
| **Queue position** | 422 of 500 (chronological — do not skip) |
| **Agent** | A — Backend / Orchestrator |
| **Phase** | Regression Hardening — BugfixRegressionTests, use-case failures, edge cases |
| **Priority** | P3 |
...
Regression hardening for `EngineIntegration.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `EgressHostAndCitationTests.swift` edge case #422. Must fail on prior commit, pass now.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/BugfixRegressionTests.swift`
