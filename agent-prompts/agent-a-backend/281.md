# [A-281] Intelligence: ConflictDetector.swift expressiveness
...
Expressiveness in `ConflictDetector.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `SmarterThanSiriTests.swift`.
