# [A-499] Beats-Siri: ScopeClassifier.swift offline synthesis
...
Beats-Siri gate for `ScopeClassifier.swift`: cross-document offline synthesis with verified citations and zero egress. Capture evidence via `mnemoctl ask --verify` transcript for prompt #499.
