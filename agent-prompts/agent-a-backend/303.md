# [A-303] Intelligence: CommandParser.swift expressiveness
...
Expressiveness in `CommandParser.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `ConsolidationTests.swift`.
