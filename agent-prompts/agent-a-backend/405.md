# [A-405] Regression: Confidence.swift edge case #405
...
Regression hardening for `Confidence.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `CommandParserTests.swift` edge case #405. Must fail on prior commit, pass now.
