# [A-009] Foundation audit: CharSpan.swift
...
Ensure `CharSpan.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
