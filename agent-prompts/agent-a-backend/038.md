# [A-038] Foundation audit: TimelineBuilder.swift
...
Verify `TimelineBuilder.swift` never constructs a URL with a non-loopback host. Add invariant assertion test in `InvariantTests` or `IngestIndexTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/IngestIndexTests.swift`
