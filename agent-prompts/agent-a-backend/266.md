# [A-266] Consolidation: EngineIntegration.swift dreaming safety

| Field | Value |
|-------|-------|
| **Queue position** | 266 of 500 (chronological — do not skip) |
| **Agent** | A — Backend / Orchestrator |
| **Phase** | Consolidation — Dreaming, synthesis dedup, cold archive, profile promotion |
| **Priority** | P2 |
...
Consolidation pass in `EngineIntegration.swift`: dreaming must not duplicate syntheses, must cite constituents, and must remain subject to M5 verification. Regression in `CitationVerifierTests.swift`.
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoOrchestratorTests/ConsolidationTests.swift`
