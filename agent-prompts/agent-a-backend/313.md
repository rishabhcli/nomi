# [A-313] Intelligence: QueryService.swift expressiveness
...
Expressiveness in `QueryService.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `HopPlannerTests.swift`.
