# [A-428] Regression: LLMHopPlanner.swift edge case #428
...
Regression hardening for `LLMHopPlanner.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `ExpressivenessTests.swift` edge case #428. Must fail on prior commit, pass now.
