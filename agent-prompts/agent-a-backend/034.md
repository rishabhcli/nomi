# [A-034] Foundation audit: QueryHistory.swift
...
Ensure `QueryHistory.swift` logs nothing at info level that could contain user document text. Redact or downgrade to debug.
