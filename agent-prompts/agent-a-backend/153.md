# [A-153] Grounding: Coverage.swift citation integrity
...
Raise retrieval/citation quality in `Coverage.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `AgenticGrepTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/Coverage.swift`
