# [A-304] Intelligence: EntityExtractor.swift expressiveness
...
Expressiveness in `EntityExtractor.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `InspectorTests.swift`.
