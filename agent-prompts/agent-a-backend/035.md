# [A-035] Foundation audit: PersonalRanker.swift
...
Add doc comment to every public type in `PersonalRanker.swift` explaining its single responsibility and which milestone (M1–M12) it serves.
