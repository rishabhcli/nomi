# [A-308] Intelligence: Preferences.swift expressiveness
...
Expressiveness in `Preferences.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `BugfixRegressionTests.swift`.
