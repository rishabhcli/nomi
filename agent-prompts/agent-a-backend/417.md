# [A-417] Regression: QueryService.swift edge case #417
...
Regression hardening for `QueryService.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `SyncEngineTests.swift` edge case #417. Must fail on prior commit, pass now.
