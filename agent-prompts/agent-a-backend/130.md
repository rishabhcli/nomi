# [A-130] Grounding: EgressGuard.swift citation integrity
...
Raise retrieval/citation quality in `EgressGuard.swift`: char-offset spans must resolve to real corpus text; unsupported sentences must reach `.unsupportedAnswer`. Add deterministic fixture test in `InspectorTests.swift`.
...
**Primary targets:** `Sources/MnemoOrchestrator/EgressGuard.swift`
