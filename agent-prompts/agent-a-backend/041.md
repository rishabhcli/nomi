# [A-041] Fix: SelfHeal.orphanedMemoryIds deletes source-less consolidation memories
...
Exempt syntheses, promoted facts, and manual `memory add` entries from orphan GC; add regression test proving they survive `sync self-heal`.
...
- [ ] New/changed behavior has automated test coverage: Add or extend `Tests/MnemoOrchestratorTests/MemoryDynamicsTests.swift`
