# [A-298] Intelligence: TimelineBuilder.swift expressiveness
...
Expressiveness in `TimelineBuilder.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `AgenticGrepTests.swift`.
