# [A-407] Regression: CommandParser.swift edge case #407
...
Regression hardening for `CommandParser.swift`: add case to `BugfixRegressionTests.swift` for a fixed 2026-07-09 audit item or `QueryServiceTests.swift` edge case #407. Must fail on prior commit, pass now.
