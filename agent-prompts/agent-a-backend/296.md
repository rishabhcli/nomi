# [A-296] Intelligence: NumericReasoner.swift expressiveness
...
Expressiveness in `NumericReasoner.swift`: timeline/table/bullet shaping for cross-doc synthesis; beat Siri's PCC-dependent synthesis offline. Add case to `SmarterThanSiriTests` or `EngineClientTests.swift`.
