# [C-429] Integration probe: stack health #29
...
Live stack probe #29: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
