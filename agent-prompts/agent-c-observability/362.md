# [C-362] Debug hooks: headless verification #2
...
Diagnostics #2: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
