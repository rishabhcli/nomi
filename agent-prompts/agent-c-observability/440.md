# [C-440] Integration probe: stack health #40
...
Live stack probe #40: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
