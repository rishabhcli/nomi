# [C-477] CI gate: operational excellence #37
...
Operational gate #37: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
