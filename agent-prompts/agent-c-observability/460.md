# [C-460] CI gate: operational excellence #20
...
Operational gate #20: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
