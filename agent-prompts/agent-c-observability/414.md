# [C-414] Integration probe: stack health #14
...
Live stack probe #14: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
