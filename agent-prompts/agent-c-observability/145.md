# [C-145] Privacy: egress measurement hardening #25

| Field | Value |
|-------|-------|
| **Queue position** | 145 of 500 (chronological — do not skip) |
...
Egress observability #25: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
