# [C-137] Privacy: egress measurement hardening #17

| Field | Value |
|-------|-------|
| **Queue position** | 137 of 500 (chronological — do not skip) |
...
Egress observability #17: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
