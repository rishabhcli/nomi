# [C-333] Docs: restore M12 notch UI (AT-M12.*)
...
Documentation recovery: reconstruct `M12 notch UI (AT-M12.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
