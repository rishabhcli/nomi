# [C-160] Privacy: egress measurement hardening #40

| Field | Value |
|-------|-------|
| **Queue position** | 160 of 500 (chronological — do not skip) |
...
Egress observability #40: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
