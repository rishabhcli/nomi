# [C-062] Structured log: emit terminal_state
...
Implement structured logging of `terminal_state` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
