# [C-361] Debug hooks: headless verification #1
...
Diagnostics #1: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
