# [C-497] CI gate: operational excellence #57
...
Operational gate #57: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
