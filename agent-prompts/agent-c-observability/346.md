# [C-346] Docs: restore M5 grounding (AT-M5.*)
...
Documentation recovery: reconstruct `M5 grounding (AT-M5.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
