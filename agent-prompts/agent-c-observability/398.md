# [C-398] Debug hooks: headless verification #38
...
Diagnostics #38: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
