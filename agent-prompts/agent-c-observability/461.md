# [C-461] CI gate: operational excellence #21
...
Operational gate #21: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
