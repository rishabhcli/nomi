# [C-043] Structured log: emit effort_tier
...
Implement structured logging of `effort_tier` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
