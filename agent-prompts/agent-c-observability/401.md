# [C-401] Integration probe: stack health #1
...
Live stack probe #1: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
