# [C-388] Debug hooks: headless verification #28
...
Diagnostics #28: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
