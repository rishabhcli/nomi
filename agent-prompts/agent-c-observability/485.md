# [C-485] CI gate: operational excellence #45
...
Operational gate #45: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
