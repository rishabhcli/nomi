# [C-226] Metrics: SLA automation #26
...
SLA metric #26: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
