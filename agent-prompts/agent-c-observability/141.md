# [C-141] Privacy: egress measurement hardening #21

| Field | Value |
|-------|-------|
| **Queue position** | 141 of 500 (chronological — do not skip) |
...
Egress observability #21: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
