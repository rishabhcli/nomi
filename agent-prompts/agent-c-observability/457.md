# [C-457] CI gate: operational excellence #17
...
Operational gate #17: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
