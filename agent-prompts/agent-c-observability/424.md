# [C-424] Integration probe: stack health #24
...
Live stack probe #24: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
