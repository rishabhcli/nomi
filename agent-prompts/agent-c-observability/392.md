# [C-392] Debug hooks: headless verification #32
...
Diagnostics #32: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
