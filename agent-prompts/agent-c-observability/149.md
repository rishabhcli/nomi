# [C-149] Privacy: egress measurement hardening #29

| Field | Value |
|-------|-------|
| **Queue position** | 149 of 500 (chronological — do not skip) |
...
Egress observability #29: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
