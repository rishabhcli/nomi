# [C-156] Privacy: egress measurement hardening #36

| Field | Value |
|-------|-------|
| **Queue position** | 156 of 500 (chronological — do not skip) |
...
Egress observability #36: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
