# [C-397] Debug hooks: headless verification #37
...
Diagnostics #37: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
