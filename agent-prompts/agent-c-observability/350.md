# [C-350] Docs: restore M9 inspector (AT-M9.*)
...
Documentation recovery: reconstruct `M9 inspector (AT-M9.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
