# [C-277] Harness: bulk-ingest.sh reliability
...
Harness #37: fix `scripts/bulk-ingest.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
