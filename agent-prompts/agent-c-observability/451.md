# [C-451] CI gate: operational excellence #11
...
Operational gate #11: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
