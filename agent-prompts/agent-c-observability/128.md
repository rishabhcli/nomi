# [C-128] Privacy: egress measurement hardening #8

| Field | Value |
|-------|-------|
| **Queue position** | 128 of 500 (chronological — do not skip) |
...
Egress observability #8: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
