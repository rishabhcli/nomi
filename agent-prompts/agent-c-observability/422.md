# [C-422] Integration probe: stack health #22
...
Live stack probe #22: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
