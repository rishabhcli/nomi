# [C-452] CI gate: operational excellence #12
...
Operational gate #12: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
