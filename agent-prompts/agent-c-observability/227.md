# [C-227] Metrics: SLA automation #27
...
SLA metric #27: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
