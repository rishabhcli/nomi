# [C-131] Privacy: egress measurement hardening #11

| Field | Value |
|-------|-------|
| **Queue position** | 131 of 500 (chronological — do not skip) |
...
Egress observability #11: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
