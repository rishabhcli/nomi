# [C-385] Debug hooks: headless verification #25

| Field | Value |
|-------|-------|
| **Queue position** | 385 of 500 (chronological — do not skip) |
...
Diagnostics #25: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
