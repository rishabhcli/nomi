# [C-216] Metrics: SLA automation #16
...
SLA metric #16: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
