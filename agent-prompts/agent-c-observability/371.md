# [C-371] Debug hooks: headless verification #11
...
Diagnostics #11: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
