# [C-439] Integration probe: stack health #39
...
Live stack probe #39: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
