# [C-468] CI gate: operational excellence #28
...
Operational gate #28: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
