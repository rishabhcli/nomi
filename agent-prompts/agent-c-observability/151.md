# [C-151] Privacy: egress measurement hardening #31

| Field | Value |
|-------|-------|
| **Queue position** | 151 of 500 (chronological — do not skip) |
...
Egress observability #31: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
