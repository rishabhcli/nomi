# [C-136] Privacy: egress measurement hardening #16

| Field | Value |
|-------|-------|
| **Queue position** | 136 of 500 (chronological — do not skip) |
...
Egress observability #16: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
