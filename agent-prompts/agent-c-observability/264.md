# [C-264] Harness: analyze-frames.py reliability
...
Harness #24: fix `scripts/analyze-frames.py` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
