# [C-335] Docs: restore Appendix A config schema
...
Documentation recovery: reconstruct `Appendix A config schema` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
