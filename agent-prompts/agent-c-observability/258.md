# [C-258] Harness: airplane-parity.sh reliability
...
Harness #18: fix `scripts/airplane-parity.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
...
**Primary targets:** `scripts/airplane-parity.sh`
...
- [ ] New/changed behavior has automated test coverage: Run ./airplane-parity.sh and capture exit 0 + output
