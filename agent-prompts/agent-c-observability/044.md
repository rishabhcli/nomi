# [C-044] Structured log: emit retrieval_hop_count
...
Implement structured logging of `retrieval_hop_count` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
