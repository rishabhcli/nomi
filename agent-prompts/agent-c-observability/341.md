# [C-341] Docs: restore M0 bootstrap acceptance tests (AT-M0.*)

| Field | Value |
|-------|-------|
| **Queue position** | 341 of 500 (chronological — do not skip) |
| **Agent** | C — Observability / Infra |
| **Phase** | Documentation Recovery — PLAN.md, UI.md, Shared/ alignment |
| **Priority** | P2 |
...
Documentation recovery: reconstruct `M0 bootstrap acceptance tests (AT-M0.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
...
**Primary targets:** `PLAN.md` or `UI.md` (create if missing)
...
- [ ] New/changed behavior has automated test coverage: No broken internal links; peer review checklist
