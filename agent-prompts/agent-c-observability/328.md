# [C-328] Docs: restore M7 sync (AT-M7.*)
...
Documentation recovery: reconstruct `M7 sync (AT-M7.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
