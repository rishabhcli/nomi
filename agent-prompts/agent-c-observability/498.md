# [C-498] CI gate: operational excellence #58
...
Operational gate #58: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
