# [C-406] Integration probe: stack health #6
...
Live stack probe #6: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
