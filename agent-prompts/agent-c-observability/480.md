# [C-480] CI gate: operational excellence #40
...
Operational gate #40: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
