# [C-045] Structured log: emit first_token_ms
...
Implement structured logging of `first_token_ms` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
