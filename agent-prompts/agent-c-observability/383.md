# [C-383] Debug hooks: headless verification #23
...
Diagnostics #23: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
