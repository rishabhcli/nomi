# [C-403] Integration probe: stack health #3
...
Live stack probe #3: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
