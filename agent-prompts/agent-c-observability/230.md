# [C-230] Metrics: SLA automation #30
...
SLA metric #30: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
