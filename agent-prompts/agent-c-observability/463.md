# [C-463] CI gate: operational excellence #23
...
Operational gate #23: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
