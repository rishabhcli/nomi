# [C-407] Integration probe: stack health #7
...
Live stack probe #7: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
