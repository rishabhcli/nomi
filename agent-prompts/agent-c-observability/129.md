# [C-129] Privacy: egress measurement hardening #9

| Field | Value |
|-------|-------|
| **Queue position** | 129 of 500 (chronological — do not skip) |
...
Egress observability #9: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
