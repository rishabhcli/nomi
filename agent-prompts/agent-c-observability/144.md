# [C-144] Privacy: egress measurement hardening #24

| Field | Value |
|-------|-------|
| **Queue position** | 144 of 500 (chronological — do not skip) |
...
Egress observability #24: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
