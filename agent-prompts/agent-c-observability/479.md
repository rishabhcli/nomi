# [C-479] CI gate: operational excellence #39
...
Operational gate #39: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
