# [C-402] Integration probe: stack health #2
...
Live stack probe #2: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
