# [C-420] Integration probe: stack health #20
...
Live stack probe #20: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
