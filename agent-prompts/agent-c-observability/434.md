# [C-434] Integration probe: stack health #34
...
Live stack probe #34: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
