# [C-494] CI gate: operational excellence #54
...
Operational gate #54: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
