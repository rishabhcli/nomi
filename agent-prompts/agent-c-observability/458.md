# [C-458] CI gate: operational excellence #18
...
Operational gate #18: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
