# [C-158] Privacy: egress measurement hardening #38

| Field | Value |
|-------|-------|
| **Queue position** | 158 of 500 (chronological — do not skip) |
...
Egress observability #38: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
