# [C-130] Privacy: egress measurement hardening #10

| Field | Value |
|-------|-------|
| **Queue position** | 130 of 500 (chronological — do not skip) |
...
Egress observability #10: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
