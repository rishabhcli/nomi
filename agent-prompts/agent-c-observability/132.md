# [C-132] Privacy: egress measurement hardening #12

| Field | Value |
|-------|-------|
| **Queue position** | 132 of 500 (chronological — do not skip) |
...
Egress observability #12: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
