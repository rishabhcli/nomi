# [C-418] Integration probe: stack health #18
...
Live stack probe #18: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
