# [C-471] CI gate: operational excellence #31
...
Operational gate #31: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
