# [C-041] Structured log: emit query_id
...
Implement structured logging of `query_id` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
