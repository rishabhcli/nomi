# [C-018] Foundation: config/audit gate #18

| Field | Value |
|-------|-------|
| **Queue position** | 18 of 500 (chronological — do not skip) |
| **Agent** | C — Observability / Infra |
| **Phase** | Foundation — Config invariants, stack health, audit tooling |
| **Priority** | P0 |
...
**Primary targets:** `Sources/MnemoCore/` + `Sources/MnemoSupervisor/LoopbackAudit.swift`
...
- [ ] New/changed behavior has automated test coverage: `Tests/MnemoCoreTests/InvariantTests.swift` + `mnemoctl audit`
