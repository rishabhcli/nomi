# [C-125] Privacy: egress measurement hardening #5

| Field | Value |
|-------|-------|
| **Queue position** | 125 of 500 (chronological — do not skip) |
...
Egress observability #5: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
