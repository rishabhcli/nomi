# [C-381] Debug hooks: headless verification #21
...
Diagnostics #21: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
