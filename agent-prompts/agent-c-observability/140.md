# [C-140] Privacy: egress measurement hardening #20

| Field | Value |
|-------|-------|
| **Queue position** | 140 of 500 (chronological — do not skip) |
...
Egress observability #20: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
