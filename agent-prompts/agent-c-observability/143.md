# [C-143] Privacy: egress measurement hardening #23

| Field | Value |
|-------|-------|
| **Queue position** | 143 of 500 (chronological — do not skip) |
...
Egress observability #23: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
