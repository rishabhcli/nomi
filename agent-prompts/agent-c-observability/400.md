# [C-400] Debug hooks: headless verification #40

| Field | Value |
|-------|-------|
| **Queue position** | 400 of 500 (chronological — do not skip) |
...
Diagnostics #40: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
