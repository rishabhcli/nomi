# [C-394] Debug hooks: headless verification #34

| Field | Value |
|-------|-------|
| **Queue position** | 394 of 500 (chronological — do not skip) |
...
Diagnostics #34: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
