# [C-484] CI gate: operational excellence #44
...
Operational gate #44: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
