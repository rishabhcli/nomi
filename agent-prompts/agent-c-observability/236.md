# [C-236] Metrics: SLA automation #36
...
SLA metric #36: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
