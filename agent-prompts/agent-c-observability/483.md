# [C-483] CI gate: operational excellence #43
...
Operational gate #43: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
