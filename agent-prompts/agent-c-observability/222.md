# [C-222] Metrics: SLA automation #22
...
SLA metric #22: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
