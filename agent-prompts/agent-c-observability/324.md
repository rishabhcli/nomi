# [C-324] Docs: restore M3 retrieval (AT-M3.*)
...
Documentation recovery: reconstruct `M3 retrieval (AT-M3.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
