# [C-122] Privacy: egress measurement hardening #2

| Field | Value |
|-------|-------|
| **Queue position** | 122 of 500 (chronological — do not skip) |
...
Egress observability #2: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
