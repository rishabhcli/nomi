# [C-475] CI gate: operational excellence #35
...
Operational gate #35: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
