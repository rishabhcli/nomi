# [C-358] Docs: restore Appendix D dependency graph
...
Documentation recovery: reconstruct `Appendix D dependency graph` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
