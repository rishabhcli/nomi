# [C-364] Debug hooks: headless verification #4
...
Diagnostics #4: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
