# [C-157] Privacy: egress measurement hardening #37
...
Egress observability #37: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
