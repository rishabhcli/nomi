# [C-249] Harness: smoke.sh reliability
...
Harness #9: fix `scripts/smoke.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
