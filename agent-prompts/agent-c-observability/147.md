# [C-147] Privacy: egress measurement hardening #27

| Field | Value |
|-------|-------|
| **Queue position** | 147 of 500 (chronological — do not skip) |
...
Egress observability #27: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
