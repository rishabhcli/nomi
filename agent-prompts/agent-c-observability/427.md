# [C-427] Integration probe: stack health #27
...
Live stack probe #27: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
