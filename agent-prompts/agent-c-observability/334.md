# [C-334] Docs: restore UI.md motion tokens
...
Documentation recovery: reconstruct `UI.md motion tokens` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
