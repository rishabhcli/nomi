# [C-435] Integration probe: stack health #35
...
Live stack probe #35: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
