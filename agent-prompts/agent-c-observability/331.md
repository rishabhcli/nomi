# [C-331] Docs: restore M10 offline privacy (AT-M10.*)
...
Documentation recovery: reconstruct `M10 offline privacy (AT-M10.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
