# [C-323] Docs: restore M2 ingestion (AT-M2.*)
...
Documentation recovery: reconstruct `M2 ingestion (AT-M2.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
