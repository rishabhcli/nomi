# [C-421] Integration probe: stack health #21
...
Live stack probe #21: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
