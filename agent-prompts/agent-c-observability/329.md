# [C-329] Docs: restore M8 consolidation (AT-M8.*)
...
Documentation recovery: reconstruct `M8 consolidation (AT-M8.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
