# [C-456] CI gate: operational excellence #16
...
Operational gate #16: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
