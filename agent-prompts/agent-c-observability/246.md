# [C-246] Harness: drain-watchdog.sh reliability
...
Harness #6: fix `scripts/drain-watchdog.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
