# [C-482] CI gate: operational excellence #42
...
Operational gate #42: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
