# [C-081] Config wire: [dreaming] enabled
...
Wire `[dreaming]` section into MnemoConfig and Consolidator scheduling.
...
**Primary targets:** `mnemo.toml` + `Sources/MnemoCore/MnemoConfig.swift`
