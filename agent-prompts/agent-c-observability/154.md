# [C-154] Privacy: egress measurement hardening #34

| Field | Value |
|-------|-------|
| **Queue position** | 154 of 500 (chronological — do not skip) |
...
Egress observability #34: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
