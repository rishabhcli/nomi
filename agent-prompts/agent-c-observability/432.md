# [C-432] Integration probe: stack health #32
...
Live stack probe #32: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
