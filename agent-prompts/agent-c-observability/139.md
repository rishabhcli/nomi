# [C-139] Privacy: egress measurement hardening #19

| Field | Value |
|-------|-------|
| **Queue position** | 139 of 500 (chronological — do not skip) |
...
Egress observability #19: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
