# [C-235] Metrics: SLA automation #35
...
SLA metric #35: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
