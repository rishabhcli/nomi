# [C-433] Integration probe: stack health #33
...
Live stack probe #33: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
