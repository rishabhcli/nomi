# [C-259] Harness: run-usecases.sh reliability
...
Harness #19: fix `scripts/run-usecases.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
