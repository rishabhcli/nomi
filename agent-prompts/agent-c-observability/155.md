# [C-155] Privacy: egress measurement hardening #35

| Field | Value |
|-------|-------|
| **Queue position** | 155 of 500 (chronological — do not skip) |
...
Egress observability #35: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
