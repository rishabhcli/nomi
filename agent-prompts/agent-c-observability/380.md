# [C-380] Debug hooks: headless verification #20
...
Diagnostics #20: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
