# [C-232] Metrics: SLA automation #32
...
SLA metric #32: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
