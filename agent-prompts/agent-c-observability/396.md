# [C-396] Debug hooks: headless verification #36
...
Diagnostics #36: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
