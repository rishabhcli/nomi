# [C-244] Harness: ui-torture.sh reliability
...
Harness #4: fix `scripts/ui-torture.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
