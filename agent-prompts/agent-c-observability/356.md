# [C-356] Docs: restore Appendix B observability metrics
...
Documentation recovery: reconstruct `Appendix B observability metrics` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
