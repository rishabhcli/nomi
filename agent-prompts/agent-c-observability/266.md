# [C-266] Harness: airplane-parity.sh reliability
...
Harness #26: fix `scripts/airplane-parity.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
