# [C-214] Metrics: SLA automation #14
...
SLA metric #14: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
