# [C-359] Docs: restore Global data model / Shared types
...
Documentation recovery: reconstruct `Global data model / Shared types` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
