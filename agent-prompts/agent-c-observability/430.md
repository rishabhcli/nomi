# [C-430] Integration probe: stack health #30
...
Live stack probe #30: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
