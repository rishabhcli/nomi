# [C-476] CI gate: operational excellence #36
...
Operational gate #36: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
