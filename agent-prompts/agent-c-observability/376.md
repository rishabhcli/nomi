# [C-376] Debug hooks: headless verification #16
...
Diagnostics #16: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
