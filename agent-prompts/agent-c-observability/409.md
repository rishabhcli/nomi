# [C-409] Integration probe: stack health #9
...
Live stack probe #9: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
