# [C-405] Integration probe: stack health #5
...
Live stack probe #5: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
