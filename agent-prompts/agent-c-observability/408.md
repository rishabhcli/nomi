# [C-408] Integration probe: stack health #8
...
Live stack probe #8: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
