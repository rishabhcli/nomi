# [C-347] Docs: restore M6 memory dynamics (AT-M6.*)
...
Documentation recovery: reconstruct `M6 memory dynamics (AT-M6.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
