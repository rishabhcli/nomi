# [C-496] CI gate: operational excellence #56
...
Operational gate #56: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
