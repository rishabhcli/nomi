# [C-495] CI gate: operational excellence #55
...
Operational gate #55: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
