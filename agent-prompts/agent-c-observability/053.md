# [C-053] Structured log: emit route_intent
...
Implement structured logging of `route_intent` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
