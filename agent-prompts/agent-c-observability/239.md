# [C-239] Metrics: SLA automation #39
...
SLA metric #39: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
