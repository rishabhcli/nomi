# [C-123] Privacy: egress measurement hardening #3

| Field | Value |
|-------|-------|
| **Queue position** | 123 of 500 (chronological — do not skip) |
...
Egress observability #3: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
