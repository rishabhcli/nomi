# [C-150] Privacy: egress measurement hardening #30

| Field | Value |
|-------|-------|
| **Queue position** | 150 of 500 (chronological — do not skip) |
...
Egress observability #30: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
