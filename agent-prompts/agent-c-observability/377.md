# [C-377] Debug hooks: headless verification #17

| Field | Value |
|-------|-------|
| **Queue position** | 377 of 500 (chronological — do not skip) |
...
Diagnostics #17: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
