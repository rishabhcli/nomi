# [C-118] Config: wire ui.panel_level
...
Parse and validate `mnemo.toml` key `ui.panel_level`: wire into `MnemoConfig`, fail startup if invalid, expose via `mnemoctl health --verbose`.
