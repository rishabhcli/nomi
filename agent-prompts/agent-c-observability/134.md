# [C-134] Privacy: egress measurement hardening #14

| Field | Value |
|-------|-------|
| **Queue position** | 134 of 500 (chronological — do not skip) |
...
Egress observability #14: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
