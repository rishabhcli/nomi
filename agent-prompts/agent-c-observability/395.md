# [C-395] Debug hooks: headless verification #35

| Field | Value |
|-------|-------|
| **Queue position** | 395 of 500 (chronological — do not skip) |
...
Diagnostics #35: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
