# [C-360] Docs: restore BS-M12 beats-Siri criteria
...
Documentation recovery: reconstruct `BS-M12 beats-Siri criteria` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
