# [C-142] Privacy: egress measurement hardening #22

| Field | Value |
|-------|-------|
| **Queue position** | 142 of 500 (chronological — do not skip) |
...
Egress observability #22: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
