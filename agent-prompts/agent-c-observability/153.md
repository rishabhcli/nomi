# [C-153] Privacy: egress measurement hardening #33

| Field | Value |
|-------|-------|
| **Queue position** | 153 of 500 (chronological — do not skip) |
...
Egress observability #33: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
