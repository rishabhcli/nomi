# [C-124] Privacy: egress measurement hardening #4

| Field | Value |
|-------|-------|
| **Queue position** | 124 of 500 (chronological — do not skip) |
...
Egress observability #4: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
