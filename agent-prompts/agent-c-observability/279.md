# [C-279] Harness: build-app.sh reliability
...
Harness #39: fix `scripts/build-app.sh` — isolated build dir for `run-usecases.sh`, no mid-run binary clobber; green 105-case run; capture log artifact.
