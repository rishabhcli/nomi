# [C-133] Privacy: egress measurement hardening #13

| Field | Value |
|-------|-------|
| **Queue position** | 133 of 500 (chronological — do not skip) |
...
Egress observability #13: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
