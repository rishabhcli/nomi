# [C-121] Privacy: egress measurement hardening #1

| Field | Value |
|-------|-------|
| **Queue position** | 121 of 500 (chronological — do not skip) |
...
Egress observability #1: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
