# [C-437] Integration probe: stack health #37
...
Live stack probe #37: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
