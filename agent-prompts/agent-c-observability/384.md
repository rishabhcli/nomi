# [C-384] Debug hooks: headless verification #24
...
Diagnostics #24: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
