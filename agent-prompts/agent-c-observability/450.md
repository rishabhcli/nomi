# [C-450] CI gate: operational excellence #10
...
Operational gate #10: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
