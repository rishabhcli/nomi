# [C-224] Metrics: SLA automation #24
...
SLA metric #24: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
