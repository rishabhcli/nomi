# [C-438] Integration probe: stack health #38
...
Live stack probe #38: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
