# [C-368] Debug hooks: headless verification #8
...
Diagnostics #8: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
