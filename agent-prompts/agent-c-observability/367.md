# [C-367] Debug hooks: headless verification #7

| Field | Value |
|-------|-------|
| **Queue position** | 367 of 500 (chronological — do not skip) |
...
Diagnostics #7: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
