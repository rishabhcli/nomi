# [C-127] Privacy: egress measurement hardening #7

| Field | Value |
|-------|-------|
| **Queue position** | 127 of 500 (chronological — do not skip) |
...
Egress observability #7: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
