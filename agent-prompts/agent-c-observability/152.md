# [C-152] Privacy: egress measurement hardening #32

| Field | Value |
|-------|-------|
| **Queue position** | 152 of 500 (chronological — do not skip) |
...
Egress observability #32: strengthen `EgressGuard` measurement; ensure `mnemoctl egress-check` prints blocked host list; `scripts/airplane-parity.sh` step maps to this invariant.
