# [C-212] Metrics: SLA automation #12
...
SLA metric #12: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
