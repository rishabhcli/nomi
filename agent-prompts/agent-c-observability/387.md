# [C-387] Debug hooks: headless verification #27
...
Diagnostics #27: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
