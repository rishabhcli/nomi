# [C-474] CI gate: operational excellence #34
...
Operational gate #34: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
