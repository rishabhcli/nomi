# [C-332] Docs: restore M11 concurrency (AT-M11.*)
...
Documentation recovery: reconstruct `M11 concurrency (AT-M11.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
