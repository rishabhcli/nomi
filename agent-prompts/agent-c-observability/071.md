# [C-071] Structured log: emit context_token_count
...
Implement structured logging of `context_token_count` to `~/Library/Logs/Mnemo/app.jsonl` (one JSON object per query, no document body at info level). Add redaction tests.
