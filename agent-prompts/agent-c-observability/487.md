# [C-487] CI gate: operational excellence #47
...
Operational gate #47: CI pipeline step — `swift test` + `mnemoctl audit` + `egress-check` + isolated `run-usecases.sh`; publish badge artifact.
