# [C-411] Integration probe: stack health #11
...
Live stack probe #11: script checks engine document error rate, extraction failures, smfs mount health — report JSON for user dashboard.
