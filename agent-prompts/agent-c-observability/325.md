# [C-325] Docs: restore M4 query lifecycle (AT-M4.*)
...
Documentation recovery: reconstruct `M4 query lifecycle (AT-M4.*)` in `PLAN.md` or `UI.md` from `docs/superpowers/plans/`, code comments, and tests. No placeholders.
