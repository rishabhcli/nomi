# [C-382] Debug hooks: headless verification #22
...
Diagnostics #22: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
