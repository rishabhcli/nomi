# [C-399] Debug hooks: headless verification #39
...
Diagnostics #39: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
