# [C-240] Metrics: SLA automation #40
...
SLA metric #40: automate `mnemoctl bench` threshold comparison against `mnemo.toml [sla]`; emit PASS/FAIL report artifact to `Tests/Fixtures/`.
