# [C-379] Debug hooks: headless verification #19
...
Diagnostics #19: extend `DebugHooks.swift` contract — geometry snapshots, reasoning event stream to `/tmp/mnemo-geometry.log`, headless PNG captures for CI.
