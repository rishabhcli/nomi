...
| Field | Value |
|-------|-------|
| **Queue position** | 483 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `CorpusControl.swift`: run `scripts/m12-acceptance.md` checklist item #43; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
