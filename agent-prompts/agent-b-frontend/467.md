...
| Field | Value |
|-------|-------|
| **Queue position** | 467 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `main.swift`: run `scripts/m12-acceptance.md` checklist item #27; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/main.swift` + `scripts/m12-acceptance.md`
