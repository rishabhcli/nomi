...
| Field | Value |
|-------|-------|
| **Queue position** | 468 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchGeometry+NSScreen.swift`: run `scripts/m12-acceptance.md` checklist item #28; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
