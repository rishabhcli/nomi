...
| Field | Value |
|-------|-------|
| **Queue position** | 475 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Motion.swift`: run `scripts/m12-acceptance.md` checklist item #35; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
