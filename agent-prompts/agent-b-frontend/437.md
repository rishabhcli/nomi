...
| Field | Value |
|-------|-------|
| **Queue position** | 437 of 500 (chronological — do not skip) |
...
Interaction polish in `NotchPanel.swift`: hover dwell before collapse; in-flight query lock prevents duplicate summon; single-instance enforcement; global hotkey summon from config.
