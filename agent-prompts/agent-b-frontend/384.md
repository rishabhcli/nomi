...
| Field | Value |
|-------|-------|
| **Queue position** | 384 of 500 (chronological — do not skip) |
...
Accessibility in `NotchShape.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `NotchShape.swift`
