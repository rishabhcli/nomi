...
| Field | Value |
|-------|-------|
| **Queue position** | 459 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Dictation.swift`: run `scripts/m12-acceptance.md` checklist item #19; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
