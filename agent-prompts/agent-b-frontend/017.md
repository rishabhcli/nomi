...
| Field | Value |
|-------|-------|
| **Queue position** | 17 of 500 (chronological — do not skip) |
...
Audit `main.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
