...
| Field | Value |
|-------|-------|
| **Queue position** | 486 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchGeometry+NSScreen.swift`: run `scripts/m12-acceptance.md` checklist item #46; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
