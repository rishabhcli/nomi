...
| Field | Value |
|-------|-------|
| **Queue position** | 449 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `main.swift`: run `scripts/m12-acceptance.md` checklist item #9; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
