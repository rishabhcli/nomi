...
| Field | Value |
|-------|-------|
| **Queue position** | 424 of 500 (chronological — do not skip) |
...
Interaction polish in `VoiceOrbView.swift`: hover dwell before collapse; in-flight query lock prevents duplicate summon; single-instance enforcement; global hotkey summon from config.
