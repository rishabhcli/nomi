...
| Field | Value |
|-------|-------|
| **Queue position** | 487 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchSurfaceView.swift`: run `scripts/m12-acceptance.md` checklist item #47; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchSurfaceView.swift` + `scripts/m12-acceptance.md`
