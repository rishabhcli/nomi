...
| Field | Value |
|-------|-------|
| **Queue position** | 452 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `SurfaceBlocks.swift`: run `scripts/m12-acceptance.md` checklist item #12; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
