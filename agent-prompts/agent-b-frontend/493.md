...
| Field | Value |
|-------|-------|
| **Queue position** | 493 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Motion.swift`: run `scripts/m12-acceptance.md` checklist item #53; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/Motion.swift` + `scripts/m12-acceptance.md`
