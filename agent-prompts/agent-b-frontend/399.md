...
| Field | Value |
|-------|-------|
| **Queue position** | 399 of 500 (chronological — do not skip) |
...
Accessibility in `NotchViewModel.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `NotchViewModel.swift`
