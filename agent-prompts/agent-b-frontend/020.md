...
| Field | Value |
|-------|-------|
| **Queue position** | 20 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `SurfaceBlocks.swift` via `Narrator` or `.accessibilityLabel`.
