...
| Field | Value |
|-------|-------|
| **Queue position** | 286 of 500 (chronological — do not skip) |
...
Source cards in `DebugHooks.swift`: render within `sources_render_ms` SLA; char-span preview on hover; Finder reveal on click; citation chips inline in markdown answer.
