...
| Field | Value |
|-------|-------|
| **Queue position** | 38 of 500 (chronological — do not skip) |
...
Ensure `SurfaceBlocks.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
