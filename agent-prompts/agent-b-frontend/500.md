...
| Field | Value |
|-------|-------|
| **Queue position** | 500 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `BackgroundSync.swift`: run `scripts/m12-acceptance.md` checklist item #60; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
