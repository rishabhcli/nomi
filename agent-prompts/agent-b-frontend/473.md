...
| Field | Value |
|-------|-------|
| **Queue position** | 473 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchPanel.swift`: run `scripts/m12-acceptance.md` checklist item #33; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
