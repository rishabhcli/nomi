...
| Field | Value |
|-------|-------|
| **Queue position** | 73 of 500 (chronological — do not skip) |
...
Render terminal state `.emptyCorpus` in `SurfaceBlocks.swift` with a beautiful, calm layout: iconography, recovery CTA, and plain-language copy. Must match Liquid Glass aesthetic. No empty panels — every sub-case of `.emptyCorpus` gets distinct copy.
