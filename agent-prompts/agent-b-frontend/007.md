...
| Field | Value |
|-------|-------|
| **Queue position** | 7 of 500 (chronological — do not skip) |
...
Audit `Motion.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
