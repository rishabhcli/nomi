...
Accessibility in `main.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `main.swift`
