...
| Field | Value |
|-------|-------|
| **Queue position** | 471 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchViewModel.swift`: run `scripts/m12-acceptance.md` checklist item #31; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchViewModel.swift` + `scripts/m12-acceptance.md`
