...
| Field | Value |
|-------|-------|
| **Queue position** | 27 of 500 (chronological — do not skip) |
...
Audit `Dictation.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
