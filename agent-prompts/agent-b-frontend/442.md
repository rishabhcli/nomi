...
| Field | Value |
|-------|-------|
| **Queue position** | 442 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `VoiceOrbView.swift`: run `scripts/m12-acceptance.md` checklist item #2; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
