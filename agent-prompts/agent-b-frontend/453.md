...
| Field | Value |
|-------|-------|
| **Queue position** | 453 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchViewModel.swift`: run `scripts/m12-acceptance.md` checklist item #13; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
