...
| Field | Value |
|-------|-------|
| **Queue position** | 495 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Dictation.swift`: run `scripts/m12-acceptance.md` checklist item #55; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/Dictation.swift` + `scripts/m12-acceptance.md`
