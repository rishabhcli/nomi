...
| Field | Value |
|-------|-------|
| **Queue position** | 461 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `VoiceOrb.metal`: run `scripts/m12-acceptance.md` checklist item #21; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/VoiceOrb.metal` + `scripts/m12-acceptance.md`
