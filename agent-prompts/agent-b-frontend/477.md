...
| Field | Value |
|-------|-------|
| **Queue position** | 477 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Dictation.swift`: run `scripts/m12-acceptance.md` checklist item #37; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
