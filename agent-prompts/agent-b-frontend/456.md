...
| Field | Value |
|-------|-------|
| **Queue position** | 456 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchShape.swift`: run `scripts/m12-acceptance.md` checklist item #16; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchShape.swift` + `scripts/m12-acceptance.md`
