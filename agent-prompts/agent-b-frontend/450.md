...
| Field | Value |
|-------|-------|
| **Queue position** | 450 of 500 (chronological — do not skip) |
| **Agent** | B — Frontend / Notch UI |
| **Phase** | Demo Fidelity — UI torture, beats-siri surface, M12 acceptance checklist |
| **Priority** | P3 |
...
M12 demo fidelity in `NotchGeometry+NSScreen.swift`: run `scripts/m12-acceptance.md` checklist item #10; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchGeometry+NSScreen.swift` + `scripts/m12-acceptance.md`
...
- [ ] New/changed behavior has automated test coverage: `scripts/ui-torture.sh` + manual AT-M12 checklist
