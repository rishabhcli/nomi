...
| Field | Value |
|-------|-------|
| **Queue position** | 485 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `main.swift`: run `scripts/m12-acceptance.md` checklist item #45; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
