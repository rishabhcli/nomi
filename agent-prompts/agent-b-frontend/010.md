...
| Field | Value |
|-------|-------|
| **Queue position** | 10 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `VoiceOrbView.swift` via `Narrator` or `.accessibilityLabel`.
