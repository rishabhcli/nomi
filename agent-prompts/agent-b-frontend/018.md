...
| Field | Value |
|-------|-------|
| **Queue position** | 18 of 500 (chronological — do not skip) |
...
Ensure `NotchGeometry+NSScreen.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
