...
| Field | Value |
|-------|-------|
| **Queue position** | 390 of 500 (chronological — do not skip) |
...
Accessibility in `Narrator.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `Narrator.swift`
