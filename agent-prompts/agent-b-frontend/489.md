...
| Field | Value |
|-------|-------|
| **Queue position** | 489 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchViewModel.swift`: run `scripts/m12-acceptance.md` checklist item #49; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
