...
| Field | Value |
|-------|-------|
| **Queue position** | 443 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `VoiceOrb.metal`: run `scripts/m12-acceptance.md` checklist item #3; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
