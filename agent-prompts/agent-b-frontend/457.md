...
| Field | Value |
|-------|-------|
| **Queue position** | 457 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Motion.swift`: run `scripts/m12-acceptance.md` checklist item #17; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
