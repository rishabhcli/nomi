...
| Field | Value |
|-------|-------|
| **Queue position** | 491 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchPanel.swift`: run `scripts/m12-acceptance.md` checklist item #51; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchPanel.swift` + `scripts/m12-acceptance.md`
