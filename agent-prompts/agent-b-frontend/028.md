...
| Field | Value |
|-------|-------|
| **Queue position** | 28 of 500 (chronological — do not skip) |
...
Ensure `VoiceOrbView.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
