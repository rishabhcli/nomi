...
| Field | Value |
|-------|-------|
| **Queue position** | 40 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `NotchController.swift` via `Narrator` or `.accessibilityLabel`.
