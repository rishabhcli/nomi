...
| Field | Value |
|-------|-------|
| **Queue position** | 490 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchController.swift`: run `scripts/m12-acceptance.md` checklist item #50; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
