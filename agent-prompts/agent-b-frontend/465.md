...
| Field | Value |
|-------|-------|
| **Queue position** | 465 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `CorpusControl.swift`: run `scripts/m12-acceptance.md` checklist item #25; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/CorpusControl.swift` + `scripts/m12-acceptance.md`
