...
| Field | Value |
|-------|-------|
| **Queue position** | 32 of 500 (chronological — do not skip) |
...
Audit `BackgroundSync.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
