...
| Field | Value |
|-------|-------|
| **Queue position** | 33 of 500 (chronological — do not skip) |
...
Ensure `CorpusControl.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
