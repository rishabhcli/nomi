...
| Field | Value |
|-------|-------|
| **Queue position** | 462 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Narrator.swift`: run `scripts/m12-acceptance.md` checklist item #22; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
