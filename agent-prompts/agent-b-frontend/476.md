...
| Field | Value |
|-------|-------|
| **Queue position** | 476 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `HoverDetector.swift`: run `scripts/m12-acceptance.md` checklist item #36; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
