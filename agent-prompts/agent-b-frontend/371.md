...
| Field | Value |
|-------|-------|
| **Queue position** | 371 of 500 (chronological — do not skip) |
...
Accessibility in `VoiceOrb.metal`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
