...
| Field | Value |
|-------|-------|
| **Queue position** | 469 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchSurfaceView.swift`: run `scripts/m12-acceptance.md` checklist item #29; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
