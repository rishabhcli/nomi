...
| Field | Value |
|-------|-------|
| **Queue position** | 470 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `SurfaceBlocks.swift`: run `scripts/m12-acceptance.md` checklist item #30; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/SurfaceBlocks.swift` + `scripts/m12-acceptance.md`
