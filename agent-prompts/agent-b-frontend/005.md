...
| Field | Value |
|-------|-------|
| **Queue position** | 5 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `NotchPanel.swift` via `Narrator` or `.accessibilityLabel`.
