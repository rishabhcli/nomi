...
| Field | Value |
|-------|-------|
| **Queue position** | 446 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `BackgroundSync.swift`: run `scripts/m12-acceptance.md` checklist item #6; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
