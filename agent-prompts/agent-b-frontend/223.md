...
| Field | Value |
|-------|-------|
| **Queue position** | 223 of 500 (chronological — do not skip) |
...
Voice pipeline in `Motion.swift`: on-device `SpeechAnalyzer` only; Metal orb at 120fps; `MicEnvelope` attack/release smooth; press-hold affordance obvious; audio never egresses.
