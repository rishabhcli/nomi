...
| Field | Value |
|-------|-------|
| **Queue position** | 484 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `DebugHooks.swift`: run `scripts/m12-acceptance.md` checklist item #44; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/DebugHooks.swift` + `scripts/m12-acceptance.md`
