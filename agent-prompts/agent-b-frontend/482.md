...
| Field | Value |
|-------|-------|
| **Queue position** | 482 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `BackgroundSync.swift`: run `scripts/m12-acceptance.md` checklist item #42; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/BackgroundSync.swift` + `scripts/m12-acceptance.md`
