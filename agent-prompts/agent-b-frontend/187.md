...
| Field | Value |
|-------|-------|
| **Queue position** | 187 of 500 (chronological — do not skip) |
...
Notch geometry in `Motion.swift`: read `NSScreen.safeAreaInsets` and `auxiliaryTopLeftArea` at runtime; virtual notch on external displays; multi-monitor hover handoff without duplicate panels.
