...
| Field | Value |
|-------|-------|
| **Queue position** | 30 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `Narrator.swift` via `Narrator` or `.accessibilityLabel`.
