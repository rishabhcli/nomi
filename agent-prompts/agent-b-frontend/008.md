...
| Field | Value |
|-------|-------|
| **Queue position** | 8 of 500 (chronological — do not skip) |
...
Ensure `HoverDetector.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
