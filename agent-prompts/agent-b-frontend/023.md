...
| Field | Value |
|-------|-------|
| **Queue position** | 23 of 500 (chronological — do not skip) |
...
Ensure `NotchPanel.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
