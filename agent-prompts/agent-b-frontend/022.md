...
| Field | Value |
|-------|-------|
| **Queue position** | 22 of 500 (chronological — do not skip) |
...
Audit `NotchController.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
