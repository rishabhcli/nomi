# [B-002] Foundation: SurfaceBlocks.swift architecture audit

| Field | Value |
|-------|-------|
| **Queue position** | 2 of 500 (chronological — do not skip) |
...
Audit `SurfaceBlocks.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
