...
| Field | Value |
|-------|-------|
| **Queue position** | 494 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `HoverDetector.swift`: run `scripts/m12-acceptance.md` checklist item #54; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/HoverDetector.swift` + `scripts/m12-acceptance.md`
