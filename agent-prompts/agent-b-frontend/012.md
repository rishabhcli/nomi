...
| Field | Value |
|-------|-------|
| **Queue position** | 12 of 500 (chronological — do not skip) |
...
Audit `Narrator.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
