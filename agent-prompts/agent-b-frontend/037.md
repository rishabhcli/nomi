...
| Field | Value |
|-------|-------|
| **Queue position** | 37 of 500 (chronological — do not skip) |
...
Audit `NotchSurfaceView.swift` for hand-rolled blur/vibrancy — replace with real `glassEffect` / `GlassEffectContainer` per CLAUDE.md.
