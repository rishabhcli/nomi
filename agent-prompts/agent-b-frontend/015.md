...
| Field | Value |
|-------|-------|
| **Queue position** | 15 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `CorpusControl.swift` via `Narrator` or `.accessibilityLabel`.
