...
| Field | Value |
|-------|-------|
| **Queue position** | 13 of 500 (chronological — do not skip) |
...
Ensure `AppCommandHandler.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
