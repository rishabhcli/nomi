...
| Field | Value |
|-------|-------|
| **Queue position** | 25 of 500 (chronological — do not skip) |
...
Add VoiceOver labels to every interactive control in `Motion.swift` via `Narrator` or `.accessibilityLabel`.
