...
| Field | Value |
|-------|-------|
| **Queue position** | 448 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `DebugHooks.swift`: run `scripts/m12-acceptance.md` checklist item #8; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
