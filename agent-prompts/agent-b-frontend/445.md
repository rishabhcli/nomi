...
| Field | Value |
|-------|-------|
| **Queue position** | 445 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `AppCommandHandler.swift`: run `scripts/m12-acceptance.md` checklist item #5; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
