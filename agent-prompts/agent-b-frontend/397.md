...
| Field | Value |
|-------|-------|
| **Queue position** | 397 of 500 (chronological — do not skip) |
...
Accessibility in `NotchSurfaceView.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `NotchSurfaceView.swift`
