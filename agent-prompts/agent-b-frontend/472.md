...
| Field | Value |
|-------|-------|
| **Queue position** | 472 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchController.swift`: run `scripts/m12-acceptance.md` checklist item #32; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/NotchController.swift` + `scripts/m12-acceptance.md`
