...
| Field | Value |
|-------|-------|
| **Queue position** | 480 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `Narrator.swift`: run `scripts/m12-acceptance.md` checklist item #40; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `scripts/m12-acceptance.md`
