...
| Field | Value |
|-------|-------|
| **Queue position** | 458 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `HoverDetector.swift`: run `scripts/m12-acceptance.md` checklist item #18; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
