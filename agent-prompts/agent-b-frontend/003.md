# [B-003] Foundation: NotchViewModel.swift architecture audit

| Field | Value |
|-------|-------|
| **Queue position** | 3 of 500 (chronological — do not skip) |
...
Ensure `NotchViewModel.swift` honors Reduce Motion: replace springs with opacity cross-fade when `accessibilityReduceMotion` is true.
