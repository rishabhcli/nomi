...
| Field | Value |
|-------|-------|
| **Queue position** | 375 of 500 (chronological — do not skip) |
...
Accessibility in `CorpusControl.swift`: VoiceOver reads answer + citations in logical order; Increase Contrast raises glass border visibility; ESC dismiss announced.
...
**Primary targets:** `Sources/MnemoApp/Narrator.swift` + `CorpusControl.swift`
