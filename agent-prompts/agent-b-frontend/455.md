...
| Field | Value |
|-------|-------|
| **Queue position** | 455 of 500 (chronological — do not skip) |
...
M12 demo fidelity in `NotchPanel.swift`: run `scripts/m12-acceptance.md` checklist item #15; capture evidence; fix any FAIL. Target: beats-siri surface quality offline.
