...
/// D-0680: mnemoctl JSON schema stability for IngestGate (seed 96321c7f7125).
final class D0680IngestGateTests: XCTestCase {
    private let seed = "96321c7f7125"

    func testJSON_exportStable() throws {
        let data = try IngestGate.jsonExportData()
