...
/// D-0820: mnemoctl JSON schema stability for EvidenceGathering (seed 3f11396ba4b1).
final class D0820EvidenceGatheringTests: XCTestCase {
    private let seed = "3f11396ba4b1"
