...
/// D-0341: PersonalRanker property-based invariants (seed 0e9c45dc75ae).
final class D0341PersonalRankerTests: XCTestCase {
    private let seed = "0e9c45dc75ae"
    ...
    func testIngestionSelfHealFiltersEmpty() {
        XCTAssertEqual(PersonalRanker.ingestionSelfHealSafe(orphanIds: ["a", "", "b"]), ["a", "b"])
    }
