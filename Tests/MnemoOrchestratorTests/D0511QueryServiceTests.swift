...
/// D-0511: agentic grep deadlock prevention for QueryService (seed 9e9eb4cd1432).
final class D0511QueryServiceTests: XCTestCase {
    private let seed = "9e9eb4cd1432"

    func testGrep_deadlockSafe() {
        XCTAssertTrue(QueryService.grepDeadlockSafe())
    }
