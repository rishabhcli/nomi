...
/// D-0568: citation verifier false-positive elimination for CitationVerifier (seed 72800024119f).
final class D0568CitationVerifierTests: XCTestCase {
    private let seed = "72800024119f"
    ...
    func testCitation_notTrivialFragment() {
        XCTAssertFalse(CitationVerifier.isTrivialFragment("User prefers Bazel for builds."))
    }
