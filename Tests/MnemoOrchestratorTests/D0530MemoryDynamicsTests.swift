...
/// D-0530: ingest gate timing proofs for MemoryDynamics (seed 705e311c35ec).
final class D0530MemoryDynamicsTests: XCTestCase {
    private let seed = "705e311c35ec"

    func testIngestGate_timingMonotonic() async {
        XCTAssertTrue(await MemoryDynamics.ingestGateTimingProof(timeoutMs: 2))
    }
