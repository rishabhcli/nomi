...
/// D-0481: Consolidation property-based invariants (seed 448d9797d1b8).
final class D0481ConsolidationTests: XCTestCase {
    private let seed = "448d9797d1b8"
    ...
    func testIngestionSelfHealFiltersEmpty() {
        XCTAssertEqual(Consolidation.ingestionSelfHealSafe(orphanIds: ["a", "", "b"]), ["a", "b"])
    }
