...
/// D-0971: agentic grep deadlock prevention for Router (seed 798ed779014e).
final class D0971RouterTests: XCTestCase {
    private let seed = "798ed779014e"
    ...
    func testModuleDeadlockWrapper() {
        XCTAssertTrue(Router.agenticDeadlockSafe(hopQueries: ["a", "b"]))
    }
