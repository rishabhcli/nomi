...
/// D-0480: ConflictDetector mnemoctl JSON schema stability (seed 8986fa0e54db).
final class D0480ConflictDetectorTests: XCTestCase {
    private let seed = "8986fa0e54db"
