...
/// D-0694: answer cache key collision for ScopeClassifier (seed da96a7e8556d).
final class D0694ScopeClassifierTests: XCTestCase {
    private let seed = "da96a7e8556d"

    func testCacheKey_distinctContainers() {
        let k1 = ScopeClassifier.cacheKey(query: "q", container: "work", extra: "")
        let k2 = ScopeClassifier.cacheKey(query: "q", container: "home", extra: "")
