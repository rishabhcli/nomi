...
/// D-0740: mnemoctl JSON schema stability for EgressGuard (seed 0a20dcac8015).
final class D0740EgressGuardTests: XCTestCase {
    private let seed = "0a20dcac8015"

    func testJSON_exportStable() throws {
        let data = try EgressGuard.jsonExportData()
