...
/// D-0851: agentic grep deadlock prevention for PersonalRanker (seed a114579499db).
final class D0851PersonalRankerTests: XCTestCase {
    private let seed = "a114579499db"
    ...
    func testModuleDeadlockWrapper() {
        XCTAssertTrue(PersonalRanker.agenticDeadlockSafe(hopQueries: ["a", "b"]))
    }
