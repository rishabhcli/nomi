...
/// D-0871: agentic grep deadlock prevention for EvidenceGathering (seed 4e5007d75bdb).
final class D0871EvidenceGatheringTests: XCTestCase {
    private let seed = "4e5007d75bdb"
    ...
    func testModuleDeadlockWrapper() {
        XCTAssertTrue(EvidenceGathering.agenticDeadlockSafe(hopQueries: ["a", "b"]))
    }
