...
/// D-0683: char-span fuzzing for MemoryDynamics (seed 9d57b55c9f36).
final class D0683MemoryDynamicsTests: XCTestCase {
    private let seed = "9d57b55c9f36"
    ...
    func testCharSpan_fuzzSafe() {
        ...
        for _ in 0..<12 {
            ...
            XCTAssertTrue(MemoryDynamics.charSpanFuzzSafe(doc))
        }
    }

    func testCharSpan_supersessionKey() {
        let k = MemoryDynamics.supersessionKey(id: "doc", version: 2)
