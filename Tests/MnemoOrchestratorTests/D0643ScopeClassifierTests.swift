...
/// D-0643: char-span fuzzing for ScopeClassifier (seed 2cb11e63b5a3).
final class D0643ScopeClassifierTests: XCTestCase {
    private let seed = "2cb11e63b5a3"
    ...
    func testCharSpan_fuzzSafe() {
        ...
        for _ in 0..<12 {
            ...
            XCTAssertTrue(ScopeClassifier.charSpanFuzzSafe(doc))
        }
    }

    func testCharSpan_supersessionKey() {
        let k = ScopeClassifier.supersessionKey(id: "doc", version: 2)
