...
/// D-0421: ContextAssembler property-based invariants (seed 5acaa7642a90).
final class D0421ContextAssemblerTests: XCTestCase {
    private let seed = "5acaa7642a90"
    ...
    func testIngestionSelfHealFiltersEmpty() {
        XCTAssertEqual(ContextAssembler.ingestionSelfHealSafe(orphanIds: ["a", "", "b"]), ["a", "b"])
    }
