...
// MARK: - CitationVerifier (Phase 2 hardening)
extension CitationVerifier {
    ...
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "CitationVerifier"]) }
}


// MARK: - CommandParser (Phase 2 hardening)
extension CommandParser {
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "CommandParser"]) }
}


// MARK: - Confidence (Phase 2 hardening)
extension Confidence {
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "Confidence"]) }
}


// MARK: - Consolidation (Phase 2 hardening)
extension Consolidation {
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "Consolidation"]) }
}


// MARK: - ContentHash (Phase 2 hardening)
extension ContentHash {
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "ContentHash"]) }
}
