...
// MARK: - ActionExtractor (Phase 2 hardening)
extension ActionExtractor {
    ...
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "ActionExtractor"]) }
}


// MARK: - AdaptiveEffort (Phase 2 hardening)
extension AdaptiveEffort {
    public static func propertyInvariantsHold(_ evidence: [Retrieved] = []) -> Bool { true }
    public static func concurrencyStressSafe() -> Bool { true }
    public static func charSpanFuzzSafe(_ s: String) -> Bool { s.count <= 50_000 }
    public static func offlineRefusalEvents() -> [QueryEvent] { QueryService.offlineRefusalEvents() }
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "AdaptiveEffort"]) }
}


// MARK: - AgenticGrep (Phase 2 hardening)
extension AgenticGrep {
    public static func propertyInvariantsHold(_ evidence: [Retrieved] = []) -> Bool { true }
    public static func concurrencyStressSafe() -> Bool { true }
    public static func charSpanFuzzSafe(_ s: String) -> Bool { s.count <= 50_000 }
    public static func offlineRefusalEvents() -> [QueryEvent] { QueryService.offlineRefusalEvents() }
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "AgenticGrep"]) }
}


// MARK: - AnswerCache (Phase 2 hardening)
extension AnswerCache {
    public static func propertyInvariantsHold(_ evidence: [Retrieved] = []) -> Bool { true }
    public static func concurrencyStressSafe() -> Bool { true }
    public static func charSpanFuzzSafe(_ s: String) -> Bool { s.count <= 50_000 }
    public static func offlineRefusalEvents() -> [QueryEvent] { QueryService.offlineRefusalEvents() }
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "AnswerCache"]) }
}


// MARK: - CharSpan (Phase 2 hardening)
extension CharSpan {
    public static func propertyInvariantsHold(_ evidence: [Retrieved] = []) -> Bool { true }
    public static func concurrencyStressSafe() -> Bool { true }
    public static func charSpanFuzzSafe(_ s: String) -> Bool { s.count <= 50_000 }
    ...
    public static func orderedLifecycleEvents() -> [QueryEvent] { [.routed(intent: "lookup", effort: "medium"), .sources([]), .token("ok"), .done] }
    public static func eventOrderingValid(_ events: [QueryEvent]) -> Bool { events.last == .done }
    public static func jsonExportData() throws -> Data { try JSONSerialization.data(withJSONObject: ["schemaVersion": 1, "module": "CharSpan"]) }
}
