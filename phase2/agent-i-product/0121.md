# [I-0121] Product: BS-M12 demo script
...
As a **staff product engineer / tech writer**, deliver **BS-M12 demo script** to production quality (seed `3c72c9368ed3`).
...
- [ ] Evidence: `phase2/evidence/I-0121.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0122 (or finish at 1000)
