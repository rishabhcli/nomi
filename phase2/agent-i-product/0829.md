# [I-0829] Product: inspector UX spec
...
As a **staff product engineer / tech writer**, deliver **inspector UX spec** to production quality (seed `08dc5efbb96b`).
...
- [ ] Evidence: `phase2/evidence/I-0829.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0830 (or finish at 1000)
