# [I-0426] Product: inspector UX spec
...
As a **staff product engineer / tech writer**, deliver **inspector UX spec** to production quality (seed `0048b2046eda`).
...
- [ ] Evidence: `phase2/evidence/I-0426.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0427 (or finish at 1000)
