# [I-0043] Product: BS-M12 demo script
...
As a **staff product engineer / tech writer**, deliver **BS-M12 demo script** to production quality (seed `24c4fd62ae8f`).
...
- [ ] Evidence: `phase2/evidence/I-0043.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0044 (or finish at 1000)
