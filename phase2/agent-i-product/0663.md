# [I-0663] Product: comparison table accuracy
...
As a **staff product engineer / tech writer**, deliver **comparison table accuracy** to production quality (seed `f5948c04447c`).
...
- [ ] Evidence: `phase2/evidence/I-0663.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0664 (or finish at 1000)
