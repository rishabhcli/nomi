# [I-0815] Product: helpfulness refusal copy
...
As a **staff product engineer / tech writer**, deliver **helpfulness refusal copy** to production quality (seed `b177d3c00972`).
...
- [ ] Evidence: `phase2/evidence/I-0815.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0816 (or finish at 1000)
