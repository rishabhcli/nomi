# [I-0282] Product: helpfulness refusal copy
...
As a **staff product engineer / tech writer**, deliver **helpfulness refusal copy** to production quality (seed `a9a307a15cc1`).
...
- [ ] Evidence: `phase2/evidence/I-0282.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0283 (or finish at 1000)
