# [I-0278] Product: beats-siri.mov storyboard
...
As a **staff product engineer / tech writer**, deliver **beats-siri.mov storyboard** to production quality (seed `d245880b35b5`).
...
- [ ] Evidence: `phase2/evidence/I-0278.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0279 (or finish at 1000)
