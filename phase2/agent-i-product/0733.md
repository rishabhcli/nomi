# [I-0733] Product: beats-siri.mov storyboard
...
As a **staff product engineer / tech writer**, deliver **beats-siri.mov storyboard** to production quality (seed `ae8928def230`).
...
- [ ] Evidence: `phase2/evidence/I-0733.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0734 (or finish at 1000)
