# [I-0694] Product: beats-siri.mov storyboard
...
As a **staff product engineer / tech writer**, deliver **beats-siri.mov storyboard** to production quality (seed `bc36e4dca99d`).
...
- [ ] Evidence: `phase2/evidence/I-0694.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0695 (or finish at 1000)
