# [I-0875] Product: BS-M12 demo script
...
As a **staff product engineer / tech writer**, deliver **BS-M12 demo script** to production quality (seed `eaae154cf17c`).
...
- [ ] Evidence: `phase2/evidence/I-0875.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0876 (or finish at 1000)
