# [I-0604] Product: Appendix B metric mapping
...
As a **staff product engineer / tech writer**, deliver **Appendix B metric mapping** to production quality (seed `7f2ea29c4d42`).
...
- [ ] Evidence: `phase2/evidence/I-0604.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0605 (or finish at 1000)
