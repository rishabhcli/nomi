# [I-0339] Product: UI.md motion token
...
As a **staff product engineer / tech writer**, deliver **UI.md motion token** to production quality (seed `49008bbdad38`).
...
- [ ] Evidence: `phase2/evidence/I-0339.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0340 (or finish at 1000)
