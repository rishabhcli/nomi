# [I-0009] Product: helpfulness refusal copy
...
As a **staff product engineer / tech writer**, deliver **helpfulness refusal copy** to production quality (seed `a905db46cb2e`).
...
- [ ] Evidence: `phase2/evidence/I-0009.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0010 (or finish at 1000)
