# [I-0309] Product: inspector UX spec
...
As a **staff product engineer / tech writer**, deliver **inspector UX spec** to production quality (seed `a112ff40396c`).
...
- [ ] Evidence: `phase2/evidence/I-0309.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0310 (or finish at 1000)
