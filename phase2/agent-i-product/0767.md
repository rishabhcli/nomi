# [I-0767] Product: comparison table accuracy
...
As a **staff product engineer / tech writer**, deliver **comparison table accuracy** to production quality (seed `2fd5a0215d2e`).
...
- [ ] Evidence: `phase2/evidence/I-0767.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to I-0768 (or finish at 1000)
