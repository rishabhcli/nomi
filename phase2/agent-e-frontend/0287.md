# [E-0287] HoverDetector: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **suggestion chip relevance** (seed `4ae1a29c9714`).
...
- [ ] Evidence: `phase2/evidence/E-0287.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0288 (or finish at 1000)
