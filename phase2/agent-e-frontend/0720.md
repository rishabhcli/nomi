# [E-0720] Increase Contrast glass: excel at entity chip exploration
...
As a **staff UI engineer**, make `Increase Contrast glass` **best-in-class** for **entity chip exploration** (seed `7b0b4c6e25ed`).
...
- [ ] Evidence: `phase2/evidence/E-0720.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0721 (or finish at 1000)
