# [E-0360] Increase Contrast glass: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `Increase Contrast glass` **best-in-class** for **reasoning trace legibility** (seed `fdeaa3212a0f`).
...
- [ ] Evidence: `phase2/evidence/E-0360.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0361 (or finish at 1000)
