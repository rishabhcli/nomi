# [E-0803] ReasoningTraceView: excel at citation affordance
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **citation affordance** (seed `5a6c83f98c22`).
...
- [ ] Evidence: `phase2/evidence/E-0803.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0804 (or finish at 1000)
