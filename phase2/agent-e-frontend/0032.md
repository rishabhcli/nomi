# [E-0032] Narrator: excel at entity chip exploration
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **entity chip exploration** (seed `9022857f7849`).
...
- [ ] Evidence: `phase2/evidence/E-0032.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0033 (or finish at 1000)
