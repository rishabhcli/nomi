# [E-0812] Narrator: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **empty corpus onboarding** (seed `0c8a10f2f754`).
...
- [ ] Evidence: `phase2/evidence/E-0812.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0813 (or finish at 1000)
