# [E-0045] NotchController: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `NotchController` **best-in-class** for **in-flight query lock UX** (seed `ab01878a1d6e`).
...
- [ ] Evidence: `phase2/evidence/E-0045.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0046 (or finish at 1000)
