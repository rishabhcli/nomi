# [E-0724] NotchViewModel: excel at error recovery clarity
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **error recovery clarity** (seed `e38c59553484`).
...
- [ ] Evidence: `phase2/evidence/E-0724.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0725 (or finish at 1000)
