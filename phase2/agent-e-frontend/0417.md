# [E-0417] privacy egress dot: excel at perceived latency
...
As a **staff UI engineer**, make `privacy egress dot` **best-in-class** for **perceived latency** (seed `799041a8b610`).
...
- [ ] Evidence: `phase2/evidence/E-0417.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0418 (or finish at 1000)
