# [E-0204] NotchViewModel: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **empty corpus onboarding** (seed `e9a3c64d332f`).
...
- [ ] Evidence: `phase2/evidence/E-0204.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0205 (or finish at 1000)
