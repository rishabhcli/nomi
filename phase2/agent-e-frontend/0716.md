# [E-0716] source card chips: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `source card chips` **best-in-class** for **empty corpus onboarding** (seed `cead661e66f7`).
...
- [ ] Evidence: `phase2/evidence/E-0716.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0717 (or finish at 1000)
