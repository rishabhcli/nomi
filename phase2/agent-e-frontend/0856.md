# [E-0856] source card chips: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `source card chips` **best-in-class** for **reasoning trace legibility** (seed `13bc06806ba8`).
...
- [ ] Evidence: `phase2/evidence/E-0856.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0857 (or finish at 1000)
