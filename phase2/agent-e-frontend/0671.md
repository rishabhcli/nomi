# [E-0671] Motion: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **suggestion chip relevance** (seed `b1da59463d6b`).
...
- [ ] Evidence: `phase2/evidence/E-0671.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0672 (or finish at 1000)
