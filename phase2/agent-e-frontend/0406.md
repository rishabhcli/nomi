# [E-0406] NotchPanel: excel at keyboard-only summon
...
As a **staff UI engineer**, make `NotchPanel` **best-in-class** for **keyboard-only summon** (seed `20f5581c2395`).
...
- [ ] Evidence: `phase2/evidence/E-0406.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0407 (or finish at 1000)
