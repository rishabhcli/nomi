# [E-0613] AppCommandHandler: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `AppCommandHandler` **best-in-class** for **VoiceOver rotor order** (seed `678cf761812f`).
...
- [ ] Evidence: `phase2/evidence/E-0613.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0614 (or finish at 1000)
