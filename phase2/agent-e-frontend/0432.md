# [E-0432] Narrator: excel at entity chip exploration
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **entity chip exploration** (seed `0d3dfd94a082`).
...
- [ ] Evidence: `phase2/evidence/E-0432.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0433 (or finish at 1000)
