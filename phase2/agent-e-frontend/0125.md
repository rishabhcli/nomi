# [E-0125] NotchController: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `NotchController` **best-in-class** for **in-flight query lock UX** (seed `b1c17a175af7`).
...
- [ ] Evidence: `phase2/evidence/E-0125.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0126 (or finish at 1000)
