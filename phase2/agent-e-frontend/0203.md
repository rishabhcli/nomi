# [E-0203] ReasoningTraceView: excel at 120fps orb thermal stability
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **120fps orb thermal stability** (seed `5c78504ef70e`).
...
- [ ] Evidence: `phase2/evidence/E-0203.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0204 (or finish at 1000)
