# [E-0352] Narrator: excel at entity chip exploration
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **entity chip exploration** (seed `653df614bdea`).
...
- [ ] Evidence: `phase2/evidence/E-0352.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0353 (or finish at 1000)
