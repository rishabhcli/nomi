# [E-0864] NotchViewModel: excel at entity chip exploration
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **entity chip exploration** (seed `5fc9adf2bdb9`).
...
- [ ] Evidence: `phase2/evidence/E-0864.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0865 (or finish at 1000)
