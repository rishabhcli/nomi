# [E-0504] NotchViewModel: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **reasoning trace legibility** (seed `3407f5e572be`).
...
- [ ] Evidence: `phase2/evidence/E-0504.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0505 (or finish at 1000)
