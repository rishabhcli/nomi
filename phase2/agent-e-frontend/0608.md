# [E-0608] Dictation: excel at entity chip exploration
...
As a **staff UI engineer**, make `Dictation` **best-in-class** for **entity chip exploration** (seed `81e9e61a9c8a`).
...
- [ ] Evidence: `phase2/evidence/E-0608.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0609 (or finish at 1000)
