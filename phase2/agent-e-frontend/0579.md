# [E-0579] Reduce Motion morph: excel at citation affordance
...
As a **staff UI engineer**, make `Reduce Motion morph` **best-in-class** for **citation affordance** (seed `9157cc3de828`).
...
- [ ] Evidence: `phase2/evidence/E-0579.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0580 (or finish at 1000)
