# [E-0801] NotchSurfaceView: excel at perceived latency
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **perceived latency** (seed `63842deb0dd9`).
...
- [ ] Evidence: `phase2/evidence/E-0801.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0802 (or finish at 1000)
