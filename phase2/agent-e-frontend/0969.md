# [E-0969] VoiceOrbView: excel at glass material hierarchy
...
As a **staff UI engineer**, make `VoiceOrbView` **best-in-class** for **glass material hierarchy** (seed `fdbfe5b42d6c`).
...
- [ ] Evidence: `phase2/evidence/E-0969.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0970 (or finish at 1000)
