# [E-0303] ReasoningTraceView: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **suggestion chip relevance** (seed `b081387f1804`).
...
- [ ] Evidence: `phase2/evidence/E-0303.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0304 (or finish at 1000)
