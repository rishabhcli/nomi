# [E-0819] Reduce Motion morph: excel at citation affordance
...
As a **staff UI engineer**, make `Reduce Motion morph` **best-in-class** for **citation affordance** (seed `425ce1f23596`).
...
- [ ] Evidence: `phase2/evidence/E-0819.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0820 (or finish at 1000)
