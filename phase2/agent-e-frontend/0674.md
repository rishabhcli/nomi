# [E-0674] InputTray: excel at reading-grade typography
...
As a **staff UI engineer**, make `InputTray` **best-in-class** for **reading-grade typography** (seed `d75d059dd6f0`).
...
- [ ] Evidence: `phase2/evidence/E-0674.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0675 (or finish at 1000)
