# [E-0301] NotchSurfaceView: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **in-flight query lock UX** (seed `b28ec89a39ce`).
...
- [ ] Evidence: `phase2/evidence/E-0301.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0302 (or finish at 1000)
