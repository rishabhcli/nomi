# [E-0012] Narrator: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **empty corpus onboarding** (seed `6d250771925b`).
...
- [ ] Evidence: `phase2/evidence/E-0012.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0013 (or finish at 1000)
