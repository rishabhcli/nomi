# [E-0547] HoverDetector: excel at citation affordance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **citation affordance** (seed `ed3cdfe9fde5`).
...
- [ ] Evidence: `phase2/evidence/E-0547.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0548 (or finish at 1000)
