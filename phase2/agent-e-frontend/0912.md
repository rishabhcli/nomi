# [E-0912] Narrator: excel at entity chip exploration
...
As a **staff UI engineer**, make `Narrator` **best-in-class** for **entity chip exploration** (seed `cac8b64f4d98`).
...
- [ ] Evidence: `phase2/evidence/E-0912.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0913 (or finish at 1000)
