# [E-0931] Motion: excel at citation affordance
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **citation affordance** (seed `5d986b81afa5`).
...
- [ ] Evidence: `phase2/evidence/E-0931.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0932 (or finish at 1000)
