# [E-0401] NotchSurfaceView: excel at perceived latency
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **perceived latency** (seed `d5c309a384b0`).
...
- [ ] Evidence: `phase2/evidence/E-0401.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0402 (or finish at 1000)
