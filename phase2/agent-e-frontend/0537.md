# [E-0537] privacy egress dot: excel at glass material hierarchy
...
As a **staff UI engineer**, make `privacy egress dot` **best-in-class** for **glass material hierarchy** (seed `00dc63ef18e7`).
...
- [ ] Evidence: `phase2/evidence/E-0537.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0538 (or finish at 1000)
