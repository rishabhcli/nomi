# [E-0342] SurfaceBlocks: excel at keyboard-only summon
...
As a **staff UI engineer**, make `SurfaceBlocks` **best-in-class** for **keyboard-only summon** (seed `5b61bb0849ea`).
...
- [ ] Evidence: `phase2/evidence/E-0342.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0343 (or finish at 1000)
