# [E-0246] NotchPanel: excel at keyboard-only summon
...
As a **staff UI engineer**, make `NotchPanel` **best-in-class** for **keyboard-only summon** (seed `00282a83785f`).
...
- [ ] Evidence: `phase2/evidence/E-0246.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0247 (or finish at 1000)
