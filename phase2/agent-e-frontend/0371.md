# [E-0371] Motion: excel at citation affordance
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **citation affordance** (seed `f5e15fae2bed`).
...
- [ ] Evidence: `phase2/evidence/E-0371.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0372 (or finish at 1000)
