# [E-0291] Motion: excel at citation affordance
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **citation affordance** (seed `1bc53615a136`).
...
- [ ] Evidence: `phase2/evidence/E-0291.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0292 (or finish at 1000)
