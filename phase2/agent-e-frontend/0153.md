# [E-0153] AppCommandHandler: excel at glass material hierarchy
...
As a **staff UI engineer**, make `AppCommandHandler` **best-in-class** for **glass material hierarchy** (seed `9bbde48ea3d1`).
...
- [ ] Evidence: `phase2/evidence/E-0153.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0154 (or finish at 1000)
