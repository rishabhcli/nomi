# [E-0021] NotchSurfaceView: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **VoiceOver rotor order** (seed `2b2628795287`).
...
- [ ] Evidence: `phase2/evidence/E-0021.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0022 (or finish at 1000)
