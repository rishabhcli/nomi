# [E-0044] NotchViewModel: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **empty corpus onboarding** (seed `3001e9ba747f`).
...
- [ ] Evidence: `phase2/evidence/E-0044.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0045 (or finish at 1000)
