# [E-0675] terminal recovery CTAs: excel at citation affordance
...
As a **staff UI engineer**, make `terminal recovery CTAs` **best-in-class** for **citation affordance** (seed `c44fb33b6b2d`).
...
- [ ] Evidence: `phase2/evidence/E-0675.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0676 (or finish at 1000)
