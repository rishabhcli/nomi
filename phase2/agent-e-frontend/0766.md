# [E-0766] NotchPanel: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `NotchPanel` **best-in-class** for **unsupported sentence styling** (seed `62ecc0aed095`).
...
- [ ] Evidence: `phase2/evidence/E-0766.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0767 (or finish at 1000)
