# [E-0834] InputTray: excel at reading-grade typography
...
As a **staff UI engineer**, make `InputTray` **best-in-class** for **reading-grade typography** (seed `d183d980cbd3`).
...
- [ ] Evidence: `phase2/evidence/E-0834.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0835 (or finish at 1000)
