# [E-0139] Reduce Motion morph: excel at 120fps orb thermal stability
...
As a **staff UI engineer**, make `Reduce Motion morph` **best-in-class** for **120fps orb thermal stability** (seed `ba357f8df41f`).
...
- [ ] Evidence: `phase2/evidence/E-0139.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0140 (or finish at 1000)
