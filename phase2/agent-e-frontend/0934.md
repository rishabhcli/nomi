# [E-0934] InputTray: excel at keyboard-only summon
...
As a **staff UI engineer**, make `InputTray` **best-in-class** for **keyboard-only summon** (seed `dd53eb7b49dd`).
...
- [ ] Evidence: `phase2/evidence/E-0934.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0935 (or finish at 1000)
