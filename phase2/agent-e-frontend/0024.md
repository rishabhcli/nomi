# [E-0024] NotchViewModel: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **reasoning trace legibility** (seed `486520e17a70`).
...
**Targets:** `Sources/MnemoApp/` (NotchViewModel), `Tests/MnemoOrchestratorTests/NotchReducerTests.swift` or UI logic tests
...
- [ ] Evidence: `phase2/evidence/E-0024.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0025 (or finish at 1000)
