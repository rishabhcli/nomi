# [E-0231] Motion: excel at press-hold dictation discoverability
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **press-hold dictation discoverability** (seed `e4e83d3b733b`).
...
- [ ] Evidence: `phase2/evidence/E-0231.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0232 (or finish at 1000)
