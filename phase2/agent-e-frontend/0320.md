# [E-0320] Increase Contrast glass: excel at entity chip exploration
...
As a **staff UI engineer**, make `Increase Contrast glass` **best-in-class** for **entity chip exploration** (seed `ef0e80224b8c`).
...
- [ ] Evidence: `phase2/evidence/E-0320.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0321 (or finish at 1000)
