# [E-0322] SurfaceBlocks: excel at reading-grade typography
...
As a **staff UI engineer**, make `SurfaceBlocks` **best-in-class** for **reading-grade typography** (seed `74bb3156aa5c`).
...
- [ ] Evidence: `phase2/evidence/E-0322.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0323 (or finish at 1000)
