# [E-0643] ReasoningTraceView: excel at citation affordance
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **citation affordance** (seed `a972eea6b42c`).
...
- [ ] Evidence: `phase2/evidence/E-0643.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0644 (or finish at 1000)
