# [E-0084] NotchViewModel: excel at error recovery clarity
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **error recovery clarity** (seed `c7779c65276f`).
...
- [ ] Evidence: `phase2/evidence/E-0084.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0085 (or finish at 1000)
