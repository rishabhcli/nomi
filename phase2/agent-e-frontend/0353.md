# [E-0353] AppCommandHandler: excel at perceived latency
...
As a **staff UI engineer**, make `AppCommandHandler` **best-in-class** for **perceived latency** (seed `2ff068916f47`).
...
- [ ] Evidence: `phase2/evidence/E-0353.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0354 (or finish at 1000)
