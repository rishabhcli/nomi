# [E-0990] VoiceOrb.metal: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `VoiceOrb.metal` **best-in-class** for **unsupported sentence styling** (seed `335b4284439f`).
...
- [ ] Evidence: `phase2/evidence/E-0990.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0991 (or finish at 1000)
