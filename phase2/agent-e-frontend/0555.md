# [E-0555] terminal recovery CTAs: excel at 120fps orb thermal stability
...
As a **staff UI engineer**, make `terminal recovery CTAs` **best-in-class** for **120fps orb thermal stability** (seed `a026b93f77c1`).
...
- [ ] Evidence: `phase2/evidence/E-0555.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0556 (or finish at 1000)
