# [E-0325] NotchController: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchController` **best-in-class** for **VoiceOver rotor order** (seed `7c68971cbe6a`).
...
- [ ] **Do not commit** — advance to E-0326 (or finish at 1000)
