# [E-0965] NotchController: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchController` **best-in-class** for **VoiceOver rotor order** (seed `58ea3180b117`).
...
- [ ] Evidence: `phase2/evidence/E-0965.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0966 (or finish at 1000)
