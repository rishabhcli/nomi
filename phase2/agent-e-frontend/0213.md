# [E-0213] AppCommandHandler: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `AppCommandHandler` **best-in-class** for **VoiceOver rotor order** (seed `704202929ebd`).
...
- [ ] Evidence: `phase2/evidence/E-0213.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0214 (or finish at 1000)
