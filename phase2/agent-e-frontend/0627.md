# [E-0627] HoverDetector: excel at citation affordance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **citation affordance** (seed `f9ea88c17fe9`).
...
- [ ] Evidence: `phase2/evidence/E-0627.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0628 (or finish at 1000)
