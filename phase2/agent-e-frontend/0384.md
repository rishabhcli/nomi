# [E-0384] NotchViewModel: excel at entity chip exploration
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **entity chip exploration** (seed `98d52cc358df`).
...
- [ ] Evidence: `phase2/evidence/E-0384.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0385 (or finish at 1000)
