# [E-0364] NotchViewModel: excel at empty corpus onboarding
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **empty corpus onboarding** (seed `a968139d3acd`).
...
- [ ] Evidence: `phase2/evidence/E-0364.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0365 (or finish at 1000)
