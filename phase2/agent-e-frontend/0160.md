# [E-0160] Increase Contrast glass: excel at entity chip exploration
...
As a **staff UI engineer**, make `Increase Contrast glass` **best-in-class** for **entity chip exploration** (seed `50a7589a686c`).
...
- [ ] Evidence: `phase2/evidence/E-0160.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0161 (or finish at 1000)
