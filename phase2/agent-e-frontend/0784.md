# [E-0784] NotchViewModel: excel at entity chip exploration
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **entity chip exploration** (seed `b8a396254770`).
...
- [ ] Evidence: `phase2/evidence/E-0784.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0785 (or finish at 1000)
