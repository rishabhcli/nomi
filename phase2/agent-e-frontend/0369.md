# [E-0369] VoiceOrbView: excel at perceived latency
...
As a **staff UI engineer**, make `VoiceOrbView` **best-in-class** for **perceived latency** (seed `2a683470d13d`).
...
- [ ] Evidence: `phase2/evidence/E-0369.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0370 (or finish at 1000)
