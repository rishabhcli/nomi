# [E-0190] VoiceOrb.metal: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `VoiceOrb.metal` **best-in-class** for **unsupported sentence styling** (seed `080e72dacc00`).
...
- [ ] Evidence: `phase2/evidence/E-0190.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0191 (or finish at 1000)
