# [E-0389] VoiceOrbView: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `VoiceOrbView` **best-in-class** for **VoiceOver rotor order** (seed `b871c8f04f39`).
...
- [ ] Evidence: `phase2/evidence/E-0389.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0390 (or finish at 1000)
