# [E-0664] NotchViewModel: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **reasoning trace legibility** (seed `540125425194`).
...
- [ ] Evidence: `phase2/evidence/E-0664.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0665 (or finish at 1000)
