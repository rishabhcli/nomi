# [E-0981] NotchSurfaceView: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **VoiceOver rotor order** (seed `e94a8f950e15`).
...
- [ ] Evidence: `phase2/evidence/E-0981.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0982 (or finish at 1000)
