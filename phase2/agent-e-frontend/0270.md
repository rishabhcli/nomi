# [E-0270] VoiceOrb.metal: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `VoiceOrb.metal` **best-in-class** for **unsupported sentence styling** (seed `7e5e52328dd9`).
...
- [ ] Evidence: `phase2/evidence/E-0270.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0271 (or finish at 1000)
