# [E-0804] NotchViewModel: excel at error recovery clarity
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **error recovery clarity** (seed `86cc92ed4a66`).
...
- [ ] Evidence: `phase2/evidence/E-0804.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0805 (or finish at 1000)
