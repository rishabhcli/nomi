# [E-0144] NotchViewModel: excel at entity chip exploration
...
As a **staff UI engineer**, make `NotchViewModel` **best-in-class** for **entity chip exploration** (seed `321ee383cf48`).
...
- [ ] Evidence: `phase2/evidence/E-0144.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0145 (or finish at 1000)
