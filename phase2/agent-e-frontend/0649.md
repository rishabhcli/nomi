# [E-0649] VoiceOrbView: excel at glass material hierarchy
...
As a **staff UI engineer**, make `VoiceOrbView` **best-in-class** for **glass material hierarchy** (seed `27d34a7db76b`).
...
- [ ] Evidence: `phase2/evidence/E-0649.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0650 (or finish at 1000)
