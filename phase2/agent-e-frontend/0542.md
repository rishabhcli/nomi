# [E-0542] SurfaceBlocks: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `SurfaceBlocks` **best-in-class** for **unsupported sentence styling** (seed `b395896e03ee`).
...
- [ ] Evidence: `phase2/evidence/E-0542.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0543 (or finish at 1000)
