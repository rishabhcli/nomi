# [E-0847] HoverDetector: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **suggestion chip relevance** (seed `d953227cbb01`).
...
- [ ] Evidence: `phase2/evidence/E-0847.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0848 (or finish at 1000)
