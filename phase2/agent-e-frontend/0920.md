# [E-0920] Increase Contrast glass: excel at reasoning trace legibility
...
As a **staff UI engineer**, make `Increase Contrast glass` **best-in-class** for **reasoning trace legibility** (seed `edeb0b5c703b`).
...
- [ ] Evidence: `phase2/evidence/E-0920.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0921 (or finish at 1000)
