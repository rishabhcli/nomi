# [E-0317] privacy egress dot: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `privacy egress dot` **best-in-class** for **in-flight query lock UX** (seed `dcde9fa8fbdd`).
...
- [ ] Evidence: `phase2/evidence/E-0317.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0318 (or finish at 1000)
