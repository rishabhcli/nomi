# [E-0614] InputTray: excel at keyboard-only summon
...
As a **staff UI engineer**, make `InputTray` **best-in-class** for **keyboard-only summon** (seed `7dff5cd586b2`).
...
- [ ] Evidence: `phase2/evidence/E-0614.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0615 (or finish at 1000)
