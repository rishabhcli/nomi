# [E-0601] NotchSurfaceView: excel at glass material hierarchy
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **glass material hierarchy** (seed `c3b84738a1ca`).
...
- [ ] Evidence: `phase2/evidence/E-0601.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0602 (or finish at 1000)
