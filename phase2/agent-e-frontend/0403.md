# [E-0403] ReasoningTraceView: excel at citation affordance
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **citation affordance** (seed `9d0935e57418`).
...
- [ ] Evidence: `phase2/evidence/E-0403.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0404 (or finish at 1000)
