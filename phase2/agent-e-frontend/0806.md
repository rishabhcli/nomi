# [E-0806] NotchPanel: excel at keyboard-only summon
...
As a **staff UI engineer**, make `NotchPanel` **best-in-class** for **keyboard-only summon** (seed `39bec1c96ed9`).
...
- [ ] Evidence: `phase2/evidence/E-0806.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0807 (or finish at 1000)
