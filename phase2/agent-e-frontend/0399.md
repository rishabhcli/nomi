# [E-0399] Reduce Motion morph: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `Reduce Motion morph` **best-in-class** for **suggestion chip relevance** (seed `85f74e3445af`).
...
- [ ] Evidence: `phase2/evidence/E-0399.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0400 (or finish at 1000)
