# [E-0767] HoverDetector: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **suggestion chip relevance** (seed `802a868ddd4c`).
...
- [ ] Evidence: `phase2/evidence/E-0767.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0768 (or finish at 1000)
