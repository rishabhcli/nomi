# [E-0739] Reduce Motion morph: excel at citation affordance
...
As a **staff UI engineer**, make `Reduce Motion morph` **best-in-class** for **citation affordance** (seed `d5a0f5ed3f0e`).
...
- [ ] Evidence: `phase2/evidence/E-0739.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0740 (or finish at 1000)
