# [E-0781] NotchSurfaceView: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **in-flight query lock UX** (seed `d098c8c01f09`).
...
- [ ] Evidence: `phase2/evidence/E-0781.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0782 (or finish at 1000)
