# [E-0261] NotchSurfaceView: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchSurfaceView` **best-in-class** for **VoiceOver rotor order** (seed `0ec0ef9f7a80`).
...
- [ ] Evidence: `phase2/evidence/E-0261.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0262 (or finish at 1000)
