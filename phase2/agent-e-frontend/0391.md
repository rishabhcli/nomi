# [E-0391] Motion: excel at press-hold dictation discoverability
...
As a **staff UI engineer**, make `Motion` **best-in-class** for **press-hold dictation discoverability** (seed `243866fc1228`).
...
- [ ] Evidence: `phase2/evidence/E-0391.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0392 (or finish at 1000)
