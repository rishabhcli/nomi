# [E-0046] NotchPanel: excel at unsupported sentence styling
...
As a **staff UI engineer**, make `NotchPanel` **best-in-class** for **unsupported sentence styling** (seed `c05cde10d4ab`).
...
- [ ] Evidence: `phase2/evidence/E-0046.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0047 (or finish at 1000)
