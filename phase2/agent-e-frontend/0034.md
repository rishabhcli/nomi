# [E-0034] InputTray: excel at reading-grade typography
...
As a **staff UI engineer**, make `InputTray` **best-in-class** for **reading-grade typography** (seed `a4578e5f3eaf`).
...
- [ ] Evidence: `phase2/evidence/E-0034.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0035 (or finish at 1000)
