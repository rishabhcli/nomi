# [E-0085] NotchController: excel at VoiceOver rotor order
...
As a **staff UI engineer**, make `NotchController` **best-in-class** for **VoiceOver rotor order** (seed `e63b937cd3a8`).
...
- [ ] Evidence: `phase2/evidence/E-0085.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0086 (or finish at 1000)
