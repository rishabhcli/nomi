# [E-0067] HoverDetector: excel at citation affordance
...
As a **staff UI engineer**, make `HoverDetector` **best-in-class** for **citation affordance** (seed `044e22c4a9ea`).
...
- [ ] Evidence: `phase2/evidence/E-0067.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0068 (or finish at 1000)
