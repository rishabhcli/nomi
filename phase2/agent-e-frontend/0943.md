# [E-0943] ReasoningTraceView: excel at suggestion chip relevance
...
As a **staff UI engineer**, make `ReasoningTraceView` **best-in-class** for **suggestion chip relevance** (seed `af562a30df6a`).
...
- [ ] Evidence: `phase2/evidence/E-0943.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0944 (or finish at 1000)
