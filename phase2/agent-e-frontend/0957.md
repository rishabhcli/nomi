# [E-0957] privacy egress dot: excel at in-flight query lock UX
...
As a **staff UI engineer**, make `privacy egress dot` **best-in-class** for **in-flight query lock UX** (seed `14f7dd4ce5a4`).
...
- [ ] Evidence: `phase2/evidence/E-0957.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to E-0958 (or finish at 1000)
