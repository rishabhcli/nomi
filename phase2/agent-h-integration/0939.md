# [H-0939] E2E: profile recall after /forget
...
As a **staff integration engineer**, prove **profile recall after /forget** works offline (seed `e4417e096c4c`).
...
- [ ] Evidence: `phase2/evidence/H-0939.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0940 (or finish at 1000)
