# [H-0573] E2E: bulk ingest under load
...
As a **staff integration engineer**, prove **bulk ingest under load** works offline (seed `7ac5401e99b8`).
...
- [ ] Evidence: `phase2/evidence/H-0573.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0574 (or finish at 1000)
