# [H-1000] E2E: ingest-then-query race
...
As a **staff integration engineer**, prove **ingest-then-query race** works offline (seed `9a3d8b700bdb`).
...
- At **1000/1000 only**: one atomic commit per agent:
  - `git add -A && git commit -m "H: Phase 2 complete (H-0001..H-1000)"`
  - Then one push.
...
- [ ] Evidence: `phase2/evidence/H-1000.md` with **raw** command output
