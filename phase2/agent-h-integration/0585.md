# [H-0585] E2E: bulk ingest under load
...
As a **staff integration engineer**, prove **bulk ingest under load** works offline (seed `04c4ecfad1de`).
...
- [ ] Evidence: `phase2/evidence/H-0585.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0586 (or finish at 1000)
