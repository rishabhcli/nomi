# [H-0314] E2E: job-finder multi-hop
...
As a **staff integration engineer**, prove **job-finder multi-hop** works offline (seed `1446b5d8c64e`).
...
- [ ] Evidence: `phase2/evidence/H-0314.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0315 (or finish at 1000)
