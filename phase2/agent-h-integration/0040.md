# [H-0040] E2E: ingest-then-query race
...
As a **staff integration engineer**, prove **ingest-then-query race** works offline (seed `7baf06bb1bdd`).
...
- [ ] Evidence: `phase2/evidence/H-0040.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0041 (or finish at 1000)
