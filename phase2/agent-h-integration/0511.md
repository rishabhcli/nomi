# [H-0511] E2E: model unload recovery
...
As a **staff integration engineer**, prove **model unload recovery** works offline (seed `3bc2c08c532d`).
...
- [ ] Evidence: `phase2/evidence/H-0511.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0512 (or finish at 1000)
