# [H-0358] E2E: concurrent ask + ingest
...
As a **staff integration engineer**, prove **concurrent ask + ingest** works offline (seed `fa326bbb68d6`).
...
- [ ] Evidence: `phase2/evidence/H-0358.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0359 (or finish at 1000)
