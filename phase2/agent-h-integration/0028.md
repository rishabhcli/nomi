# [H-0028] E2E: ingest-then-query race
...
As a **staff integration engineer**, prove **ingest-then-query race** works offline (seed `763427aeb7dc`).
...
- [ ] Evidence: `phase2/evidence/H-0028.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0029 (or finish at 1000)
