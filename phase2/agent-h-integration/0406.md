# [H-0406] E2E: concurrent ask + ingest
...
As a **staff integration engineer**, prove **concurrent ask + ingest** works offline (seed `7d388cf20ab9`).
...
- [ ] Evidence: `phase2/evidence/H-0406.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0407 (or finish at 1000)
