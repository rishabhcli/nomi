# [H-0862] E2E: concurrent ask + ingest
...
As a **staff integration engineer**, prove **concurrent ask + ingest** works offline (seed `e5e6d48cef3a`).
...
- [ ] Evidence: `phase2/evidence/H-0862.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0863 (or finish at 1000)
