# [H-0563] E2E: warm vs cold first-token bench
...
As a **staff integration engineer**, prove **warm vs cold first-token bench** works offline (seed `e450df067d88`).
...
- [ ] Evidence: `phase2/evidence/H-0563.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0564 (or finish at 1000)
