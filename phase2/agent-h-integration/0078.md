# [H-0078] E2E: engine restart mid-query
...
As a **staff integration engineer**, prove **engine restart mid-query** works offline (seed `565c3378f421`).
...
- [ ] Evidence: `phase2/evidence/H-0078.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to H-0079 (or finish at 1000)
