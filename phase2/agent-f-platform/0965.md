# [F-0965] Platform: Ollama warmup SLO
...
As a **staff platform engineer**, implement **Ollama warmup SLO** end-to-end (seed `5359188cc5c7`).
...
- [ ] Evidence: `phase2/evidence/F-0965.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0966 (or finish at 1000)
