# [F-0597] Platform: stack-report JSON
...
As a **staff platform engineer**, implement **stack-report JSON** end-to-end (seed `d1b8807060e0`).
...
- [ ] Evidence: `phase2/evidence/F-0597.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0598 (or finish at 1000)
