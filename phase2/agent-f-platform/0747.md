# [F-0747] Platform: stack-report JSON
...
As a **staff platform engineer**, implement **stack-report JSON** end-to-end (seed `c0cede709d74`).
...
- [ ] Evidence: `phase2/evidence/F-0747.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0748 (or finish at 1000)
