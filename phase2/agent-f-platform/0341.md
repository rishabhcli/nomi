# [F-0341] Platform: airplane-parity harness
...
As a **staff platform engineer**, implement **airplane-parity harness** end-to-end (seed `52e639dcb2cd`).
...
- [ ] Evidence: `phase2/evidence/F-0341.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0342 (or finish at 1000)
