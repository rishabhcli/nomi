# [F-0598] Platform: debug hooks headless PNG
...
As a **staff platform engineer**, implement **debug hooks headless PNG** end-to-end (seed `5cff33ca511e`).
...
- [ ] Evidence: `phase2/evidence/F-0598.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0599 (or finish at 1000)
