# [F-0070] Platform: first_token_ms regression gate
...
As a **staff platform engineer**, implement **first_token_ms regression gate** end-to-end (seed `6861bbce737d`).
...
- [ ] Evidence: `phase2/evidence/F-0070.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0071 (or finish at 1000)
