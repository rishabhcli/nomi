# [F-0431] Platform: airplane-parity harness
...
As a **staff platform engineer**, implement **airplane-parity harness** end-to-end (seed `7241fec27a02`).
...
- [ ] Evidence: `phase2/evidence/F-0431.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0432 (or finish at 1000)
