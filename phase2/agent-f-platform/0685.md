# [F-0685] Platform: first_token_ms regression gate
...
As a **staff platform engineer**, implement **first_token_ms regression gate** end-to-end (seed `0a80027969dd`).
...
- [ ] Evidence: `phase2/evidence/F-0685.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0686 (or finish at 1000)
