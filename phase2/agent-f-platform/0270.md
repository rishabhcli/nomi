# [F-0270] Platform: supervisor log aggregation
...
As a **staff platform engineer**, implement **supervisor log aggregation** end-to-end (seed `114f21957fe0`).
...
- [ ] Evidence: `phase2/evidence/F-0270.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0271 (or finish at 1000)
