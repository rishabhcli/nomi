# [F-0701] Platform: airplane-parity harness
...
As a **staff platform engineer**, implement **airplane-parity harness** end-to-end (seed `3694439075ee`).
...
- [ ] Evidence: `phase2/evidence/F-0701.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0702 (or finish at 1000)
