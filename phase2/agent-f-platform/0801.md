# [F-0801] Platform: smfs mount health
...
As a **staff platform engineer**, implement **smfs mount health** end-to-end (seed `6fc1f8f8875b`).
...
- [ ] Evidence: `phase2/evidence/F-0801.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0802 (or finish at 1000)
