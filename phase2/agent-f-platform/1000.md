# [F-1000] Platform: first_token_ms regression gate
...
As a **staff platform engineer**, implement **first_token_ms regression gate** end-to-end (seed `5ae636bb6e74`).
...
- [ ] Evidence: `phase2/evidence/F-1000.md` with **raw** command output
