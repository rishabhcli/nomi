# [F-0698] Platform: CI isolated build dir
...
As a **staff platform engineer**, implement **CI isolated build dir** end-to-end (seed `f8c48a7cc6ed`).
...
- [ ] Evidence: `phase2/evidence/F-0698.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0699 (or finish at 1000)
