# [F-0039] Platform: sources_render_ms automation
...
As a **staff platform engineer**, implement **sources_render_ms automation** end-to-end (seed `822cb1b57ac0`).
...
- [ ] Evidence: `phase2/evidence/F-0039.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0040 (or finish at 1000)
