# [F-0844] Platform: ProcessSupervisor restart backoff
...
As a **staff platform engineer**, implement **ProcessSupervisor restart backoff** end-to-end (seed `00d84aa0c973`).
...
- [ ] Evidence: `phase2/evidence/F-0844.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0845 (or finish at 1000)
