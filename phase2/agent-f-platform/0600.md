# [F-0600] Platform: supervisor log aggregation
...
As a **staff platform engineer**, implement **supervisor log aggregation** end-to-end (seed `b32fc1d67501`).
...
- [ ] Evidence: `phase2/evidence/F-0600.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0601 (or finish at 1000)
