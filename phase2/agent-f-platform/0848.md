# [F-0848] Platform: CI isolated build dir
...
As a **staff platform engineer**, implement **CI isolated build dir** end-to-end (seed `d2a485778102`).
...
- [ ] Evidence: `phase2/evidence/F-0848.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0849 (or finish at 1000)
