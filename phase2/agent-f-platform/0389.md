# [F-0389] Platform: config hot-reload safety
...
As a **staff platform engineer**, implement **config hot-reload safety** end-to-end (seed `3db2a8f504b4`).
...
- [ ] Evidence: `phase2/evidence/F-0389.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0390 (or finish at 1000)
