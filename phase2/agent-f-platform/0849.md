# [F-0849] Platform: sources_render_ms automation
...
As a **staff platform engineer**, implement **sources_render_ms automation** end-to-end (seed `38e8a4f0f88b`).
...
- [ ] Evidence: `phase2/evidence/F-0849.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0850 (or finish at 1000)
