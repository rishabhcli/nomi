# [F-0390] Platform: supervisor log aggregation
...
As a **staff platform engineer**, implement **supervisor log aggregation** end-to-end (seed `a16a327f837f`).
...
- [ ] Evidence: `phase2/evidence/F-0390.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0391 (or finish at 1000)
