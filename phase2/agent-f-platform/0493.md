# [F-0493] Platform: debug hooks headless PNG
...
As a **staff platform engineer**, implement **debug hooks headless PNG** end-to-end (seed `c67a9020860d`).
...
- [ ] Evidence: `phase2/evidence/F-0493.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0494 (or finish at 1000)
