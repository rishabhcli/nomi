# [F-0178] Platform: debug hooks headless PNG
...
As a **staff platform engineer**, implement **debug hooks headless PNG** end-to-end (seed `f57ddc066e07`).
...
- [ ] Evidence: `phase2/evidence/F-0178.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0179 (or finish at 1000)
