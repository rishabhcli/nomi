# [F-0553] Platform: debug hooks headless PNG
...
As a **staff platform engineer**, implement **debug hooks headless PNG** end-to-end (seed `280cd4b5a80c`).
...
- [ ] Evidence: `phase2/evidence/F-0553.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0554 (or finish at 1000)
