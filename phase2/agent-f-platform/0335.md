# [F-0335] Platform: Ollama warmup SLO
...
As a **staff platform engineer**, implement **Ollama warmup SLO** end-to-end (seed `0ad5536a12bf`).
...
- [ ] Evidence: `phase2/evidence/F-0335.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0336 (or finish at 1000)
