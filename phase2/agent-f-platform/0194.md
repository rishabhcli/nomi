# [F-0194] Platform: config hot-reload safety
...
As a **staff platform engineer**, implement **config hot-reload safety** end-to-end (seed `cdc0d074b0d1`).
...
- [ ] Evidence: `phase2/evidence/F-0194.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0195 (or finish at 1000)
