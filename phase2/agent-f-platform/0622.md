# [F-0622] Platform: log rotation privacy
...
As a **staff platform engineer**, implement **log rotation privacy** end-to-end (seed `55ec298f115f`).
...
- [ ] Evidence: `phase2/evidence/F-0622.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0623 (or finish at 1000)
