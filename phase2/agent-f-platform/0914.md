# [F-0914] Platform: config hot-reload safety
...
As a **staff platform engineer**, implement **config hot-reload safety** end-to-end (seed `e89d3cbcfaea`).
...
- [ ] Evidence: `phase2/evidence/F-0914.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0915 (or finish at 1000)
