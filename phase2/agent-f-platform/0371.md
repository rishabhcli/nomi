# [F-0371] Platform: airplane-parity harness
...
As a **staff platform engineer**, implement **airplane-parity harness** end-to-end (seed `3ccb5362a467`).
...
- [ ] Evidence: `phase2/evidence/F-0371.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0372 (or finish at 1000)
