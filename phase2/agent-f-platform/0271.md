# [F-0271] Platform: StructuredLog wiring
...
As a **staff platform engineer**, implement **StructuredLog wiring** end-to-end (seed `2d05b1fa09ce`).
...
- [ ] Evidence: `phase2/evidence/F-0271.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0272 (or finish at 1000)
