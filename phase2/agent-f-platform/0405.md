# [F-0405] Platform: supervisor log aggregation
...
As a **staff platform engineer**, implement **supervisor log aggregation** end-to-end (seed `395f4a678793`).
...
- [ ] Evidence: `phase2/evidence/F-0405.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0406 (or finish at 1000)
