# [F-0424] Platform: ProcessSupervisor restart backoff
...
As a **staff platform engineer**, implement **ProcessSupervisor restart backoff** end-to-end (seed `dcf32c91654e`).
...
- [ ] Evidence: `phase2/evidence/F-0424.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0425 (or finish at 1000)
