# [F-0920] Platform: Ollama warmup SLO
...
As a **staff platform engineer**, implement **Ollama warmup SLO** end-to-end (seed `522ac5924822`).
...
- [ ] Evidence: `phase2/evidence/F-0920.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0921 (or finish at 1000)
