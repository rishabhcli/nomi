# [F-0861] Platform: smfs mount health
...
As a **staff platform engineer**, implement **smfs mount health** end-to-end (seed `ea6af791870b`).
...
- [ ] Evidence: `phase2/evidence/F-0861.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0862 (or finish at 1000)
