# [F-0686] Platform: airplane-parity harness
...
As a **staff platform engineer**, implement **airplane-parity harness** end-to-end (seed `99fbda2d9f22`).
...
- [ ] Evidence: `phase2/evidence/F-0686.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to F-0687 (or finish at 1000)
