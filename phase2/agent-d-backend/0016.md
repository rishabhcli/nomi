...
As a **staff backend engineer**, harden `Ingestion` using **subprocess stderr backpressure** (seed `8802ac5c49b0`).
...
- [ ] Evidence: `phase2/evidence/D-0016.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0017 (or finish at 1000)
