...
As a **staff backend engineer**, harden `MediaCompanion` using **cache poisoning resistance** (seed `7a8e49d6fca9`).
...
- [ ] Evidence: `phase2/evidence/D-0045.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0046 (or finish at 1000)
