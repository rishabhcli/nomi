...
As a **staff backend engineer**, harden `MediaCompanion` using **subprocess stderr backpressure** (seed `40d1f82dfb28`).
...
- [ ] Evidence: `phase2/evidence/D-0096.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0097 (or finish at 1000)
