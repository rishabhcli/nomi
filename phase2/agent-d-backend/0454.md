# [D-0454] LocalExtractor: answer cache key collision
...
As a **staff backend engineer**, harden `LocalExtractor` using **answer cache key collision** (seed `b538779bc6d3`).
...
- [ ] Evidence: `phase2/evidence/D-0454.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0455 (or finish at 1000)
