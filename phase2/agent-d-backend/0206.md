...
As a **staff backend engineer**, harden `Router` using **token budget adversarial trim** (seed `b35ee468fa3d`).
...
- [ ] Evidence: `phase2/evidence/D-0206.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0207 (or finish at 1000)
