# [D-0537] WorkScheduler: AsyncStream cancellation
...
As a **staff backend engineer**, harden `WorkScheduler` using **AsyncStream cancellation** (seed `d2dceb2ffa3a`).
...
- [ ] Evidence: `phase2/evidence/D-0537.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0538 (or finish at 1000)
