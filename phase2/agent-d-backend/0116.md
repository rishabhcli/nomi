...
As a **staff backend engineer**, harden `Prompt` using **subprocess stderr backpressure** (seed `214fb0a81fa3`).
...
- [ ] Evidence: `phase2/evidence/D-0116.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0117 (or finish at 1000)
