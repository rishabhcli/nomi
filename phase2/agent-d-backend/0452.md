# [D-0452] EntityExtractor: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `EntityExtractor` using **numeric synthesis distractor immunity** (seed `d23705356f0d`).
...
- [ ] Evidence: `phase2/evidence/D-0452.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0453 (or finish at 1000)
