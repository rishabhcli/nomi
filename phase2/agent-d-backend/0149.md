...
As a **staff backend engineer**, harden `Digest` using **memory supersession race conditions** (seed `6321966c17f0`).
...
- [ ] Evidence: `phase2/evidence/D-0149.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0150 (or finish at 1000)
