# [D-0806] Confidence: token budget adversarial trim
...
As a **staff backend engineer**, harden `Confidence` using **token budget adversarial trim** (seed `a8349b2cb3e1`).
...
- [ ] Evidence: `phase2/evidence/D-0806.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0807 (or finish at 1000)
