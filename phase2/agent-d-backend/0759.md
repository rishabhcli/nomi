# [D-0759] MediaCompanion: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `MediaCompanion` using **QueryEvent ordering guarantees** (seed `c0ef3d69d388`).
...
- [ ] Evidence: `phase2/evidence/D-0759.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0760 (or finish at 1000)
