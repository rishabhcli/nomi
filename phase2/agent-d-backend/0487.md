...
As a **staff backend engineer**, harden `NotchReducer` using **router escalation boundaries** (seed `a42062a2fe61`).
...
- [ ] Evidence: `phase2/evidence/D-0487.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0488 (or finish at 1000)
