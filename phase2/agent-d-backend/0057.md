...
As a **staff backend engineer**, harden `EngineIntegration` using **AsyncStream cancellation** (seed `83f0b9def60f`).
...
- [ ] Evidence: `phase2/evidence/D-0057.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0058 (or finish at 1000)
