...
As a **staff backend engineer**, harden `WorkScheduler` using **memory supersession race conditions** (seed `8719f36ab1f1`).
...
- [ ] Evidence: `phase2/evidence/D-0129.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0130 (or finish at 1000)
