...
As a **staff backend engineer**, harden `Inspector` using **AsyncStream cancellation** (seed `5b2f88d78201`).
...
- [ ] Evidence: `phase2/evidence/D-0177.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0178 (or finish at 1000)
