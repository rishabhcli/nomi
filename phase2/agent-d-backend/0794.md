# [D-0794] QueryRewriter: answer cache key collision
...
As a **staff backend engineer**, harden `QueryRewriter` using **answer cache key collision** (seed `366d792edfa2`).
...
- [ ] Evidence: `phase2/evidence/D-0794.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0795 (or finish at 1000)
