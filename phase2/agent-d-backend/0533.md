# [D-0533] LLMSynthesizer: profile preamble staleness
...
As a **staff backend engineer**, harden `LLMSynthesizer` using **profile preamble staleness** (seed `2f6d7152e31a`).
...
- [ ] Evidence: `phase2/evidence/D-0533.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0534 (or finish at 1000)
