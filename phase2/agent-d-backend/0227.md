...
As a **staff backend engineer**, harden `LLMSynthesizer` using **router escalation boundaries** (seed `883224d877b8`).
...
- [ ] Evidence: `phase2/evidence/D-0227.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0228 (or finish at 1000)
