# [D-0774] CharSpan: answer cache key collision
...
As a **staff backend engineer**, harden `CharSpan` using **answer cache key collision** (seed `c0755779849c`).
...
- [ ] Evidence: `phase2/evidence/D-0774.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0775 (or finish at 1000)
