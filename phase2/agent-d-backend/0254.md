# [D-0254] Highlight: answer cache key collision
...
As a **staff backend engineer**, harden `Highlight` using **answer cache key collision** (seed `6bf220968258`).
...
- [ ] Evidence: `phase2/evidence/D-0254.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0255 (or finish at 1000)
