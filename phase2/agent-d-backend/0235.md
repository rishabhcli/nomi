...
As a **staff backend engineer**, harden `ScopeClassifier` using **egress guard host parsing** (seed `5d1706cf41ee`).
...
- [ ] Evidence: `phase2/evidence/D-0235.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0236 (or finish at 1000)
