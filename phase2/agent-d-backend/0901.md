# [D-0901] QueryHistory: property-based invariants
...
As a **staff backend engineer**, harden `QueryHistory` using **property-based invariants** (seed `689ab69f11c0`).
...
- [ ] Evidence: `phase2/evidence/D-0901.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0902 (or finish at 1000)
