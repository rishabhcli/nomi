# [D-0642] QueryDecomposer: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `QueryDecomposer` using **concurrency stress under WorkScheduler** (seed `3319dc566e8b`).
...
- [ ] Evidence: `phase2/evidence/D-0642.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0643 (or finish at 1000)
