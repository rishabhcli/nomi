# [D-0674] KeywordBackstop: answer cache key collision
...
As a **staff backend engineer**, harden `KeywordBackstop` using **answer cache key collision** (seed `867dd441b195`).
...
- [ ] Evidence: `phase2/evidence/D-0674.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0675 (or finish at 1000)
