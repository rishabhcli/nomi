# [D-0302] Digest: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `Digest` using **concurrency stress under WorkScheduler** (seed `f335e7d32c82`).
...
- [ ] Evidence: `phase2/evidence/D-0302.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0303 (or finish at 1000)
