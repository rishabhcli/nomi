# [D-0803] TimelineBuilder: char-span fuzzing
...
As a **staff backend engineer**, harden `TimelineBuilder` using **char-span fuzzing** (seed `09afa8fbbe3d`).
...
- [ ] Evidence: `phase2/evidence/D-0803.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0804 (or finish at 1000)
