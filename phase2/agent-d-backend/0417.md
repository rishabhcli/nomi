...
As a **staff backend engineer**, harden `CharSpan` using **AsyncStream cancellation** (seed `847c6ad760ae`).
...
- [ ] Evidence: `phase2/evidence/D-0417.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0418 (or finish at 1000)
