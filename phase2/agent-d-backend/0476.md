...
As a **staff backend engineer**, harden `IngestGate` using **subprocess stderr backpressure** (seed `9279697c6a3b`).
...
- [ ] Evidence: `phase2/evidence/D-0476.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0477 (or finish at 1000)
