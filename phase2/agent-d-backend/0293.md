...
As a **staff backend engineer**, harden `TimelineBuilder` using **profile preamble staleness** (seed `04d44d6c2cf1`).
...
- [ ] Evidence: `phase2/evidence/D-0293.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0294 (or finish at 1000)
