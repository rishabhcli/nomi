# [D-0563] Router: char-span fuzzing
...
As a **staff backend engineer**, harden `Router` using **char-span fuzzing** (seed `badbb48d52d0`).
...
- [ ] Evidence: `phase2/evidence/D-0563.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0564 (or finish at 1000)
