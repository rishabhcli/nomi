# [D-0569] SpanResolver: memory supersession race conditions
...
As a **staff backend engineer**, harden `SpanResolver` using **memory supersession race conditions** (seed `e482ed68713c`).
...
- [ ] Evidence: `phase2/evidence/D-0569.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0570 (or finish at 1000)
