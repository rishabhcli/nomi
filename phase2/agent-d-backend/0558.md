# [D-0558] Preferences: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `Preferences` using **TerminalState exhaustiveness** (seed `32d25ed3d132`).
...
- [ ] Evidence: `phase2/evidence/D-0558.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0559 (or finish at 1000)
