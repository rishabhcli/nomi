...
As a **staff backend engineer**, harden `NotchReducer` using **cache poisoning resistance** (seed `03472cb17a48`).
...
- [ ] Evidence: `phase2/evidence/D-0385.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0386 (or finish at 1000)
