# [D-0429] ConflictDetector: memory supersession race conditions
...
As a **staff backend engineer**, harden `ConflictDetector` using **memory supersession race conditions** (seed `41e9590c83ac`).
...
- [ ] Evidence: `phase2/evidence/D-0429.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0430 (or finish at 1000)
