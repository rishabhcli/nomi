...
As a **staff backend engineer**, harden `NotchReducer` using **answer cache key collision** (seed `56052a0283d9`).
...
- [ ] Evidence: `phase2/evidence/D-0334.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0335 (or finish at 1000)
