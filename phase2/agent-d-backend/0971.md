# [D-0971] Router: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `Router` using **agentic grep deadlock prevention** (seed `798ed779014e`).
...
- [ ] Evidence: `phase2/evidence/D-0971.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0972 (or finish at 1000)
