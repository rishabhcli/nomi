...
As a **staff backend engineer**, harden `PersonalRanker` using **ingest gate timing proofs** (seed `5ea06e148e9f`).
...
- [ ] Evidence: `phase2/evidence/D-0290.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0291 (or finish at 1000)
