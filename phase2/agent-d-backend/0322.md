...
As a **staff backend engineer**, harden `Ingestion` using **concurrency stress under WorkScheduler** (seed `7768eb06c3b8`).
...
- [ ] Evidence: `phase2/evidence/D-0322.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0323 (or finish at 1000)
