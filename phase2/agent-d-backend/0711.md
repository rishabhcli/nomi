# [D-0711] Preferences: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `Preferences` using **agentic grep deadlock prevention** (seed `55af02fd94e5`).
...
- [ ] Evidence: `phase2/evidence/D-0711.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0712 (or finish at 1000)
