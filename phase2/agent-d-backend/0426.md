# [D-0426] SyncEngine: token budget adversarial trim
...
As a **staff backend engineer**, harden `SyncEngine` using **token budget adversarial trim** (seed `bb27afaf56e6`).
...
- [ ] Evidence: `phase2/evidence/D-0426.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0427 (or finish at 1000)
