# [D-0609] Preferences: memory supersession race conditions
...
As a **staff backend engineer**, harden `Preferences` using **memory supersession race conditions** (seed `13f9bfd57ea3`).
...
- [ ] Evidence: `phase2/evidence/D-0609.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0610 (or finish at 1000)
