...
As a **staff backend engineer**, harden `Inspector` using **QueryEvent ordering guarantees** (seed `1b1c5d96e94e`).
...
- [ ] Evidence: `phase2/evidence/D-0279.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0280 (or finish at 1000)
