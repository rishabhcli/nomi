# [D-0599] TimelineBuilder: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `TimelineBuilder` using **QueryEvent ordering guarantees** (seed `acc03d41ec82`).
...
- [ ] Evidence: `phase2/evidence/D-0599.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0600 (or finish at 1000)
