...
As a **staff backend engineer**, harden `SpanResolver` using **char-span fuzzing** (seed `e232d2b3f79c`).
...
- [ ] Evidence: `phase2/evidence/D-0263.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0264 (or finish at 1000)
