...
As a **staff backend engineer**, harden `NumericReasoner` using **memory supersession race conditions** (seed `f0e782646455`).
...
- [ ] Evidence: `phase2/evidence/D-0189.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0190 (or finish at 1000)
