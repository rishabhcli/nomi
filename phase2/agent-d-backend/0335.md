...
As a **staff backend engineer**, harden `QueryRewriter` using **egress guard host parsing** (seed `167c900e4a3a`).
...
- [ ] Evidence: `phase2/evidence/D-0335.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0336 (or finish at 1000)
