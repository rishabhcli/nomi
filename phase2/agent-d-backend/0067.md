...
As a **staff backend engineer**, harden `Ingestion` using **router escalation boundaries** (seed `9f27b9e42b82`).
...
- [ ] Evidence: `phase2/evidence/D-0067.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0068 (or finish at 1000)
