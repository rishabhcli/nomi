...
As a **staff backend engineer**, harden `QueryDecomposer` using **numeric synthesis distractor immunity** (seed `3baa5fe0b6cd`).
...
- [ ] Evidence: `phase2/evidence/D-0132.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0133 (or finish at 1000)
