...
As a **staff backend engineer**, harden `CharSpan` using **mnemoctl JSON schema stability** (seed `e983c479eec0`).
...
- [ ] Evidence: `phase2/evidence/D-0060.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0061 (or finish at 1000)
