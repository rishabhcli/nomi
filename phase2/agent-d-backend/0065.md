...
As a **staff backend engineer**, harden `Prompt` using **cache poisoning resistance** (seed `e57a9cb7a959`).
...
- [ ] Evidence: `phase2/evidence/D-0065.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0066 (or finish at 1000)
