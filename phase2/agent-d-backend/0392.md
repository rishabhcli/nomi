...
As a **staff backend engineer**, harden `PersonalRanker` using **numeric synthesis distractor immunity** (seed `cfee1ed16e76`).
...
- [ ] Evidence: `phase2/evidence/D-0392.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0393 (or finish at 1000)
