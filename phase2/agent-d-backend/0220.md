...
As a **staff backend engineer**, harden `Ingestion` using **mnemoctl JSON schema stability** (seed `840d3f939115`).
...
- [ ] Evidence: `phase2/evidence/D-0220.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0221 (or finish at 1000)
