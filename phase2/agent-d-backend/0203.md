...
As a **staff backend engineer**, harden `Highlight` using **char-span fuzzing** (seed `5d6a6d0e6239`).
...
- [ ] Evidence: `phase2/evidence/D-0203.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0204 (or finish at 1000)
