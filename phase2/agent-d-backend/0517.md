# [D-0517] CitationVerifier: AsyncStream cancellation
...
As a **staff backend engineer**, harden `CitationVerifier` using **AsyncStream cancellation** (seed `aa12750dce2a`).
...
- [ ] Evidence: `phase2/evidence/D-0517.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0518 (or finish at 1000)
