...
As a **staff backend engineer**, harden `LLMHopPlanner` using **answer cache key collision** (seed `24bcece4843a`).
...
- [ ] Evidence: `phase2/evidence/D-0114.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0115 (or finish at 1000)
