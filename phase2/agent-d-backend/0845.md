# [D-0845] QueryRewriter: cache poisoning resistance
...
As a **staff backend engineer**, harden `QueryRewriter` using **cache poisoning resistance** (seed `47d33ebdbef0`).
...
- [ ] Evidence: `phase2/evidence/D-0845.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0846 (or finish at 1000)
