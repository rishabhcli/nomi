...
As a **staff backend engineer**, harden `Profile` using **memory supersession race conditions** (seed `99f5364b9924`).
...
- [ ] Evidence: `phase2/evidence/D-0229.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0230 (or finish at 1000)
