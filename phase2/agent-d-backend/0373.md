# [D-0373] Ingestion: profile preamble staleness
...
As a **staff backend engineer**, harden `Ingestion` using **profile preamble staleness** (seed `a08ea9b1759d`).
...
- [ ] Evidence: `phase2/evidence/D-0373.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0374 (or finish at 1000)
