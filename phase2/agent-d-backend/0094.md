...
As a **staff backend engineer**, harden `CommandParser` using **answer cache key collision** (seed `c95ad5c6f0f8`).
...
- [ ] Evidence: `phase2/evidence/D-0094.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0095 (or finish at 1000)
