...
As a **staff backend engineer**, harden `FollowUp` using **token budget adversarial trim** (seed `5f10c462caec`).
...
- [ ] Evidence: `phase2/evidence/D-0346.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0347 (or finish at 1000)
