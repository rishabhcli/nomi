...
As a **staff backend engineer**, harden `ResponseStyle` using **QueryEvent ordering guarantees** (seed `07c9f8bc7384`).
...
- [ ] Evidence: `phase2/evidence/D-0039.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0040 (or finish at 1000)
