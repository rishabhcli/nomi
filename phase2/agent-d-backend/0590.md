# [D-0590] QueryRewriter: ingest gate timing proofs
...
As a **staff backend engineer**, harden `QueryRewriter` using **ingest gate timing proofs** (seed `e386b25cce81`).
...
- [ ] Evidence: `phase2/evidence/D-0590.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0591 (or finish at 1000)
