# [D-0945] WorkScheduler: cache poisoning resistance
...
As a **staff backend engineer**, harden `WorkScheduler` using **cache poisoning resistance** (seed `f4c917f4ca60`).
...
- [ ] Evidence: `phase2/evidence/D-0945.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0946 (or finish at 1000)
