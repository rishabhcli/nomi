# [D-0555] MediaCompanion: egress guard host parsing
...
As a **staff backend engineer**, harden `MediaCompanion` using **egress guard host parsing** (seed `db1cbe4b017b`).
...
- [ ] Evidence: `phase2/evidence/D-0555.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0556 (or finish at 1000)
