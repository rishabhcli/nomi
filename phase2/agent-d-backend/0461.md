# [D-0461] Router: property-based invariants
...
As a **staff backend engineer**, harden `Router` using **property-based invariants** (seed `a2a2cffdfedf`).
...
- [ ] Evidence: `phase2/evidence/D-0461.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0462 (or finish at 1000)
