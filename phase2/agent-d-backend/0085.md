...
As a **staff backend engineer**, harden `QueryHistory` using **cache poisoning resistance** (seed `9588b21b2d90`).
...
- [ ] Evidence: `phase2/evidence/D-0085.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0086 (or finish at 1000)
