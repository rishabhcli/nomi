# [D-0423] OllamaClient: char-span fuzzing
...
As a **staff backend engineer**, harden `OllamaClient` using **char-span fuzzing** (seed `beae5eb84391`).
...
- [ ] Evidence: `phase2/evidence/D-0423.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0424 (or finish at 1000)
