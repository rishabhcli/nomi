...
As a **staff backend engineer**, harden `AnswerCache` using **property-based invariants** (seed `98a24578c63f`).
...
- [ ] Evidence: `phase2/evidence/D-0441.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0442 (or finish at 1000)
