...
As a **staff backend engineer**, harden `Profile` using **cache poisoning resistance** (seed `a76ebb452b51`).
...
- [ ] Evidence: `phase2/evidence/D-0025.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0026 (or finish at 1000)
