...
As a **staff backend engineer**, harden `AgenticGrep` using **answer cache key collision** (seed `7a04c3802256`).
...
- [ ] Evidence: `phase2/evidence/D-0214.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0215 (or finish at 1000)
