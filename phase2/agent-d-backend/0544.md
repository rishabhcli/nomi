# [D-0544] QueryHistory: offline refusal paths
...
As a **staff backend engineer**, harden `QueryHistory` using **offline refusal paths** (seed `73c60d5e3b40`).
...
- [ ] Evidence: `phase2/evidence/D-0544.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0545 (or finish at 1000)
