...
As a **staff backend engineer**, harden `TimeWindow` using **property-based invariants** (seed `4231d5fe9ada`).
...
- [ ] Evidence: `phase2/evidence/D-0241.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0242 (or finish at 1000)
