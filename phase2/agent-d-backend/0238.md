...
As a **staff backend engineer**, harden `QueryHistory` using **TerminalState exhaustiveness** (seed `c6955dae9e5b`).
...
- [ ] Evidence: `phase2/evidence/D-0238.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0239 (or finish at 1000)
