# [D-0760] LocalExtractor: mnemoctl JSON schema stability
...
As a **staff backend engineer**, harden `LocalExtractor` using **mnemoctl JSON schema stability** (seed `46c8e8923a12`).
...
- [ ] Evidence: `phase2/evidence/D-0760.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0761 (or finish at 1000)
