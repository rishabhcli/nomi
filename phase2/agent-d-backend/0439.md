...
As a **staff backend engineer**, harden `ScopeClassifier` using **QueryEvent ordering guarantees** (seed `c30eaedf5359`).
...
- [ ] Evidence: `phase2/evidence/D-0439.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0440 (or finish at 1000)
