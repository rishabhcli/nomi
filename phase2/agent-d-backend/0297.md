# [D-0297] Provenance: AsyncStream cancellation
...
As a **staff backend engineer**, harden `Provenance` using **AsyncStream cancellation** (seed `56daeb886178`).
...
- [ ] Evidence: `phase2/evidence/D-0297.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0298 (or finish at 1000)
