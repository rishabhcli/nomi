...
As a **staff backend engineer**, harden `AgenticGrep` using **TerminalState exhaustiveness** (seed `b0859ac603b0`).
...
- [ ] Evidence: `phase2/evidence/D-0418.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0419 (or finish at 1000)
