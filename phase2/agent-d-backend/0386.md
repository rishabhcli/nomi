# [D-0386] QueryRewriter: token budget adversarial trim
...
As a **staff backend engineer**, harden `QueryRewriter` using **token budget adversarial trim** (seed `2f3ce16b1357`).
...
- [ ] Evidence: `phase2/evidence/D-0386.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0387 (or finish at 1000)
