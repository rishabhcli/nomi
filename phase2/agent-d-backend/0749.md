# [D-0749] PersonalRanker: memory supersession race conditions
...
As a **staff backend engineer**, harden `PersonalRanker` using **memory supersession race conditions** (seed `182b7c581f7e`).
...
- [ ] Evidence: `phase2/evidence/D-0749.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0750 (or finish at 1000)
