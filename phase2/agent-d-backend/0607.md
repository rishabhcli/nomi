# [D-0607] LocalExtractor: router escalation boundaries
...
As a **staff backend engineer**, harden `LocalExtractor` using **router escalation boundaries** (seed `f20eb48be645`).
...
- [ ] Evidence: `phase2/evidence/D-0607.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0608 (or finish at 1000)
