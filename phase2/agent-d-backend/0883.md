# [D-0883] Ingestion: char-span fuzzing
...
As a **staff backend engineer**, harden `Ingestion` using **char-span fuzzing** (seed `dc531e0f3290`).
...
- [ ] Evidence: `phase2/evidence/D-0883.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0884 (or finish at 1000)
