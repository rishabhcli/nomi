...
As a **staff backend engineer**, harden `TimelineBuilder` using **TerminalState exhaustiveness** (seed `a641237d20a5`).
...
- [ ] Evidence: `phase2/evidence/D-0038.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0039 (or finish at 1000)
