# [D-0225] ConflictDetector: cache poisoning resistance
...
As a **staff backend engineer**, harden `ConflictDetector` using **cache poisoning resistance** (seed `855a9df6bdf3`).
...
- [ ] Evidence: `phase2/evidence/D-0225.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0226 (or finish at 1000)
