# [D-0924] EngineIntegration: offline refusal paths
...
As a **staff backend engineer**, harden `EngineIntegration` using **offline refusal paths** (seed `40cd374d228e`).
...
- [ ] Evidence: `phase2/evidence/D-0924.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0925 (or finish at 1000)
