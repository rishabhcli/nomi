# [D-0378] ConflictDetector: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `ConflictDetector` using **TerminalState exhaustiveness** (seed `faa0c581c628`).
...
- [ ] Evidence: `phase2/evidence/D-0378.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0379 (or finish at 1000)
