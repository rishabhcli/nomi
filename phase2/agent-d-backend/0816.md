# [D-0816] ActionExtractor: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `ActionExtractor` using **subprocess stderr backpressure** (seed `df2ed4f5cfe2`).
...
- [ ] Evidence: `phase2/evidence/D-0816.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0817 (or finish at 1000)
