...
As a **staff backend engineer**, harden `EntityExtractor` using **QueryEvent ordering guarantees** (seed `16c53d02fcfd`).
...
- [ ] Evidence: `phase2/evidence/D-0299.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0300 (or finish at 1000)
