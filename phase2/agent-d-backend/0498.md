...
As a **staff backend engineer**, harden `ResponseStyle` using **TerminalState exhaustiveness** (seed `90be912683f2`).
...
- [ ] Evidence: `phase2/evidence/D-0498.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0499 (or finish at 1000)
