...
As a **staff backend engineer**, harden `CitationVerifier` using **router escalation boundaries** (seed `0f386ab3d7a5`).
...
- [ ] Evidence: `phase2/evidence/D-0007.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0008 (or finish at 1000)
