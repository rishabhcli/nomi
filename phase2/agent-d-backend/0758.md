# [D-0758] EntityExtractor: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `EntityExtractor` using **TerminalState exhaustiveness** (seed `77c1fa6415ee`).
...
- [ ] Evidence: `phase2/evidence/D-0758.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0759 (or finish at 1000)
