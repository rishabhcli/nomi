# [D-0946] NotchReducer: token budget adversarial trim
...
As a **staff backend engineer**, harden `NotchReducer` using **token budget adversarial trim** (seed `e767dddaf445`).
...
- [ ] Evidence: `phase2/evidence/D-0946.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0947 (or finish at 1000)
