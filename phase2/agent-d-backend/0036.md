...
As a **staff backend engineer**, harden `NumericReasoner` using **subprocess stderr backpressure** (seed `5a3bae787ee6`).
...
- [ ] Evidence: `phase2/evidence/D-0036.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0037 (or finish at 1000)
