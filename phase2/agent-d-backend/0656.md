# [D-0656] EntityExtractor: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `EntityExtractor` using **subprocess stderr backpressure** (seed `7284a3c99224`).
...
- [ ] Evidence: `phase2/evidence/D-0656.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0657 (or finish at 1000)
