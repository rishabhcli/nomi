# [D-0825] CharSpan: cache poisoning resistance
...
As a **staff backend engineer**, harden `CharSpan` using **cache poisoning resistance** (seed `edfce891486b`).
...
- [ ] Evidence: `phase2/evidence/D-0825.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0826 (or finish at 1000)
