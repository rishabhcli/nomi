# [D-0308] Router: citation verifier false-positive elimination
...
As a **staff backend engineer**, harden `Router` using **citation verifier false-positive elimination** (seed `4f1ef9cedb67`).
...
- [ ] Evidence: `phase2/evidence/D-0308.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0309 (or finish at 1000)
