...
As a **staff backend engineer**, harden `Provenance` using **egress guard host parsing** (seed `c4adea3620ca`).
...
- [ ] Evidence: `phase2/evidence/D-0195.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0196 (or finish at 1000)
