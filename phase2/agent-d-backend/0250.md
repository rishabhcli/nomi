...
As a **staff backend engineer**, harden `LocalExtractor` using **ingest gate timing proofs** (seed `e94e26653bd7`).
...
- [ ] Evidence: `phase2/evidence/D-0250.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0251 (or finish at 1000)
