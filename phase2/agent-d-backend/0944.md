# [D-0944] EgressGuard: offline refusal paths
...
As a **staff backend engineer**, harden `EgressGuard` using **offline refusal paths** (seed `499989ba2136`).
...
- [ ] Evidence: `phase2/evidence/D-0944.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0945 (or finish at 1000)
