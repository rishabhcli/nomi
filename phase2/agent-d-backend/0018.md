...
As a **staff backend engineer**, harden `SyncEngine` using **TerminalState exhaustiveness** (seed `e11c4a1ab1ac`).
...
- [ ] Evidence: `phase2/evidence/D-0018.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0019 (or finish at 1000)
