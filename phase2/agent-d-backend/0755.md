# [D-0755] Confidence: egress guard host parsing
...
As a **staff backend engineer**, harden `Confidence` using **egress guard host parsing** (seed `f3255f1e6796`).
...
- [ ] Evidence: `phase2/evidence/D-0755.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0756 (or finish at 1000)
