# [D-0953] PersonalRanker: profile preamble staleness
...
As a **staff backend engineer**, harden `PersonalRanker` using **profile preamble staleness** (seed `e2f5e49e3021`).
...
- [ ] Evidence: `phase2/evidence/D-0953.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0954 (or finish at 1000)
