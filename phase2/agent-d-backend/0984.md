# [D-0984] OllamaClient: offline refusal paths
...
As a **staff backend engineer**, harden `OllamaClient` using **offline refusal paths** (seed `7adc6406d1e4`).
...
- [ ] Evidence: `phase2/evidence/D-0984.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0985 (or finish at 1000)
