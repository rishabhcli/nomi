# [D-0999] QueryDecomposer: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `QueryDecomposer` using **QueryEvent ordering guarantees** (seed `3bff09b67d73`).
...
- [ ] Evidence: `phase2/evidence/D-0999.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-1000 (or finish at 1000)
