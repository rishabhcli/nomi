...
As a **staff backend engineer**, harden `TimeWindow` using **QueryEvent ordering guarantees** (seed `1ae6fed28ec7`).
...
- [ ] Evidence: `phase2/evidence/D-0139.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0140 (or finish at 1000)
