# [D-0295] FollowUp: egress guard host parsing
...
As a **staff backend engineer**, harden `FollowUp` using **egress guard host parsing** (seed `14dc70141c0e`).
...
- [ ] Evidence: `phase2/evidence/D-0295.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0296 (or finish at 1000)
