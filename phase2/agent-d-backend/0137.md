...
As a **staff backend engineer**, harden `PersonalRanker` using **AsyncStream cancellation** (seed `b2bc5cda511c`).
...
- [ ] Evidence: `phase2/evidence/D-0137.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0138 (or finish at 1000)
