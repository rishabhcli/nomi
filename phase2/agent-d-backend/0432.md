...
As a **staff backend engineer**, harden `Inspector` using **numeric synthesis distractor immunity** (seed `aed9aca2a2ba`).
...
- [ ] Evidence: `phase2/evidence/D-0432.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0433 (or finish at 1000)
