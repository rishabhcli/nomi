# [D-0556] LocalExtractor: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `LocalExtractor` using **subprocess stderr backpressure** (seed `247356b8214d`).
...
- [ ] Evidence: `phase2/evidence/D-0556.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0557 (or finish at 1000)
