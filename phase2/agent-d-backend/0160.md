...
As a **staff backend engineer**, harden `CitationVerifier` using **mnemoctl JSON schema stability** (seed `190c9537b494`).
...
- [ ] Evidence: `phase2/evidence/D-0160.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0161 (or finish at 1000)
