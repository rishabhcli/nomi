...
As a **staff backend engineer**, harden `EgressGuard` using **QueryEvent ordering guarantees** (seed `01168f7c9014`).
...
- [ ] Evidence: `phase2/evidence/D-0179.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0180 (or finish at 1000)
