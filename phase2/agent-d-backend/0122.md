...
As a **staff backend engineer**, harden `MemoryDynamics` using **concurrency stress under WorkScheduler** (seed `c9c1bad1a500`).
...
- [ ] Evidence: `phase2/evidence/D-0122.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0123 (or finish at 1000)
