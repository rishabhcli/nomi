...
As a **staff backend engineer**, harden `Consolidation` using **profile preamble staleness** (seed `56bc0f198674`).
...
- [ ] Evidence: `phase2/evidence/D-0073.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0074 (or finish at 1000)
