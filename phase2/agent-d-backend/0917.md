# [D-0917] Highlight: AsyncStream cancellation
...
As a **staff backend engineer**, harden `Highlight` using **AsyncStream cancellation** (seed `33d6638deb08`).
...
- [ ] Evidence: `phase2/evidence/D-0917.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0918 (or finish at 1000)
