# [D-0535] Profile: egress guard host parsing
...
As a **staff backend engineer**, harden `Profile` using **egress guard host parsing** (seed `0201e29d6635`).
...
- [ ] Evidence: `phase2/evidence/D-0535.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0536 (or finish at 1000)
