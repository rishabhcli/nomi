# [D-0406] Coverage: token budget adversarial trim
...
As a **staff backend engineer**, harden `Coverage` using **token budget adversarial trim** (seed `79a5113d3cb8`).
...
- [ ] Evidence: `phase2/evidence/D-0406.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0407 (or finish at 1000)
