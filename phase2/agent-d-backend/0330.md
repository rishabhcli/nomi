...
As a **staff backend engineer**, harden `Inspector` using **ingest gate timing proofs** (seed `490ad0dfd5fb`).
...
- [ ] Evidence: `phase2/evidence/D-0330.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0331 (or finish at 1000)
