# [D-0258] RouterEscalator: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `RouterEscalator` using **TerminalState exhaustiveness** (seed `d2970980a6c7`).
...
- [ ] Evidence: `phase2/evidence/D-0258.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0259 (or finish at 1000)
