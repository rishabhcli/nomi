# [D-0837] ConflictDetector: AsyncStream cancellation
...
As a **staff backend engineer**, harden `ConflictDetector` using **AsyncStream cancellation** (seed `e3dc2a419bb4`).
...
- [ ] Evidence: `phase2/evidence/D-0837.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0838 (or finish at 1000)
