# [D-0414] EngineIntegration: answer cache key collision
...
As a **staff backend engineer**, harden `EngineIntegration` using **answer cache key collision** (seed `9e345cdfde16`).
...
- [ ] Evidence: `phase2/evidence/D-0414.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0415 (or finish at 1000)
