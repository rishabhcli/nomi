...
As a **staff backend engineer**, harden `NumericReasoner` using **router escalation boundaries** (seed `99696b7c8b1a`).
...
- [ ] Evidence: `phase2/evidence/D-0087.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0088 (or finish at 1000)
