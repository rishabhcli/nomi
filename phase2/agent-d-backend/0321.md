# [D-0321] OllamaClient: property-based invariants
...
As a **staff backend engineer**, harden `OllamaClient` using **property-based invariants** (seed `206c1482af38`).
...
- [ ] Evidence: `phase2/evidence/D-0321.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0322 (or finish at 1000)
