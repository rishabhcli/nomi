...
As a **staff backend engineer**, harden `ContextAssembler` using **numeric synthesis distractor immunity** (seed `85228c914b9f`).
...
- [ ] Evidence: `phase2/evidence/D-0472.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0473 (or finish at 1000)
