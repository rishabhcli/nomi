# [D-0836] MemoryDynamics: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `MemoryDynamics` using **subprocess stderr backpressure** (seed `3996a2719c41`).
...
- [ ] Evidence: `phase2/evidence/D-0836.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0837 (or finish at 1000)
