...
As a **staff backend engineer**, harden `MemoryDynamics` using **mnemoctl JSON schema stability** (seed `6f216c8c2562`).
...
- [ ] Evidence: `phase2/evidence/D-0020.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0021 (or finish at 1000)
