# [D-0355] Coverage: egress guard host parsing
...
As a **staff backend engineer**, harden `Coverage` using **egress guard host parsing** (seed `2875599fdc3d`).
...
- [ ] Evidence: `phase2/evidence/D-0355.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0356 (or finish at 1000)
