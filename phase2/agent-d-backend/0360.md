...
As a **staff backend engineer**, harden `RouterEscalator` using **mnemoctl JSON schema stability** (seed `33c412edb162`).
...
- [ ] Evidence: `phase2/evidence/D-0360.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0361 (or finish at 1000)
