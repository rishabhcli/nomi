# [D-0519] CharSpan: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `CharSpan` using **QueryEvent ordering guarantees** (seed `2ce28a921ccd`).
...
- [ ] Evidence: `phase2/evidence/D-0519.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0520 (or finish at 1000)
