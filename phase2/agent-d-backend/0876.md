# [D-0876] CharSpan: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `CharSpan` using **subprocess stderr backpressure** (seed `42bc8932aeda`).
...
- [ ] Evidence: `phase2/evidence/D-0876.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0877 (or finish at 1000)
