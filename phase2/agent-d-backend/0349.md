# [D-0349] CommandParser: memory supersession race conditions
...
As a **staff backend engineer**, harden `CommandParser` using **memory supersession race conditions** (seed `259e32d046d8`).
...
- [ ] Evidence: `phase2/evidence/D-0349.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0350 (or finish at 1000)
