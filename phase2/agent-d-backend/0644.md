# [D-0644] AdaptiveEffort: offline refusal paths
...
As a **staff backend engineer**, harden `AdaptiveEffort` using **offline refusal paths** (seed `f8bfcade9501`).
...
- [ ] Evidence: `phase2/evidence/D-0644.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0645 (or finish at 1000)
