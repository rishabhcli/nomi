# [D-0911] EntityExtractor: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `EntityExtractor` using **agentic grep deadlock prevention** (seed `a6f7fa3be217`).
...
- [ ] Evidence: `phase2/evidence/D-0911.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0912 (or finish at 1000)
