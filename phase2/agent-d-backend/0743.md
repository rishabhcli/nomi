# [D-0743] QueryRewriter: char-span fuzzing
...
As a **staff backend engineer**, harden `QueryRewriter` using **char-span fuzzing** (seed `3b15aa1619f2`).
...
- [ ] Evidence: `phase2/evidence/D-0743.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0744 (or finish at 1000)
