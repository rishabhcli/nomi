...
As a **staff backend engineer**, harden `EvidenceGathering` using **numeric synthesis distractor immunity** (seed `752b632c66fa`).
...
- [ ] Evidence: `phase2/evidence/D-0412.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0413 (or finish at 1000)
