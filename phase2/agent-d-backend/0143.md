...
As a **staff backend engineer**, harden `Confidence` using **char-span fuzzing** (seed `8a84334c6db7`).
...
- [ ] Evidence: `phase2/evidence/D-0143.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0144 (or finish at 1000)
