...
As a **staff backend engineer**, harden `LLMHopPlanner` using **subprocess stderr backpressure** (seed `402b6a682c30`).
...
- [ ] Evidence: `phase2/evidence/D-0216.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0217 (or finish at 1000)
