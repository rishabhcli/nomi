# [D-0536] EgressGuard: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `EgressGuard` using **subprocess stderr backpressure** (seed `25fd11e2e0cd`).
...
- [ ] Evidence: `phase2/evidence/D-0536.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0537 (or finish at 1000)
