# [D-0621] CharSpan: property-based invariants
...
As a **staff backend engineer**, harden `CharSpan` using **property-based invariants** (seed `9d75bcc4b603`).
...
- [ ] Evidence: `phase2/evidence/D-0621.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0622 (or finish at 1000)
