# [D-0931] ContextAssembler: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `ContextAssembler` using **agentic grep deadlock prevention** (seed `45b1085a08db`).
...
- [ ] Evidence: `phase2/evidence/D-0931.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0932 (or finish at 1000)
