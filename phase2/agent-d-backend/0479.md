...
As a **staff backend engineer**, harden `MemoryDynamics` using **QueryEvent ordering guarantees** (seed `c3cdae859375`).
...
- [ ] Evidence: `phase2/evidence/D-0479.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0480 (or finish at 1000)
