...
As a **staff backend engineer**, harden `Digest` using **agentic grep deadlock prevention** (seed `4d200f52176e`).
...
- [ ] Evidence: `phase2/evidence/D-0251.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0252 (or finish at 1000)
