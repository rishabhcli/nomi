# [D-0951] AnswerCache: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `AnswerCache` using **agentic grep deadlock prevention** (seed `dd69d4265438`).
...
- [ ] Evidence: `phase2/evidence/D-0951.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0952 (or finish at 1000)
