...
As a **staff backend engineer**, harden `ActionExtractor` using **offline refusal paths** (seed `942e169f4143`).
...
- [ ] Evidence: `phase2/evidence/D-0204.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0205 (or finish at 1000)
