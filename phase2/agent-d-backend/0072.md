...
| **Phase** | Foundation & Archaeology — Map every module; delete lies; establish ground truth |
| **Priority** | P0 |
| **Seed** | `d49ba2190609` |
...
As a **staff backend engineer**, harden `ConflictDetector` using **numeric synthesis distractor immunity** (seed `d49ba2190609`).
...
- [ ] Evidence: `phase2/evidence/D-0072.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0073 (or finish at 1000)
