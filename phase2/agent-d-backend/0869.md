# [D-0869] Router: memory supersession race conditions
...
As a **staff backend engineer**, harden `Router` using **memory supersession race conditions** (seed `ec157139b07a`).
...
- [ ] Evidence: `phase2/evidence/D-0869.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0870 (or finish at 1000)
