# [D-0864] Preferences: offline refusal paths
...
As a **staff backend engineer**, harden `Preferences` using **offline refusal paths** (seed `a24b94faec7c`).
...
- [ ] Evidence: `phase2/evidence/D-0864.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0865 (or finish at 1000)
