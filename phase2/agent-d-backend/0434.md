...
As a **staff backend engineer**, harden `EgressGuard` using **answer cache key collision** (seed `6ece7db38f85`).
...
- [ ] Evidence: `phase2/evidence/D-0434.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0435 (or finish at 1000)
