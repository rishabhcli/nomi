# [D-0747] AnswerCache: router escalation boundaries
...
As a **staff backend engineer**, harden `AnswerCache` using **router escalation boundaries** (seed `ef996b21865b`).
...
- [ ] Evidence: `phase2/evidence/D-0747.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0748 (or finish at 1000)
