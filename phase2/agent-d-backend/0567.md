# [D-0567] EngineIntegration: router escalation boundaries
...
As a **staff backend engineer**, harden `EngineIntegration` using **router escalation boundaries** (seed `2474b339a77f`).
...
- [ ] Evidence: `phase2/evidence/D-0567.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0568 (or finish at 1000)
