...
As a **staff backend engineer**, harden `NumericReasoner` using **agentic grep deadlock prevention** (seed `4ffd0a2086d9`).
...
- [ ] Evidence: `phase2/evidence/D-0291.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0292 (or finish at 1000)
