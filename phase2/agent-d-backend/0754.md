# [D-0754] FollowUp: answer cache key collision
...
As a **staff backend engineer**, harden `FollowUp` using **answer cache key collision** (seed `e0b49d67b2c6`).
...
- [ ] Evidence: `phase2/evidence/D-0754.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0755 (or finish at 1000)
