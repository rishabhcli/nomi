...
As a **staff backend engineer**, harden `Profile` using **concurrency stress under WorkScheduler** (seed `40cd1f52208e`).
...
- [ ] Evidence: `phase2/evidence/D-0382.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0383 (or finish at 1000)
