# [D-0942] Inspector: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `Inspector` using **concurrency stress under WorkScheduler** (seed `29021722928c`).
...
- [ ] Evidence: `phase2/evidence/D-0942.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0943 (or finish at 1000)
