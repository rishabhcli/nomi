# [D-0706] CommandParser: token budget adversarial trim
...
As a **staff backend engineer**, harden `CommandParser` using **token budget adversarial trim** (seed `48dd9ec1773b`).
...
- [ ] Evidence: `phase2/evidence/D-0706.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0707 (or finish at 1000)
