...
As a **staff backend engineer**, harden `EntityExtractor` using **offline refusal paths** (seed `f97d5e32bcc7`).
...
- [ ] Evidence: `phase2/evidence/D-0044.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0045 (or finish at 1000)
