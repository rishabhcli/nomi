# [D-0831] OllamaClient: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `OllamaClient` using **agentic grep deadlock prevention** (seed `eb7bd57c4374`).
...
- [ ] Evidence: `phase2/evidence/D-0831.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0832 (or finish at 1000)
