...
As a **staff backend engineer**, harden `EntityExtractor` using **AsyncStream cancellation** (seed `2c033b6439ff`).
...
- [ ] Evidence: `phase2/evidence/D-0197.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0198 (or finish at 1000)
