...
As a **staff backend engineer**, harden `FollowUp` using **agentic grep deadlock prevention** (seed `d78f6a9521d8`).
...
- [ ] Evidence: `phase2/evidence/D-0091.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0092 (or finish at 1000)
