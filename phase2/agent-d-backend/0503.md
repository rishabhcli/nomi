# [D-0503] EntityExtractor: char-span fuzzing
...
As a **staff backend engineer**, harden `EntityExtractor` using **char-span fuzzing** (seed `2f0508eb8dfb`).
...
- [ ] Evidence: `phase2/evidence/D-0503.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0504 (or finish at 1000)
