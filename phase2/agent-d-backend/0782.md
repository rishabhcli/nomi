# [D-0782] IngestGate: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `IngestGate` using **concurrency stress under WorkScheduler** (seed `222bfd0658bc`).
...
- [ ] Evidence: `phase2/evidence/D-0782.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0783 (or finish at 1000)
