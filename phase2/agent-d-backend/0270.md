...
As a **staff backend engineer**, harden `OllamaClient` using **ingest gate timing proofs** (seed `ed077be9f43b`).
...
- [ ] Evidence: `phase2/evidence/D-0270.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0271 (or finish at 1000)
