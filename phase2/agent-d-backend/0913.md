# [D-0913] LocalExtractor: profile preamble staleness
...
As a **staff backend engineer**, harden `LocalExtractor` using **profile preamble staleness** (seed `5fa1e66a53bb`).
...
- [ ] Evidence: `phase2/evidence/D-0913.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0914 (or finish at 1000)
