# [D-0617] EngineClient: AsyncStream cancellation
...
As a **staff backend engineer**, harden `EngineClient` using **AsyncStream cancellation** (seed `6d2583e16ccb`).
...
- [ ] Evidence: `phase2/evidence/D-0617.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0618 (or finish at 1000)
