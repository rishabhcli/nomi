...
As a **staff backend engineer**, harden `PersonalRanker` using **answer cache key collision** (seed `1a4fa51f6598`).
...
- [ ] Evidence: `phase2/evidence/D-0494.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0495 (or finish at 1000)
