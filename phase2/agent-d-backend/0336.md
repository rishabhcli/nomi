# [D-0336] QueryDecomposer: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `QueryDecomposer` using **subprocess stderr backpressure** (seed `5f4ecebc1589`).
...
- [ ] Evidence: `phase2/evidence/D-0336.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0337 (or finish at 1000)
