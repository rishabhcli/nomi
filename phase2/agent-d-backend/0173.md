...
As a **staff backend engineer**, harden `MemoryDynamics` using **profile preamble staleness** (seed `6de9d4edd97a`).
...
- [ ] Evidence: `phase2/evidence/D-0173.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0174 (or finish at 1000)
