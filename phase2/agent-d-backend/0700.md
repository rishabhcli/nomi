# [D-0700] TimeWindow: mnemoctl JSON schema stability
...
As a **staff backend engineer**, harden `TimeWindow` using **mnemoctl JSON schema stability** (seed `36f49510f641`).
...
- [ ] Evidence: `phase2/evidence/D-0700.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0701 (or finish at 1000)
