...
As a **staff backend engineer**, harden `ContentHash` using **answer cache key collision** (seed `31865e1d78f7`).
...
- [ ] Evidence: `phase2/evidence/D-0274.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0275 (or finish at 1000)
