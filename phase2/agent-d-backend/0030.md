# [D-0030] QueryDecomposer: ingest gate timing proofs
...
As a **staff backend engineer**, harden `QueryDecomposer` using **ingest gate timing proofs** (seed `db9b5a72948b`).
...
- [ ] Evidence: `phase2/evidence/D-0030.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0031 (or finish at 1000)
