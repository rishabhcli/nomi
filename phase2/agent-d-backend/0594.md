# [D-0594] AnswerCache: answer cache key collision
...
As a **staff backend engineer**, harden `AnswerCache` using **answer cache key collision** (seed `e51345b39dee`).
...
- [ ] Evidence: `phase2/evidence/D-0594.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0595 (or finish at 1000)
