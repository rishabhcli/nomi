...
As a **staff backend engineer**, harden `LocalExtractor` using **numeric synthesis distractor immunity** (seed `3b0ed469e41f`).
...
- [ ] Evidence: `phase2/evidence/D-0352.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0353 (or finish at 1000)
