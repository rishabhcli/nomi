...
As a **staff backend engineer**, harden `Highlight` using **property-based invariants** (seed `f33cf744bdca`).
...
- [ ] Evidence: `phase2/evidence/D-0101.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0102 (or finish at 1000)
