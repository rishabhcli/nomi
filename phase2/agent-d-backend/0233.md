...
As a **staff backend engineer**, harden `QueryRewriter` using **profile preamble staleness** (seed `ee746f7dc73b`).
...
- [ ] Evidence: `phase2/evidence/D-0233.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0234 (or finish at 1000)
