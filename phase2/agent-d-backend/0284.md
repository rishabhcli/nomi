# [D-0284] QueryRewriter: offline refusal paths
...
As a **staff backend engineer**, harden `QueryRewriter` using **offline refusal paths** (seed `26a15f5efbfe`).
...
- [ ] Evidence: `phase2/evidence/D-0284.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0285 (or finish at 1000)
