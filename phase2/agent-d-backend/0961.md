# [D-0961] CommandParser: property-based invariants
...
As a **staff backend engineer**, harden `CommandParser` using **property-based invariants** (seed `b6c2c754c5fd`).
...
- [ ] Evidence: `phase2/evidence/D-0961.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0962 (or finish at 1000)
