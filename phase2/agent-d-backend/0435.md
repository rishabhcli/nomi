...
As a **staff backend engineer**, harden `WorkScheduler` using **egress guard host parsing** (seed `355ac9142b4d`).
...
- [ ] Evidence: `phase2/evidence/D-0435.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0436 (or finish at 1000)
