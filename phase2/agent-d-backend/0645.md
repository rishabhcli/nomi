# [D-0645] AnswerCache: cache poisoning resistance
...
As a **staff backend engineer**, harden `AnswerCache` using **cache poisoning resistance** (seed `139dd0ca8d01`).
...
- [ ] Evidence: `phase2/evidence/D-0645.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0646 (or finish at 1000)
