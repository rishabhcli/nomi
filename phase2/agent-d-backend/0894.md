# [D-0894] WorkScheduler: answer cache key collision
...
As a **staff backend engineer**, harden `WorkScheduler` using **answer cache key collision** (seed `b5945f1e360c`).
...
- [ ] Evidence: `phase2/evidence/D-0894.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0895 (or finish at 1000)
