...
As a **staff backend engineer**, harden `IngestGate` using **QueryEvent ordering guarantees** (seed `f2bdeb848334`).
...
- [ ] Evidence: `phase2/evidence/D-0119.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0120 (or finish at 1000)
