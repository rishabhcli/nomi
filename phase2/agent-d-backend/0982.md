# [D-0982] ContextAssembler: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `ContextAssembler` using **concurrency stress under WorkScheduler** (seed `222ca1403f4c`).
...
- [ ] Evidence: `phase2/evidence/D-0982.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0983 (or finish at 1000)
