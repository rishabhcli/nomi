# [D-0822] EngineIntegration: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `EngineIntegration` using **concurrency stress under WorkScheduler** (seed `d825c654194f`).
...
- [ ] Evidence: `phase2/evidence/D-0822.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0823 (or finish at 1000)
