...
As a **staff backend engineer**, harden `ActionExtractor` using **QueryEvent ordering guarantees** (seed `ab3d0d663dbf`).
...
- [ ] Evidence: `phase2/evidence/D-0459.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0460 (or finish at 1000)
