...
As a **staff backend engineer**, harden `RouterEscalator` using **memory supersession race conditions** (seed `92798fb0971f`).
...
- [ ] Evidence: `phase2/evidence/D-0309.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0310 (or finish at 1000)
