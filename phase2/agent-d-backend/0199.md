...
As a **staff backend engineer**, harden `LocalExtractor` using **QueryEvent ordering guarantees** (seed `2d0f5cfff29c`).
...
- [ ] Evidence: `phase2/evidence/D-0199.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0200 (or finish at 1000)
