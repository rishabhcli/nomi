# [D-0154] QueryService: answer cache key collision
...
As a **staff backend engineer**, harden `QueryService` using **answer cache key collision** (seed `2288eb47dd81`).
...
- [ ] Evidence: `phase2/evidence/D-0154.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0155 (or finish at 1000)
