# [D-0964] LocalExtractor: offline refusal paths
...
As a **staff backend engineer**, harden `LocalExtractor` using **offline refusal paths** (seed `3a47ac278542`).
...
- [ ] Evidence: `phase2/evidence/D-0964.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0965 (or finish at 1000)
