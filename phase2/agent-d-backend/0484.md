...
As a **staff backend engineer**, harden `Profile` using **offline refusal paths** (seed `d762c39438ad`).
...
- [ ] Evidence: `phase2/evidence/D-0484.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0485 (or finish at 1000)
