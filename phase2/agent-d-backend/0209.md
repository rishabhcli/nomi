...
As a **staff backend engineer**, harden `EngineClient` using **memory supersession race conditions** (seed `d14fe26f5f9e`).
...
- [ ] Evidence: `phase2/evidence/D-0209.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0210 (or finish at 1000)
