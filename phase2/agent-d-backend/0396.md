...
As a **staff backend engineer**, harden `ResponseStyle` using **subprocess stderr backpressure** (seed `f8245531a614`).
...
- [ ] Evidence: `phase2/evidence/D-0396.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0397 (or finish at 1000)
