# [D-0897] QueryDecomposer: AsyncStream cancellation
...
As a **staff backend engineer**, harden `QueryDecomposer` using **AsyncStream cancellation** (seed `e5da67c55823`).
...
- [ ] Evidence: `phase2/evidence/D-0897.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0898 (or finish at 1000)
