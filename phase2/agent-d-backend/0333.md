...
As a **staff backend engineer**, harden `WorkScheduler` using **profile preamble staleness** (seed `41d064884eab`).
...
- [ ] Evidence: `phase2/evidence/D-0333.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0334 (or finish at 1000)
