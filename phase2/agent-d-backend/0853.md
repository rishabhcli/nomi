# [D-0853] TimeWindow: profile preamble staleness
...
As a **staff backend engineer**, harden `TimeWindow` using **profile preamble staleness** (seed `43e1b8a85942`).
...
- [ ] Evidence: `phase2/evidence/D-0853.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0854 (or finish at 1000)
