...
As a **staff backend engineer**, harden `ContentHash` using **router escalation boundaries** (seed `c6c4363dab7c`).
...
- [ ] Evidence: `phase2/evidence/D-0427.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0428 (or finish at 1000)
