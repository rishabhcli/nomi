# [D-0223] ContentHash: char-span fuzzing
...
As a **staff backend engineer**, harden `ContentHash` using **char-span fuzzing** (seed `bf499d01dab8`).
...
- [ ] Evidence: `phase2/evidence/D-0223.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0224 (or finish at 1000)
