# [D-0614] Router: answer cache key collision
...
As a **staff backend engineer**, harden `Router` using **answer cache key collision** (seed `acdcaa343cf5`).
...
- [ ] Evidence: `phase2/evidence/D-0614.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0615 (or finish at 1000)
