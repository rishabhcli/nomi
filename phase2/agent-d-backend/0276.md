# [D-0276] ConflictDetector: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `ConflictDetector` using **subprocess stderr backpressure** (seed `9868083d20c8`).
...
- [ ] Evidence: `phase2/evidence/D-0276.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0277 (or finish at 1000)
