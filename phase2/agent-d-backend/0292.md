# [D-0292] TimeWindow: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `TimeWindow` using **numeric synthesis distractor immunity** (seed `9f050566cb23`).
...
- [ ] Evidence: `phase2/evidence/D-0292.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0293 (or finish at 1000)
