# [D-0390] AnswerCache: ingest gate timing proofs
...
As a **staff backend engineer**, harden `AnswerCache` using **ingest gate timing proofs** (seed `9eeb05cc13d2`).
...
- [ ] Evidence: `phase2/evidence/D-0390.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0391 (or finish at 1000)
