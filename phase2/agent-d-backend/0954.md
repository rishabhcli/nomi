# [D-0954] NumericReasoner: answer cache key collision
...
As a **staff backend engineer**, harden `NumericReasoner` using **answer cache key collision** (seed `4c6b962047ed`).
...
- [ ] Evidence: `phase2/evidence/D-0954.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0955 (or finish at 1000)
