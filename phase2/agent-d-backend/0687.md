# [D-0687] Inspector: router escalation boundaries
...
As a **staff backend engineer**, harden `Inspector` using **router escalation boundaries** (seed `f7da95ead24f`).
...
- [ ] Evidence: `phase2/evidence/D-0687.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0688 (or finish at 1000)
