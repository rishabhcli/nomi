# [D-0255] ActionExtractor: egress guard host parsing
...
As a **staff backend engineer**, harden `ActionExtractor` using **egress guard host parsing** (seed `7987697fee74`).
...
- [ ] Evidence: `phase2/evidence/D-0255.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0256 (or finish at 1000)
