# [D-0586] Profile: token budget adversarial trim
...
As a **staff backend engineer**, harden `Profile` using **token budget adversarial trim** (seed `54d8d8b1aac9`).
...
- [ ] Evidence: `phase2/evidence/D-0586.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0587 (or finish at 1000)
