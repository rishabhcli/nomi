# [D-0512] Router: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `Router` using **numeric synthesis distractor immunity** (seed `f84ec9321351`).
...
- [ ] Evidence: `phase2/evidence/D-0512.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0513 (or finish at 1000)
