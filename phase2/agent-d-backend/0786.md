# [D-0786] ConflictDetector: token budget adversarial trim
...
As a **staff backend engineer**, harden `ConflictDetector` using **token budget adversarial trim** (seed `65db931a6e32`).
...
- [ ] Evidence: `phase2/evidence/D-0786.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0787 (or finish at 1000)
