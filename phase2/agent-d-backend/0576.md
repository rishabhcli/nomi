# [D-0576] OllamaClient: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `OllamaClient` using **subprocess stderr backpressure** (seed `7adf8c976e39`).
...
- [ ] Evidence: `phase2/evidence/D-0576.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0577 (or finish at 1000)
