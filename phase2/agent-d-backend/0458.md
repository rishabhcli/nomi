...
As a **staff backend engineer**, harden `Highlight` using **TerminalState exhaustiveness** (seed `2e71f0591464`).
...
- [ ] Evidence: `phase2/evidence/D-0458.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0459 (or finish at 1000)
