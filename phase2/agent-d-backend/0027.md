...
As a **staff backend engineer**, harden `WorkScheduler` using **router escalation boundaries** (seed `25557a1b21ec`).
...
- [ ] Evidence: `phase2/evidence/D-0027.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0028 (or finish at 1000)
