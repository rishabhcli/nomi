...
As a **staff backend engineer**, harden `TimelineBuilder` using **egress guard host parsing** (seed `d9562094bb01`).
...
- [ ] Evidence: `phase2/evidence/D-0395.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0396 (or finish at 1000)
