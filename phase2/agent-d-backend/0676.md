# [D-0676] ContextAssembler: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `ContextAssembler` using **subprocess stderr backpressure** (seed `457f856d2df0`).
...
- [ ] Evidence: `phase2/evidence/D-0676.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0677 (or finish at 1000)
