# [D-0636] Inspector: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `Inspector` using **subprocess stderr backpressure** (seed `341517f037ce`).
...
- [ ] Evidence: `phase2/evidence/D-0636.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0637 (or finish at 1000)
