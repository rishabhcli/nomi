# [D-0722] SpanResolver: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `SpanResolver` using **concurrency stress under WorkScheduler** (seed `ba351a03148d`).
...
- [ ] Evidence: `phase2/evidence/D-0722.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0723 (or finish at 1000)
