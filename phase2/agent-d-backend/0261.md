...
As a **staff backend engineer**, harden `EngineIntegration` using **property-based invariants** (seed `1f2228c4157a`).
...
- [ ] Evidence: `phase2/evidence/D-0261.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0262 (or finish at 1000)
