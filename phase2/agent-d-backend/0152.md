...
As a **staff backend engineer**, harden `Highlight` using **numeric synthesis distractor immunity** (seed `33c114edc5fe`).
...
- [ ] Evidence: `phase2/evidence/D-0152.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0153 (or finish at 1000)
