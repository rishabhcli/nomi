# [D-0998] QueryRewriter: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `QueryRewriter` using **TerminalState exhaustiveness** (seed `f6ab00417796`).
...
- [ ] Evidence: `phase2/evidence/D-0998.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0999 (or finish at 1000)
