...
As a **staff backend engineer**, harden `IngestGate` using **ingest gate timing proofs** (seed `6e7491367a0e`).
...
- [ ] Evidence: `phase2/evidence/D-0170.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0171 (or finish at 1000)
