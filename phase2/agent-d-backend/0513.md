# [D-0513] RouterEscalator: profile preamble staleness
...
As a **staff backend engineer**, harden `RouterEscalator` using **profile preamble staleness** (seed `601174684099`).
...
- [ ] Evidence: `phase2/evidence/D-0513.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0514 (or finish at 1000)
