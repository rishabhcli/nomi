...
As a **staff backend engineer**, harden `Consolidation` using **AsyncStream cancellation** (seed `57597154c450`).
...
- [ ] Evidence: `phase2/evidence/D-0277.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0278 (or finish at 1000)
