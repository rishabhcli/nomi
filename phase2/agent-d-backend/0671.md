# [D-0671] SpanResolver: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `SpanResolver` using **agentic grep deadlock prevention** (seed `59c27152c807`).
...
- [ ] Evidence: `phase2/evidence/D-0671.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0672 (or finish at 1000)
