# [D-0995] EgressGuard: egress guard host parsing
...
As a **staff backend engineer**, harden `EgressGuard` using **egress guard host parsing** (seed `d1a0ef5368a9`).
...
- [ ] Evidence: `phase2/evidence/D-0995.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0996 (or finish at 1000)
