...
As a **staff backend engineer**, harden `ScopeClassifier` using **agentic grep deadlock prevention** (seed `23ea5484db73`).
...
- [ ] Evidence: `phase2/evidence/D-0031.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0032 (or finish at 1000)
