# [D-0631] ContentHash: agentic grep deadlock prevention
...
As a **staff backend engineer**, harden `ContentHash` using **agentic grep deadlock prevention** (seed `7c7dc937a3e2`).
...
- [ ] Evidence: `phase2/evidence/D-0631.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0632 (or finish at 1000)
