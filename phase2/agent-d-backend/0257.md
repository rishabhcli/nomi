# [D-0257] Router: AsyncStream cancellation
...
As a **staff backend engineer**, harden `Router` using **AsyncStream cancellation** (seed `a16278aa8139`).
...
- [ ] Evidence: `phase2/evidence/D-0257.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0258 (or finish at 1000)
