# [D-0354] Preferences: answer cache key collision
...
As a **staff backend engineer**, harden `Preferences` using **answer cache key collision** (seed `6e5a50721847`).
...
- [ ] Evidence: `phase2/evidence/D-0354.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0355 (or finish at 1000)
