...
As a **staff backend engineer**, harden `ContextAssembler` using **profile preamble staleness** (seed `bdafd1517fcd`).
...
- [ ] Evidence: `phase2/evidence/D-0013.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0014 (or finish at 1000)
