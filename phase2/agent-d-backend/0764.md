# [D-0764] Highlight: offline refusal paths
...
As a **staff backend engineer**, harden `Highlight` using **offline refusal paths** (seed `c00516f815fd`).
...
- [ ] Evidence: `phase2/evidence/D-0764.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0765 (or finish at 1000)
