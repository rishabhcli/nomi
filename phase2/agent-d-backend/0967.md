# [D-0967] Coverage: router escalation boundaries
...
As a **staff backend engineer**, harden `Coverage` using **router escalation boundaries** (seed `743a210dc36a`).
...
- [ ] Evidence: `phase2/evidence/D-0967.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0968 (or finish at 1000)
