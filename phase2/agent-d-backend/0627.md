# [D-0627] OllamaClient: router escalation boundaries
...
As a **staff backend engineer**, harden `OllamaClient` using **router escalation boundaries** (seed `4d34aa3ba29d`).
...
- [ ] Evidence: `phase2/evidence/D-0627.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0628 (or finish at 1000)
