...
As a **staff backend engineer**, harden `IngestGate` using **cache poisoning resistance** (seed `4588904f982a`).
...
- [ ] Evidence: `phase2/evidence/D-0425.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0426 (or finish at 1000)
