# [D-0601] FollowUp: property-based invariants
...
As a **staff backend engineer**, harden `FollowUp` using **property-based invariants** (seed `90a2c053f6ac`).
...
- [ ] Evidence: `phase2/evidence/D-0601.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0602 (or finish at 1000)
