...
As a **staff backend engineer**, harden `FollowUp` using **offline refusal paths** (seed `490f49196e70`).
...
- [ ] Evidence: `phase2/evidence/D-0244.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0245 (or finish at 1000)
