...
As a **staff backend engineer**, harden `SpanResolver` using **numeric synthesis distractor immunity** (seed `2115c838e98d`).
...
- [ ] Evidence: `phase2/evidence/D-0212.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0213 (or finish at 1000)
