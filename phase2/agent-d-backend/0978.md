# [D-0978] CharSpan: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `CharSpan` using **TerminalState exhaustiveness** (seed `ac711fa7ddf1`).
...
- [ ] Evidence: `phase2/evidence/D-0978.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0979 (or finish at 1000)
