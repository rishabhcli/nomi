...
As a **staff backend engineer**, harden `CitationVerifier` using **concurrency stress under WorkScheduler** (seed `d9c31ac8a0cb`).
...
- [ ] Evidence: `phase2/evidence/D-0262.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0263 (or finish at 1000)
