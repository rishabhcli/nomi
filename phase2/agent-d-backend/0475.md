# [D-0475] Ingestion: egress guard host parsing
...
As a **staff backend engineer**, harden `Ingestion` using **egress guard host parsing** (seed `3ebc1250aad2`).
...
- [ ] Evidence: `phase2/evidence/D-0475.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0476 (or finish at 1000)
