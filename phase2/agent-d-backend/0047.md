...
As a **staff backend engineer**, harden `Digest` using **router escalation boundaries** (seed `f6685efbb838`).
...
- [ ] Evidence: `phase2/evidence/D-0047.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0048 (or finish at 1000)
