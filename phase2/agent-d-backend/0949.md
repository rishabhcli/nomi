# [D-0949] ScopeClassifier: memory supersession race conditions
...
As a **staff backend engineer**, harden `ScopeClassifier` using **memory supersession race conditions** (seed `6eaf0d4aa254`).
...
- [ ] Evidence: `phase2/evidence/D-0949.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0950 (or finish at 1000)
