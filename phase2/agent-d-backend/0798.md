# [D-0798] AnswerCache: TerminalState exhaustiveness
...
As a **staff backend engineer**, harden `AnswerCache` using **TerminalState exhaustiveness** (seed `ea81b2255b56`).
...
- [ ] Evidence: `phase2/evidence/D-0798.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0799 (or finish at 1000)
