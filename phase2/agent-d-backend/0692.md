# [D-0692] QueryRewriter: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `QueryRewriter` using **numeric synthesis distractor immunity** (seed `cf924c92abfa`).
...
- [ ] Evidence: `phase2/evidence/D-0692.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0693 (or finish at 1000)
