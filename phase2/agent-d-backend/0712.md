# [D-0712] Coverage: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `Coverage` using **numeric synthesis distractor immunity** (seed `82eca6bc3d1e`).
...
- [ ] Evidence: `phase2/evidence/D-0712.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0713 (or finish at 1000)
