# [D-0973] EvidenceGathering: profile preamble staleness
...
As a **staff backend engineer**, harden `EvidenceGathering` using **profile preamble staleness** (seed `fd8596ddf751`).
...
- [ ] Evidence: `phase2/evidence/D-0973.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0974 (or finish at 1000)
