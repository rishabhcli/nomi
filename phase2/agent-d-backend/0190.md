...
As a **staff backend engineer**, harden `TimeWindow` using **ingest gate timing proofs** (seed `4303aa63cad6`).
...
- [ ] Evidence: `phase2/evidence/D-0190.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0191 (or finish at 1000)
