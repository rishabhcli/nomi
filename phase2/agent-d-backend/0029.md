...
As a **staff backend engineer**, harden `QueryRewriter` using **memory supersession race conditions** (seed `c03cdc35f196`).
...
- [ ] Evidence: `phase2/evidence/D-0029.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0030 (or finish at 1000)
