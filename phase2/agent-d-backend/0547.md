# [D-0547] TimeWindow: router escalation boundaries
...
As a **staff backend engineer**, harden `TimeWindow` using **router escalation boundaries** (seed `8cc3253c442e`).
...
- [ ] Evidence: `phase2/evidence/D-0547.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0548 (or finish at 1000)
