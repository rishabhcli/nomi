# [D-0784] ContentHash: offline refusal paths
...
As a **staff backend engineer**, harden `ContentHash` using **offline refusal paths** (seed `4d8c731fd055`).
...
- [ ] Evidence: `phase2/evidence/D-0784.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0785 (or finish at 1000)
