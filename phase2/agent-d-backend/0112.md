...
As a **staff backend engineer**, harden `AgenticGrep` using **numeric synthesis distractor immunity** (seed `060cf86823bd`).
...
- [ ] Evidence: `phase2/evidence/D-0112.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0113 (or finish at 1000)
