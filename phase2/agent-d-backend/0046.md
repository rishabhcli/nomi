# [D-0046] LocalExtractor: token budget adversarial trim
...
As a **staff backend engineer**, harden `LocalExtractor` using **token budget adversarial trim** (seed `013d189fc0fa`).
...
- [ ] Evidence: `phase2/evidence/D-0046.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0047 (or finish at 1000)
