# [D-0914] Digest: answer cache key collision
...
As a **staff backend engineer**, harden `Digest` using **answer cache key collision** (seed `b4a6b39cf091`).
...
- [ ] Evidence: `phase2/evidence/D-0914.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0915 (or finish at 1000)
