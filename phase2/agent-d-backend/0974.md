# [D-0974] EngineClient: answer cache key collision
...
As a **staff backend engineer**, harden `EngineClient` using **answer cache key collision** (seed `2c294e3bec58`).
...
- [ ] Evidence: `phase2/evidence/D-0974.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0975 (or finish at 1000)
