...
As a **staff backend engineer**, harden `EgressGuard` using **property-based invariants** (seed `2c9e25e760d6`).
...
- [ ] Evidence: `phase2/evidence/D-0281.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0282 (or finish at 1000)
