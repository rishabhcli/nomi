# [D-0713] Highlight: profile preamble staleness
...
As a **staff backend engineer**, harden `Highlight` using **profile preamble staleness** (seed `bdf3b4961b7f`).
...
- [ ] Evidence: `phase2/evidence/D-0713.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0714 (or finish at 1000)
