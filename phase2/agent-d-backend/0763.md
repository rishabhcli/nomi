# [D-0763] Coverage: char-span fuzzing
...
As a **staff backend engineer**, harden `Coverage` using **char-span fuzzing** (seed `414d9eec4825`).
...
- [ ] Evidence: `phase2/evidence/D-0763.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0764 (or finish at 1000)
