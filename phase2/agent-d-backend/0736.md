# [D-0736] Consolidation: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `Consolidation` using **subprocess stderr backpressure** (seed `e811ce12b647`).
...
- [ ] Evidence: `phase2/evidence/D-0736.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0737 (or finish at 1000)
