...
As a **staff backend engineer**, harden `SyncEngine` using **concurrency stress under WorkScheduler** (seed `29ca1169afda`).
...
- [ ] Evidence: `phase2/evidence/D-0222.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0223 (or finish at 1000)
