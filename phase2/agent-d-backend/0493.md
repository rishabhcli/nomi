...
As a **staff backend engineer**, harden `QueryHistory` using **profile preamble staleness** (seed `ca2e407cb5ef`).
...
- [ ] Evidence: `phase2/evidence/D-0493.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0494 (or finish at 1000)
