...
As a **staff backend engineer**, harden `TimelineBuilder` using **token budget adversarial trim** (seed `223b45b34635`).
...
- [ ] Evidence: `phase2/evidence/D-0446.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0447 (or finish at 1000)
