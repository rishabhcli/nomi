...
As a **staff backend engineer**, harden `ContextAssembler` using **QueryEvent ordering guarantees** (seed `61c8ca3cf46a`).
...
- [ ] Evidence: `phase2/evidence/D-0319.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0320 (or finish at 1000)
