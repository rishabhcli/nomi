# [D-0859] CommandParser: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `CommandParser` using **QueryEvent ordering guarantees** (seed `fd8a952c3a1c`).
...
- [ ] Evidence: `phase2/evidence/D-0859.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0860 (or finish at 1000)
