# [D-0633] ConflictDetector: profile preamble staleness
...
As a **staff backend engineer**, harden `ConflictDetector` using **profile preamble staleness** (seed `0c9beff6d870`).
...
- [ ] Evidence: `phase2/evidence/D-0633.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0634 (or finish at 1000)
