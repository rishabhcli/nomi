# [D-0922] EvidenceGathering: concurrency stress under WorkScheduler

| Field | Value |
|-------|-------|
| **Queue** | 922 / 1000 |
| **Agent** | D — Backend / Query Brain |
| **Phase** | Capstone & Synthesis — End-to-end excellence; final evidence bundle |
| **Priority** | P3 |
| **Seed** | `00c610a4fa63` |
...
As a **staff backend engineer**, harden `EvidenceGathering` using **concurrency stress under WorkScheduler** (seed `00c610a4fa63`).
...
- [ ] Evidence: `phase2/evidence/D-0922.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0923 (or finish at 1000)
