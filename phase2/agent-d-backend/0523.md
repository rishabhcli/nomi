# [D-0523] ContextAssembler: char-span fuzzing
...
As a **staff backend engineer**, harden `ContextAssembler` using **char-span fuzzing** (seed `1c5aaf2121dc`).
...
- [ ] Evidence: `phase2/evidence/D-0523.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0524 (or finish at 1000)
