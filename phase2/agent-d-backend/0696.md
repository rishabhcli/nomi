# [D-0696] AnswerCache: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `AnswerCache` using **subprocess stderr backpressure** (seed `dae13ec4a3f2`).
...
- [ ] Evidence: `phase2/evidence/D-0696.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0697 (or finish at 1000)
