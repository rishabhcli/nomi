...
As a **staff backend engineer**, harden `QueryHistory` using **subprocess stderr backpressure** (seed `2d597e195dac`).
...
- [ ] Evidence: `phase2/evidence/D-0136.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0137 (or finish at 1000)
