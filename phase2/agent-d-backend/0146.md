...
As a **staff backend engineer**, harden `EntityExtractor` using **token budget adversarial trim** (seed `f7cdf76ea677`).
...
- [ ] Evidence: `phase2/evidence/D-0146.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0147 (or finish at 1000)
