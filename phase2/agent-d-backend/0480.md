# [D-0480] ConflictDetector: mnemoctl JSON schema stability
...
As a **staff backend engineer**, harden `ConflictDetector` using **mnemoctl JSON schema stability** (seed `8986fa0e54db`).
...
- [ ] Evidence: `phase2/evidence/D-0480.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0481 (or finish at 1000)
