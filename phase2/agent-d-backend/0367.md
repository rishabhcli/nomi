...
As a **staff backend engineer**, harden `AgenticGrep` using **router escalation boundaries** (seed `c82485cb27ab`).
...
- [ ] Evidence: `phase2/evidence/D-0367.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0368 (or finish at 1000)
