...
As a **staff backend engineer**, harden `SpanResolver` using **ingest gate timing proofs** (seed `92cb6fb3a89f`).
...
- [ ] Evidence: `phase2/evidence/D-0110.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0111 (or finish at 1000)
