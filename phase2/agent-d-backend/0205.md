...
As a **staff backend engineer**, harden `QueryService` using **cache poisoning resistance** (seed `3deba1cc27f7`).
...
- [ ] Evidence: `phase2/evidence/D-0205.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0206 (or finish at 1000)
