# [D-0972] RouterEscalator: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `RouterEscalator` using **numeric synthesis distractor immunity** (seed `72e44b2ea55b`).
...
- [ ] Evidence: `phase2/evidence/D-0972.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0973 (or finish at 1000)
