# [D-0421] ContextAssembler: property-based invariants
...
As a **staff backend engineer**, harden `ContextAssembler` using **property-based invariants** (seed `5acaa7642a90`).
...
- [ ] Evidence: `phase2/evidence/D-0421.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0422 (or finish at 1000)
