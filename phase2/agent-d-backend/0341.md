...
As a **staff backend engineer**, harden `PersonalRanker` using **property-based invariants** (seed `0e9c45dc75ae`).
...
- [ ] Evidence: `phase2/evidence/D-0341.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0342 (or finish at 1000)
