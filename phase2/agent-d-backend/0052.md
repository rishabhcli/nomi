...
As a **staff backend engineer**, harden `QueryService` using **numeric synthesis distractor immunity** (seed `876f36438d31`).
...
- [ ] Evidence: `phase2/evidence/D-0052.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0053 (or finish at 1000)
