# [D-0516] EngineIntegration: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `EngineIntegration` using **subprocess stderr backpressure** (seed `c03c1932654f`).
...
- [ ] Evidence: `phase2/evidence/D-0516.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0517 (or finish at 1000)
