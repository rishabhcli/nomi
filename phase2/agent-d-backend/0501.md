# [D-0501] Provenance: property-based invariants
...
As a **staff backend engineer**, harden `Provenance` using **property-based invariants** (seed `a384cf7a8a6b`).
...
- [ ] Evidence: `phase2/evidence/D-0501.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0502 (or finish at 1000)
