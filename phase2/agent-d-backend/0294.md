...
As a **staff backend engineer**, harden `ResponseStyle` using **answer cache key collision** (seed `b452e4238872`).
...
- [ ] Evidence: `phase2/evidence/D-0294.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0295 (or finish at 1000)
