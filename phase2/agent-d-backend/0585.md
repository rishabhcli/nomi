# [D-0585] Inspector: cache poisoning resistance
...
As a **staff backend engineer**, harden `Inspector` using **cache poisoning resistance** (seed `8f29ec960137`).
...
- [ ] Evidence: `phase2/evidence/D-0585.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0586 (or finish at 1000)
