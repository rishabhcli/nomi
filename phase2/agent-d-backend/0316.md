...
As a **staff backend engineer**, harden `AgenticGrep` using **subprocess stderr backpressure** (seed `35849d9f78f6`).
...
- [ ] Evidence: `phase2/evidence/D-0316.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0317 (or finish at 1000)
