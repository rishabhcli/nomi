# [D-0524] Prompt: offline refusal paths
...
As a **staff backend engineer**, harden `Prompt` using **offline refusal paths** (seed `a6d2bf653e4a`).
...
- [ ] Evidence: `phase2/evidence/D-0524.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0525 (or finish at 1000)
