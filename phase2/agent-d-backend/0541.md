# [D-0541] ScopeClassifier: property-based invariants
...
As a **staff backend engineer**, harden `ScopeClassifier` using **property-based invariants** (seed `210ddf388c2a`).
...
- [ ] Evidence: `phase2/evidence/D-0541.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0542 (or finish at 1000)
