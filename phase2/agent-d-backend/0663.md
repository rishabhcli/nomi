# [D-0663] ActionExtractor: char-span fuzzing
...
As a **staff backend engineer**, harden `ActionExtractor` using **char-span fuzzing** (seed `27b3794f35d2`).
...
- [ ] Evidence: `phase2/evidence/D-0663.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0664 (or finish at 1000)
