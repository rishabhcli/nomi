...
As a **staff backend engineer**, harden `OllamaClient` using **egress guard host parsing** (seed `63f70d070176`).
...
- [ ] Evidence: `phase2/evidence/D-0015.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0016 (or finish at 1000)
