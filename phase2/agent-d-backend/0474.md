# [D-0474] OllamaClient: answer cache key collision
...
As a **staff backend engineer**, harden `OllamaClient` using **answer cache key collision** (seed `dd14c17e3ac4`).
...
- [ ] Evidence: `phase2/evidence/D-0474.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0475 (or finish at 1000)
