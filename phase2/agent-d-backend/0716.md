# [D-0716] Router: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `Router` using **subprocess stderr backpressure** (seed `348fa49c4b83`).
...
- [ ] Evidence: `phase2/evidence/D-0716.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0717 (or finish at 1000)
