# [D-0927] CharSpan: router escalation boundaries
...
As a **staff backend engineer**, harden `CharSpan` using **router escalation boundaries** (seed `d725bb89414f`).
...
- [ ] Evidence: `phase2/evidence/D-0927.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0928 (or finish at 1000)
