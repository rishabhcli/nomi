...
As a **staff backend engineer**, harden `EgressGuard` using **char-span fuzzing** (seed `ca6eeee8777c`).
...
- [ ] Evidence: `phase2/evidence/D-0383.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0384 (or finish at 1000)
