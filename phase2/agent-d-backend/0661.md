# [D-0661] Coverage: property-based invariants
...
As a **staff backend engineer**, harden `Coverage` using **property-based invariants** (seed `1daab436e554`).
...
- [ ] Evidence: `phase2/evidence/D-0661.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0662 (or finish at 1000)
