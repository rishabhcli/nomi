# [D-0675] LLMHopPlanner: egress guard host parsing
...
As a **staff backend engineer**, harden `LLMHopPlanner` using **egress guard host parsing** (seed `5c38e2d3ba2a`).
...
- [ ] Evidence: `phase2/evidence/D-0675.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0676 (or finish at 1000)
