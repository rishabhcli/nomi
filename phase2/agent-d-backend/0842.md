# [D-0842] EgressGuard: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `EgressGuard` using **concurrency stress under WorkScheduler** (seed `f85699101bd8`).
...
- [ ] Evidence: `phase2/evidence/D-0842.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0843 (or finish at 1000)
