# [D-0939] ConflictDetector: QueryEvent ordering guarantees
...
As a **staff backend engineer**, harden `ConflictDetector` using **QueryEvent ordering guarantees** (seed `84d6427fed40`).
...
- [ ] Evidence: `phase2/evidence/D-0939.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0940 (or finish at 1000)
