...
As a **staff backend engineer**, harden `QueryRewriter` using **mnemoctl JSON schema stability** (seed `8bcf6c3ac633`).
...
- [ ] Evidence: `phase2/evidence/D-0080.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0081 (or finish at 1000)
