# [D-0733] ContentHash: profile preamble staleness
...
As a **staff backend engineer**, harden `ContentHash` using **profile preamble staleness** (seed `20afa74d011b`).
...
- [ ] Evidence: `phase2/evidence/D-0733.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0734 (or finish at 1000)
