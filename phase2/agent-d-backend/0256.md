# [D-0256] QueryService: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `QueryService` using **subprocess stderr backpressure** (seed `c0447134da67`).
...
- [ ] Evidence: `phase2/evidence/D-0256.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0257 (or finish at 1000)
