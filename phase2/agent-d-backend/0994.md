# [D-0994] Profile: answer cache key collision
...
As a **staff backend engineer**, harden `Profile` using **answer cache key collision** (seed `1d692bc62eaf`).
...
- [ ] Evidence: `phase2/evidence/D-0994.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0995 (or finish at 1000)
