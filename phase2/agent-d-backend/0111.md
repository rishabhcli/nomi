...
As a **staff backend engineer**, harden `CharSpan` using **agentic grep deadlock prevention** (seed `c05dbd5ed0f7`).
...
- [ ] Evidence: `phase2/evidence/D-0111.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0112 (or finish at 1000)
