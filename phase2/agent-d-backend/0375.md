# [D-0375] SyncEngine: egress guard host parsing
...
As a **staff backend engineer**, harden `SyncEngine` using **egress guard host parsing** (seed `c85e143e063b`).
...
- [ ] Evidence: `phase2/evidence/D-0375.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0376 (or finish at 1000)
