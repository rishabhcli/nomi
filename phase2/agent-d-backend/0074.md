...
As a **staff backend engineer**, harden `LLMSynthesizer` using **answer cache key collision** (seed `54824a63987d`).
...
- [ ] Evidence: `phase2/evidence/D-0074.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0075 (or finish at 1000)
