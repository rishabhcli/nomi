...
As a **staff backend engineer**, harden `SyncEngine` using **offline refusal paths** (seed `db5c20e8647b`).
...
- [ ] Evidence: `phase2/evidence/D-0324.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0325 (or finish at 1000)
