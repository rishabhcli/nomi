...
As a **staff backend engineer**, harden `Preferences` using **property-based invariants** (seed `bc5f6b15be43`).
...
- [ ] Evidence: `phase2/evidence/D-0201.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0202 (or finish at 1000)
