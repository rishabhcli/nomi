...
As a **staff backend engineer**, harden `AnswerCache` using **token budget adversarial trim** (seed `d3631502ea84`).
...
- [ ] Evidence: `phase2/evidence/D-0186.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0187 (or finish at 1000)
