# [D-0856] FollowUp: subprocess stderr backpressure
...
As a **staff backend engineer**, harden `FollowUp` using **subprocess stderr backpressure** (seed `1d2d35eebe19`).
...
- [ ] Evidence: `phase2/evidence/D-0856.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0857 (or finish at 1000)
