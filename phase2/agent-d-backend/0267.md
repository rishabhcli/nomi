...
As a **staff backend engineer**, harden `LLMHopPlanner` using **router escalation boundaries** (seed `d6b1f2034db5`).
...
- [ ] Evidence: `phase2/evidence/D-0267.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0268 (or finish at 1000)
