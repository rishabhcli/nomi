# [D-0934] Ingestion: answer cache key collision
...
As a **staff backend engineer**, harden `Ingestion` using **answer cache key collision** (seed `60336f47f1dc`).
...
- [ ] Evidence: `phase2/evidence/D-0934.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0935 (or finish at 1000)
