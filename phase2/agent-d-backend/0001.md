# [D-0001] QueryService: property-based invariants
...
As a **staff backend engineer**, harden `QueryService` using **property-based invariants** (seed `0a95dece6bd1`).
...
- [ ] Evidence: `phase2/evidence/D-0001.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0002 (or finish at 1000)
