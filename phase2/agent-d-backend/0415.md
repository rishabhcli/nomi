# [D-0415] CitationVerifier: egress guard host parsing
...
As a **staff backend engineer**, harden `CitationVerifier` using **egress guard host parsing** (seed `b1497340628f`).
...
- [ ] Evidence: `phase2/evidence/D-0415.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0416 (or finish at 1000)
