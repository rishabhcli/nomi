# [D-0824] SpanResolver: offline refusal paths
...
As a **staff backend engineer**, harden `SpanResolver` using **offline refusal paths** (seed `2fb6ec3ed345`).
...
- [ ] Evidence: `phase2/evidence/D-0824.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0825 (or finish at 1000)
