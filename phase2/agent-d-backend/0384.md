# [D-0384] WorkScheduler: offline refusal paths
...
As a **staff backend engineer**, harden `WorkScheduler` using **offline refusal paths** (seed `93f166ff9d72`).
...
- [ ] Evidence: `phase2/evidence/D-0384.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0385 (or finish at 1000)
