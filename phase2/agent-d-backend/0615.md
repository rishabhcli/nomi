# [D-0615] RouterEscalator: egress guard host parsing
...
As a **staff backend engineer**, harden `RouterEscalator` using **egress guard host parsing** (seed `a2bfd1d839d3`).
...
- [ ] Evidence: `phase2/evidence/D-0615.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0616 (or finish at 1000)
