...
As a **staff backend engineer**, harden `LocalExtractor` using **AsyncStream cancellation** (seed `5ee26c46d9f6`).
...
- [ ] Evidence: `phase2/evidence/D-0097.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0098 (or finish at 1000)
