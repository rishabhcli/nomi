...
As a **staff backend engineer**, harden `ContextAssembler` using **ingest gate timing proofs** (seed `04f0cd35b696`).
...
- [ ] Evidence: `phase2/evidence/D-0370.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0371 (or finish at 1000)
