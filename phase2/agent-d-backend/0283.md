...
As a **staff backend engineer**, harden `NotchReducer` using **char-span fuzzing** (seed `093b2115372a`).
...
- [ ] Evidence: `phase2/evidence/D-0283.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0284 (or finish at 1000)
