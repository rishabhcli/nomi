...
As a **staff backend engineer**, harden `EvidenceGathering` using **AsyncStream cancellation** (seed `2a61c75139b6`).
...
- [ ] Evidence: `phase2/evidence/D-0157.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0158 (or finish at 1000)
