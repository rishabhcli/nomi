# [D-0742] NotchReducer: concurrency stress under WorkScheduler
...
As a **staff backend engineer**, harden `NotchReducer` using **concurrency stress under WorkScheduler** (seed `2dae601f17d6`).
...
- [ ] Evidence: `phase2/evidence/D-0742.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0743 (or finish at 1000)
