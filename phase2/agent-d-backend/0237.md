...
As a **staff backend engineer**, harden `AnswerCache` using **AsyncStream cancellation** (seed `6f80ef5e9c16`).
...
- [ ] Evidence: `phase2/evidence/D-0237.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0238 (or finish at 1000)
