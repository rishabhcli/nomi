# [D-0606] MediaCompanion: token budget adversarial trim
...
As a **staff backend engineer**, harden `MediaCompanion` using **token budget adversarial trim** (seed `3a301d7a1744`).
...
- [ ] Evidence: `phase2/evidence/D-0606.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0607 (or finish at 1000)
