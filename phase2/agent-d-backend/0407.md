# [D-0407] Highlight: router escalation boundaries
...
As a **staff backend engineer**, harden `Highlight` using **router escalation boundaries** (seed `8a7c47e44a78`).
...
- [ ] Evidence: `phase2/evidence/D-0407.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0408 (or finish at 1000)
