...
As a **staff backend engineer**, harden `ContentHash` using **property-based invariants** (seed `4740317b85fa`).
...
- [ ] Evidence: `phase2/evidence/D-0121.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0122 (or finish at 1000)
