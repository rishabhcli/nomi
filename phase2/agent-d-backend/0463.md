...
As a **staff backend engineer**, harden `EvidenceGathering` using **char-span fuzzing** (seed `45d42bb11a5e`).
...
- [ ] Evidence: `phase2/evidence/D-0463.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0464 (or finish at 1000)
