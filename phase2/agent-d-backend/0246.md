...
As a **staff backend engineer**, harden `Provenance` using **token budget adversarial trim** (seed `bba4241ed9f2`).
...
- [ ] Evidence: `phase2/evidence/D-0246.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0247 (or finish at 1000)
