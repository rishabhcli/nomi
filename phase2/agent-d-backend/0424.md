...
As a **staff backend engineer**, harden `Ingestion` using **offline refusal paths** (seed `5d6a3abbd8c2`).
...
- [ ] Evidence: `phase2/evidence/D-0424.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0425 (or finish at 1000)
