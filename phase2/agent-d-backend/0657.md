# [D-0657] MediaCompanion: AsyncStream cancellation
...
As a **staff backend engineer**, harden `MediaCompanion` using **AsyncStream cancellation** (seed `acbf4c21af53`).
...
- [ ] Evidence: `phase2/evidence/D-0657.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0658 (or finish at 1000)
