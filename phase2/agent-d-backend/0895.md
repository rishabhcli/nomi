# [D-0895] NotchReducer: egress guard host parsing
...
As a **staff backend engineer**, harden `NotchReducer` using **egress guard host parsing** (seed `8272359b270c`).
...
- [ ] Evidence: `phase2/evidence/D-0895.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0896 (or finish at 1000)
