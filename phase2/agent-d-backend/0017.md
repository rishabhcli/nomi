...
As a **staff backend engineer**, harden `IngestGate` using **AsyncStream cancellation** (seed `402ba36fd5c9`).
...
- [ ] Evidence: `phase2/evidence/D-0017.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0018 (or finish at 1000)
