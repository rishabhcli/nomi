...
As a **staff backend engineer**, harden `QueryDecomposer` using **property-based invariants** (seed `d1a7358b21f5`).
...
- [ ] Evidence: `phase2/evidence/D-0081.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0082 (or finish at 1000)
