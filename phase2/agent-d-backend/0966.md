# [D-0966] Preferences: token budget adversarial trim
...
As a **staff backend engineer**, harden `Preferences` using **token budget adversarial trim** (seed `038f0bbfe65c`).
...
- [ ] Evidence: `phase2/evidence/D-0966.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0967 (or finish at 1000)
