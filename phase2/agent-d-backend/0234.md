...
As a **staff backend engineer**, harden `QueryDecomposer` using **answer cache key collision** (seed `bcb99b19a4df`).
...
- [ ] Evidence: `phase2/evidence/D-0234.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0235 (or finish at 1000)
