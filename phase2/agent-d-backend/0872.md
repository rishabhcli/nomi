# [D-0872] EngineClient: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `EngineClient` using **numeric synthesis distractor immunity** (seed `47ccbff5c1f4`).
...
- [ ] Evidence: `phase2/evidence/D-0872.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0873 (or finish at 1000)
