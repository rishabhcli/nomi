# [D-0372] OllamaClient: numeric synthesis distractor immunity
...
As a **staff backend engineer**, harden `OllamaClient` using **numeric synthesis distractor immunity** (seed `09d217b74d15`).
...
- [ ] Evidence: `phase2/evidence/D-0372.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0373 (or finish at 1000)
