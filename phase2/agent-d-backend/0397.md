...
As a **staff backend engineer**, harden `FollowUp` using **AsyncStream cancellation** (seed `ecda87db8496`).
...
- [ ] Evidence: `phase2/evidence/D-0397.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0398 (or finish at 1000)
