# [D-0714] ActionExtractor: answer cache key collision
...
As a **staff backend engineer**, harden `ActionExtractor` using **answer cache key collision** (seed `bb528f361159`).
...
- [ ] Evidence: `phase2/evidence/D-0714.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to D-0715 (or finish at 1000)
