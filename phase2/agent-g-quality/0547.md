# [G-0547] QA: PII log redaction scan on AgenticGrep
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `AgenticGrep` (seed `b91411e1422a`).
...
- [ ] Evidence: `phase2/evidence/G-0547.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0548 (or finish at 1000)
