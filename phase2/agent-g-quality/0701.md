# [G-0701] QA: egress injection attempts on ContextAssembler
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `ContextAssembler` (seed `9fb353360f5c`).
...
- [ ] Evidence: `phase2/evidence/G-0701.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0702 (or finish at 1000)
