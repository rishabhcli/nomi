# [G-0048] QA: document error rate tracking on CommandParser
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `CommandParser` (seed `ab1a669bbf15`).
...
- [ ] Evidence: `phase2/evidence/G-0048.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0049 (or finish at 1000)
