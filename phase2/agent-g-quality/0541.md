# [G-0541] QA: mutation testing mindset on CommandParser
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CommandParser` (seed `7eb9aabc218a`).
...
- [ ] Evidence: `phase2/evidence/G-0541.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0542 (or finish at 1000)
