# [G-0506] QA: regression fixture expansion on FollowUp
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `FollowUp` (seed `f1d41bc89a50`).
...
- [ ] Evidence: `phase2/evidence/G-0506.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0507 (or finish at 1000)
