# [G-0592] QA: invariant property tests on CommandParser
...
As a **staff QA/security engineer**, apply **invariant property tests** against `CommandParser` (seed `b1c0205d0695`).
...
- [ ] Evidence: `phase2/evidence/G-0592.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0593 (or finish at 1000)
