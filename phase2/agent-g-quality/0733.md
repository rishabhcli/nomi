# [G-0733] QA: mutation testing mindset on CitationVerifier
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CitationVerifier` (seed `7727cb6fbcb2`).
...
- [ ] Evidence: `phase2/evidence/G-0733.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0734 (or finish at 1000)
