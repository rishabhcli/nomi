# [G-0053] QA: egress injection attempts on CitationVerifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CitationVerifier` (seed `2137f13d587a`).
...
- [ ] Evidence: `phase2/evidence/G-0053.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0054 (or finish at 1000)
