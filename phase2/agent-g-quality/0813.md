# [G-0813] QA: silent catch eradication on CommandParser
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `CommandParser` (seed `67a98523ca1b`).
...
- [ ] Evidence: `phase2/evidence/G-0813.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0814 (or finish at 1000)
