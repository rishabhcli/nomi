# [G-0950] QA: regression fixture expansion on LocalExtractor
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `LocalExtractor` (seed `4931eba81e47`).
...
- [ ] Evidence: `phase2/evidence/G-0950.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0951 (or finish at 1000)
