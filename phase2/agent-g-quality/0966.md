# [G-0966] QA: loopback spoof hostnames on CommandParser
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CommandParser` (seed `cb030e161a91`).
...
- [ ] Evidence: `phase2/evidence/G-0966.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0967 (or finish at 1000)
