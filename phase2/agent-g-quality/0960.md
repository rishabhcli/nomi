# [G-0960] QA: document error rate tracking on Profile
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Profile` (seed `387a0e69ce1c`).
...
- [ ] Evidence: `phase2/evidence/G-0960.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0961 (or finish at 1000)
