# [G-0264] QA: document error rate tracking on NotchReducer
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `NotchReducer` (seed `71a8abf3bb78`).
...
- [ ] Evidence: `phase2/evidence/G-0264.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0265 (or finish at 1000)
