# [G-0484] QA: invariant property tests on Profile
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Profile` (seed `b129e01cfafc`).
...
- [ ] Evidence: `phase2/evidence/G-0484.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0485 (or finish at 1000)
