# [G-0189] QA: silent catch eradication on CitationVerifier
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `CitationVerifier` (seed `7e5adc9b534e`).
...
- [ ] Evidence: `phase2/evidence/G-0189.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0190 (or finish at 1000)
