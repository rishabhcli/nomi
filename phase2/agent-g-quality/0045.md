# [G-0045] QA: silent catch eradication on QueryHistory
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryHistory` (seed `9c5c88e70e1b`).
...
- [ ] Evidence: `phase2/evidence/G-0045.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0046 (or finish at 1000)
