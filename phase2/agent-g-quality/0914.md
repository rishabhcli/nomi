# [G-0914] QA: regression fixture expansion on FollowUp
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `FollowUp` (seed `9011b333831c`).
...
- [ ] Evidence: `phase2/evidence/G-0914.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0915 (or finish at 1000)
