# [G-0553] QA: mutation testing mindset on NotchReducer
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `NotchReducer` (seed `94356b6b82db`).
...
- [ ] Evidence: `phase2/evidence/G-0553.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0554 (or finish at 1000)
