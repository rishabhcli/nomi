# [G-0786] QA: loopback spoof hostnames on ContextAssembler
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ContextAssembler` (seed `c7f409140cde`).
...
- [ ] Evidence: `phase2/evidence/G-0786.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0787 (or finish at 1000)
