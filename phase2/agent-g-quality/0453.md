# [G-0453] QA: silent catch eradication on QueryHistory
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryHistory` (seed `3aa66a29ea90`).
...
- [ ] Evidence: `phase2/evidence/G-0453.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0454 (or finish at 1000)
