# [G-0312] QA: document error rate tracking on ContentHash
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ContentHash` (seed `67c853c34a40`).
...
- [ ] Evidence: `phase2/evidence/G-0312.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0313 (or finish at 1000)
