# [G-0399] QA: BS-M12 transcript audit on Profile
...
As a **staff QA/security engineer**, apply **BS-M12 transcript audit** against `Profile` (seed `8a5ab4425c91`).
...
- [ ] Evidence: `phase2/evidence/G-0399.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0400 (or finish at 1000)
