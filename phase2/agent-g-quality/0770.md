# [G-0770] QA: regression fixture expansion on Ingestion
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Ingestion` (seed `f9a20981071a`).
...
- [ ] Evidence: `phase2/evidence/G-0770.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0771 (or finish at 1000)
