# [G-0670] QA: test flake dection on Consolidation
...
As a **staff QA/security engineer**, apply **test flake dection** against `Consolidation` (seed `0757451c5b7b`).
...
- [ ] Evidence: `phase2/evidence/G-0670.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0671 (or finish at 1000)
