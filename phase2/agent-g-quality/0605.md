# [G-0605] QA: egress injection attempts on ScopeClassifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `ScopeClassifier` (seed `dab1eeb23562`).
...
- [ ] Evidence: `phase2/evidence/G-0605.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0606 (or finish at 1000)
