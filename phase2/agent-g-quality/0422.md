# [G-0422] QA: regression fixture expansion on CommandParser
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CommandParser` (seed `0e17d1274193`).
...
- [ ] Evidence: `phase2/evidence/G-0422.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0423 (or finish at 1000)
