# [G-0445] QA: mutation testing mindset on AgenticGrep
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `AgenticGrep` (seed `46b89730da9d`).
...
- [ ] Evidence: `phase2/evidence/G-0445.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0446 (or finish at 1000)
