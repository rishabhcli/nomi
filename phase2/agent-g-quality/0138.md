# [G-0138] QA: loopback spoof hostnames on CitationVerifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CitationVerifier` (seed `33d0b099eef5`).
...
- [ ] Evidence: `phase2/evidence/G-0138.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0139 (or finish at 1000)
