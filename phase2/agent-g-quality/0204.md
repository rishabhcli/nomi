# [G-0204] QA: document error rate tracking on QueryService
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryService` (seed `f6c7ee27b907`).
...
- [ ] Evidence: `phase2/evidence/G-0204.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0205 (or finish at 1000)
