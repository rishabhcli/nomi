# [G-0737] QA: egress injection attempts on ContentHash
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `ContentHash` (seed `38d4e1bfbd41`).
...
- [ ] Evidence: `phase2/evidence/G-0737.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0738 (or finish at 1000)
