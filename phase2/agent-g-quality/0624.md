# [G-0624] QA: document error rate tracking on TimeWindow
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `TimeWindow` (seed `7b21f0ab7d9c`).
...
- [ ] Evidence: `phase2/evidence/G-0624.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0625 (or finish at 1000)
