# [G-0026] QA: regression fixture expansion on NotchReducer
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `NotchReducer` (seed `59c52f932597`).
...
**Targets:** `NotchReducer.swift` + exhaustive test coverage expansion
...
- [ ] Evidence: `phase2/evidence/G-0026.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0027 (or finish at 1000)
