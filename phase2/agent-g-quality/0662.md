# [G-0662] QA: regression fixture expansion on Coverage
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Coverage` (seed `a45b5ca9daad`).
...
- [ ] Evidence: `phase2/evidence/G-0662.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0663 (or finish at 1000)
