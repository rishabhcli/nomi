# [G-0744] QA: document error rate tracking on FollowUp
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `FollowUp` (seed `257d2b0609a8`).
...
- [ ] Evidence: `phase2/evidence/G-0744.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0745 (or finish at 1000)
