# [G-0302] QA: regression fixture expansion on FollowUp
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `FollowUp` (seed `43eb3f01d355`).
...
- [ ] Evidence: `phase2/evidence/G-0302.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0303 (or finish at 1000)
