# [G-0391] QA: PII log redaction scan on QueryService
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `QueryService` (seed `127d26b3e9bb`).
...
- [ ] Evidence: `phase2/evidence/G-0391.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0392 (or finish at 1000)
