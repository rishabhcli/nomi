# [G-0816] QA: document error rate tracking on QueryService
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryService` (seed `eed29d159cc6`).
...
- [ ] Evidence: `phase2/evidence/G-0816.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0817 (or finish at 1000)
