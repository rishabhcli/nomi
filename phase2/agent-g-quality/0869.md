# [G-0869] QA: egress injection attempts on CitationVerifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CitationVerifier` (seed `23b25651c9ff`).
...
- [ ] Evidence: `phase2/evidence/G-0869.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0870 (or finish at 1000)
