# [G-0540] QA: document error rate tracking on FollowUp
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `FollowUp` (seed `164c4c096d71`).
...
- [ ] Evidence: `phase2/evidence/G-0540.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0541 (or finish at 1000)
