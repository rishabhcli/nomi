# [G-0717] QA: silent catch eradication on AgenticGrep
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `AgenticGrep` (seed `45995fab7816`).
...
- [ ] Evidence: `phase2/evidence/G-0717.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0718 (or finish at 1000)
