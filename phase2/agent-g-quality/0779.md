# [G-0779] QA: use-case harness isolation on CommandParser
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `CommandParser` (seed `3c01eb74726c`).
...
- [ ] Evidence: `phase2/evidence/G-0779.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0780 (or finish at 1000)
