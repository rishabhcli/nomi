# [G-0596] QA: force-unwrap elimination on EvidenceGathering
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `EvidenceGathering` (seed `ff3241b4c716`).
...
- [ ] Evidence: `phase2/evidence/G-0596.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0597 (or finish at 1000)
