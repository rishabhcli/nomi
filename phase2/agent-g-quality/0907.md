# [G-0907] QA: PII log redaction scan on ContentHash
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `ContentHash` (seed `0083078c20da`).
...
- [ ] Evidence: `phase2/evidence/G-0907.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0908 (or finish at 1000)
