# [G-0573] QA: silent catch eradication on TimeWindow
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `TimeWindow` (seed `1ce9a4409de7`).
...
- [ ] Evidence: `phase2/evidence/G-0573.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0574 (or finish at 1000)
