# [G-0201] QA: silent catch eradication on CommandParser
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `CommandParser` (seed `f0eca5496bc7`).
...
- [ ] Evidence: `phase2/evidence/G-0201.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0202 (or finish at 1000)
