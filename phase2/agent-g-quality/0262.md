# [G-0262] QA: test flake dection on Consolidation
...
As a **staff QA/security engineer**, apply **test flake dection** against `Consolidation` (seed `235a18dd4c65`).
...
- [ ] Evidence: `phase2/evidence/G-0262.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0263 (or finish at 1000)
