# [G-0514] QA: test flake dection on ContextAssembler
...
As a **staff QA/security engineer**, apply **test flake dection** against `ContextAssembler` (seed `b26a65ff47e0`).
...
- [ ] Evidence: `phase2/evidence/G-0514.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0515 (or finish at 1000)
