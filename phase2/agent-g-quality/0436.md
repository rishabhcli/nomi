# [G-0436] QA: invariant property tests on QueryHistory
...
As a **staff QA/security engineer**, apply **invariant property tests** against `QueryHistory` (seed `5f1212ef3502`).
...
- [ ] Evidence: `phase2/evidence/G-0436.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0437 (or finish at 1000)
