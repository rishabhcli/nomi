# [G-0684] QA: document error rate tracking on ContextAssembler
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ContextAssembler` (seed `189595f67f5c`).
...
- [ ] Evidence: `phase2/evidence/G-0684.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0685 (or finish at 1000)
