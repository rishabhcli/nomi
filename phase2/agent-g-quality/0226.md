# [G-0226] QA: test flake dection on Ingestion
...
As a **staff QA/security engineer**, apply **test flake dection** against `Ingestion` (seed `3fe71453c373`).
...
- [ ] Evidence: `phase2/evidence/G-0226.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0227 (or finish at 1000)
