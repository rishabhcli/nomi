# [G-0954] QA: loopback spoof hostnames on CitationVerifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CitationVerifier` (seed `c6465e13924f`).
...
- [ ] Evidence: `phase2/evidence/G-0954.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0955 (or finish at 1000)
