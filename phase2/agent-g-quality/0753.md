# [G-0753] QA: silent catch eradication on Ingestion
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Ingestion` (seed `5823823b48fa`).
...
- [ ] Evidence: `phase2/evidence/G-0753.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0754 (or finish at 1000)
