# [G-0901] QA: mutation testing mindset on QueryService
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `QueryService` (seed `43c6272b1219`).
...
- [ ] Evidence: `phase2/evidence/G-0901.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0902 (or finish at 1000)
