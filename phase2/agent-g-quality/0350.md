# [G-0350] QA: regression fixture expansion on ScopeClassifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ScopeClassifier` (seed `b77b96f141f9`).
...
- [ ] Evidence: `phase2/evidence/G-0350.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0351 (or finish at 1000)
