# [G-0394] QA: test flake dection on AgenticGrep
...
As a **staff QA/security engineer**, apply **test flake dection** against `AgenticGrep` (seed `1ca3f412e02e`).
...
- [ ] Evidence: `phase2/evidence/G-0394.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0395 (or finish at 1000)
