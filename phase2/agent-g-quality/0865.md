# [G-0865] QA: mutation testing mindset on LocalExtractor
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `LocalExtractor` (seed `ba42405ca331`).
...
- [ ] Evidence: `phase2/evidence/G-0865.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0866 (or finish at 1000)
