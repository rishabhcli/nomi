# [G-0942] QA: loopback spoof hostnames on Consolidation
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `Consolidation` (seed `794bca9ff0e3`).
...
- [ ] Evidence: `phase2/evidence/G-0942.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0943 (or finish at 1000)
