# [G-0442] QA: test flake dection on QueryService
...
As a **staff QA/security engineer**, apply **test flake dection** against `QueryService` (seed `bdb7a2edb923`).
...
- [ ] Evidence: `phase2/evidence/G-0442.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0443 (or finish at 1000)
