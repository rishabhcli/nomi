# [G-0307] QA: PII log redaction scan on EvidenceGathering
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `EvidenceGathering` (seed `2cb297200373`).
...
- [ ] Evidence: `phase2/evidence/G-0307.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0308 (or finish at 1000)
