# [G-0745] QA: mutation testing mindset on CommandParser
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CommandParser` (seed `7a5ac8674ac1`).
...
- [ ] Evidence: `phase2/evidence/G-0745.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0746 (or finish at 1000)
