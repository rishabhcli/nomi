# [G-0739] QA: PII log redaction scan on Profile
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `Profile` (seed `75b89d430b88`).
...
- [ ] Evidence: `phase2/evidence/G-0739.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0740 (or finish at 1000)
