# [G-0313] QA: mutation testing mindset on Consolidation
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `Consolidation` (seed `22e819152e82`).
...
- [ ] Evidence: `phase2/evidence/G-0313.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0314 (or finish at 1000)
