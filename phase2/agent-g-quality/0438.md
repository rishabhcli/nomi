# [G-0438] QA: loopback spoof hostnames on FollowUp
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `FollowUp` (seed `20ff967ff7ca`).
...
- [ ] Evidence: `phase2/evidence/G-0438.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0439 (or finish at 1000)
