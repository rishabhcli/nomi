# [G-0469] QA: mutation testing mindset on ScopeClassifier
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `ScopeClassifier` (seed `3285f8a378e2`).
...
- [ ] Evidence: `phase2/evidence/G-0469.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0470 (or finish at 1000)
