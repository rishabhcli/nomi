# [G-0749] QA: egress injection attempts on EvidenceGathering
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `EvidenceGathering` (seed `d6c8bbb36310`).
...
- [ ] Evidence: `phase2/evidence/G-0749.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0750 (or finish at 1000)
