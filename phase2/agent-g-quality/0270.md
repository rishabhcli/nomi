# [G-0270] QA: loopback spoof hostnames on LocalExtractor
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `LocalExtractor` (seed `d983b20fb694`).
...
- [ ] Evidence: `phase2/evidence/G-0270.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0271 (or finish at 1000)
