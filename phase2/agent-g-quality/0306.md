# [G-0306] QA: loopback spoof hostnames on QueryService
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `QueryService` (seed `3bc5003062ea`).
...
- [ ] Evidence: `phase2/evidence/G-0306.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0307 (or finish at 1000)
