# [G-0510] QA: loopback spoof hostnames on QueryService
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `QueryService` (seed `cc5711edeeb9`).
...
- [ ] Evidence: `phase2/evidence/G-0510.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0511 (or finish at 1000)
