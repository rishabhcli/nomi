# [G-0202] QA: test flake dection on LocalExtractor
...
As a **staff QA/security engineer**, apply **test flake dection** against `LocalExtractor` (seed `ef6826f7b698`).
...
- [ ] Evidence: `phase2/evidence/G-0202.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0203 (or finish at 1000)
