# [G-0178] QA: test flake dection on Profile
...
As a **staff QA/security engineer**, apply **test flake dection** against `Profile` (seed `0044193c0093`).
...
- [ ] Evidence: `phase2/evidence/G-0178.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0179 (or finish at 1000)
