# [G-0647] QA: use-case harness isolation on EvidenceGathering
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `EvidenceGathering` (seed `cdfd92e82c0d`).
...
- [ ] Evidence: `phase2/evidence/G-0647.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0648 (or finish at 1000)
