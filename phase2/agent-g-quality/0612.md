# [G-0612] QA: document error rate tracking on QueryService
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryService` (seed `c4eb74d96146`).
...
- [ ] Evidence: `phase2/evidence/G-0612.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0613 (or finish at 1000)
