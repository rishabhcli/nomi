# [G-0990] QA: loopback spoof hostnames on ContextAssembler
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ContextAssembler` (seed `070fd850f092`).
...
- [ ] Evidence: `phase2/evidence/G-0990.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0991 (or finish at 1000)
