# [G-0386] QA: regression fixture expansion on TimeWindow
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `TimeWindow` (seed `1d5242373ab8`).
...
- [ ] Evidence: `phase2/evidence/G-0386.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0387 (or finish at 1000)
