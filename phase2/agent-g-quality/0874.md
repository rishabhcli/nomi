# [G-0874] QA: test flake dection on Consolidation
...
As a **staff QA/security engineer**, apply **test flake dection** against `Consolidation` (seed `7c527d0cae10`).
...
- [ ] Evidence: `phase2/evidence/G-0874.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0875 (or finish at 1000)
