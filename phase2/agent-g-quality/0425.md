# [G-0425] QA: egress injection attempts on QueryService
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `QueryService` (seed `d961f494535e`).
...
- [ ] Evidence: `phase2/evidence/G-0425.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0426 (or finish at 1000)
