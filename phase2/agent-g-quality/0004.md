# [G-0004] QA: invariant property tests on ContextAssembler
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ContextAssembler` (seed `5c461358bb07`).
...
- [ ] Evidence: `phase2/evidence/G-0004.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0005 (or finish at 1000)
