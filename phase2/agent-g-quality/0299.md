# [G-0299] QA: use-case harness isolation on ScopeClassifier
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `ScopeClassifier` (seed `3faf9043ca2c`).
...
- [ ] Evidence: `phase2/evidence/G-0299.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0300 (or finish at 1000)
