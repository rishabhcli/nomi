# [G-0842] QA: regression fixture expansion on NotchReducer
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `NotchReducer` (seed `e8e276c08af6`).
...
- [ ] Evidence: `phase2/evidence/G-0842.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0843 (or finish at 1000)
