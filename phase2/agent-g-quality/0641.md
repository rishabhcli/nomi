# [G-0641] QA: egress injection attempts on TimeWindow
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `TimeWindow` (seed `d0a7f7a24c3c`).
...
- [ ] Evidence: `phase2/evidence/G-0641.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0642 (or finish at 1000)
