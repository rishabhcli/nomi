# [G-0730] QA: test flake dection on Coverage
...
As a **staff QA/security engineer**, apply **test flake dection** against `Coverage` (seed `006652219bfc`).
...
- [ ] Evidence: `phase2/evidence/G-0730.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0731 (or finish at 1000)
