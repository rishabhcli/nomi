# [G-0580] QA: invariant property tests on CitationVerifier
...
As a **staff QA/security engineer**, apply **invariant property tests** against `CitationVerifier` (seed `1fab83fb5ebb`).
...
- [ ] Evidence: `phase2/evidence/G-0580.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0581 (or finish at 1000)
