# [G-0876] QA: document error rate tracking on NotchReducer
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `NotchReducer` (seed `a0d99b1688ac`).
...
- [ ] Evidence: `phase2/evidence/G-0876.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0877 (or finish at 1000)
