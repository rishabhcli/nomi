# [G-0557] QA: egress injection attempts on FollowUp
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `FollowUp` (seed `e45671f92e49`).
...
- [ ] Evidence: `phase2/evidence/G-0557.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0558 (or finish at 1000)
