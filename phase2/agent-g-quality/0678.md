# [G-0678] QA: loopback spoof hostnames on LocalExtractor
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `LocalExtractor` (seed `327de8a3b0d3`).
...
- [ ] Evidence: `phase2/evidence/G-0678.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0679 (or finish at 1000)
