# [G-0767] QA: use-case harness isolation on CitationVerifier
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `CitationVerifier` (seed `b79483479ce2`).
...
- [ ] Evidence: `phase2/evidence/G-0767.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0768 (or finish at 1000)
