# [G-0989] QA: egress injection attempts on AgenticGrep
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `AgenticGrep` (seed `2528dacb1fe1`).
...
- [ ] Evidence: `phase2/evidence/G-0989.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0990 (or finish at 1000)
