# [G-0727] QA: PII log redaction scan on FollowUp
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `FollowUp` (seed `0deb7105e491`).
...
- [ ] Evidence: `phase2/evidence/G-0727.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0728 (or finish at 1000)
