# [G-0496] QA: invariant property tests on AgenticGrep
...
As a **staff QA/security engineer**, apply **invariant property tests** against `AgenticGrep` (seed `9be43e4ad17f`).
...
- [ ] Evidence: `phase2/evidence/G-0496.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0497 (or finish at 1000)
