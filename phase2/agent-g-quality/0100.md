# [G-0100] QA: invariant property tests on LocalExtractor
...
As a **staff QA/security engineer**, apply **invariant property tests** against `LocalExtractor` (seed `5e6ec23b9070`).
...
- [ ] Evidence: `phase2/evidence/G-0100.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0101 (or finish at 1000)
