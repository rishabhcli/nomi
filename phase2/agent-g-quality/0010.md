# [G-0010] QA: test flake dection on ScopeClassifier
...
As a **staff QA/security engineer**, apply **test flake dection** against `ScopeClassifier` (seed `149f7391baa4`).
...
- [ ] Evidence: `phase2/evidence/G-0010.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0011 (or finish at 1000)
