# [G-0197] QA: egress injection attempts on ScopeClassifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `ScopeClassifier` (seed `f9248a0f71cb`).
...
- [ ] Evidence: `phase2/evidence/G-0197.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0198 (or finish at 1000)
