# [G-0845] QA: egress injection attempts on TimeWindow
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `TimeWindow` (seed `2b4b059217d8`).
...
- [ ] Evidence: `phase2/evidence/G-0845.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0846 (or finish at 1000)
