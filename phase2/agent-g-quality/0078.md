# [G-0078] QA: loopback spoof hostnames on ScopeClassifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ScopeClassifier` (seed `3fecf41aece6`).
...
- [ ] Evidence: `phase2/evidence/G-0078.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0079 (or finish at 1000)
