# [G-0038] QA: regression fixture expansion on ContextAssembler
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContextAssembler` (seed `e50b0a1e9f0b`).
...
**Targets:** `ContextAssembler.swift` + exhaustive test coverage expansion
...
- [ ] Evidence: `phase2/evidence/G-0038.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0039 (or finish at 1000)
