# [G-0250] QA: test flake dection on TimeWindow
...
As a **staff QA/security engineer**, apply **test flake dection** against `TimeWindow` (seed `f2f42c54e279`).
...
- [ ] Evidence: `phase2/evidence/G-0250.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0251 (or finish at 1000)
