# [G-0805] QA: mutation testing mindset on ContentHash
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `ContentHash` (seed `ea35b1579d2c`).
...
- [ ] Evidence: `phase2/evidence/G-0805.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0806 (or finish at 1000)
