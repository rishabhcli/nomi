# [G-0461] QA: egress injection attempts on CitationVerifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CitationVerifier` (seed `712853958b69`).
...
- [ ] Evidence: `phase2/evidence/G-0461.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0462 (or finish at 1000)
