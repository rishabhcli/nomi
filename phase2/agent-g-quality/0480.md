# [G-0480] QA: document error rate tracking on ContextAssembler
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ContextAssembler` (seed `4791ce299995`).
...
- [ ] Evidence: `phase2/evidence/G-0480.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0481 (or finish at 1000)
