# [G-0984] QA: document error rate tracking on LocalExtractor
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `LocalExtractor` (seed `3280882744c6`).
...
- [ ] Evidence: `phase2/evidence/G-0984.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0985 (or finish at 1000)
