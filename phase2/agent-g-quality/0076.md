# [G-0076] QA: invariant property tests on Profile
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Profile` (seed `948c9b178f63`).
...
- [ ] Evidence: `phase2/evidence/G-0076.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0077 (or finish at 1000)
