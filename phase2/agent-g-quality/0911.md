# [G-0911] QA: use-case harness isolation on ScopeClassifier
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `ScopeClassifier` (seed `a32a316b707a`).
...
- [ ] Evidence: `phase2/evidence/G-0911.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0912 (or finish at 1000)
