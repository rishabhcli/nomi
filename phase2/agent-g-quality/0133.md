# [G-0133] QA: mutation testing mindset on CommandParser
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CommandParser` (seed `99cc408d79b1`).
...
- [ ] Evidence: `phase2/evidence/G-0133.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0134 (or finish at 1000)
