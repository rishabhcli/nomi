# [G-0804] QA: document error rate tracking on Ingestion
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Ingestion` (seed `4ff3f855e2a0`).
...
- [ ] Evidence: `phase2/evidence/G-0804.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0805 (or finish at 1000)
