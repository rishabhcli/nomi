# [G-0809] QA: egress injection attempts on ScopeClassifier
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `ScopeClassifier` (seed `47ce3ca40dc0`).
...
- [ ] Evidence: `phase2/evidence/G-0809.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0810 (or finish at 1000)
