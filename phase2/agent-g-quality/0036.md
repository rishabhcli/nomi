# [G-0036] QA: document error rate tracking on CitationVerifier
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `CitationVerifier` (seed `71e1b4eba28c`).
...
- [ ] Evidence: `phase2/evidence/G-0036.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0037 (or finish at 1000)
