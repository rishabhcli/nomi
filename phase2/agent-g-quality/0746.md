# [G-0746] QA: regression fixture expansion on LocalExtractor
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `LocalExtractor` (seed `8ed1dfbdb78c`).
...
- [ ] Evidence: `phase2/evidence/G-0746.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0747 (or finish at 1000)
