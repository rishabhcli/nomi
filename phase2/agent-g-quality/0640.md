# [G-0640] QA: invariant property tests on QueryHistory
...
As a **staff QA/security engineer**, apply **invariant property tests** against `QueryHistory` (seed `1f9aed08b9ec`).
...
- [ ] Evidence: `phase2/evidence/G-0640.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0641 (or finish at 1000)
