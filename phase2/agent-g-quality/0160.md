# [G-0160] QA: invariant property tests on Consolidation
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Consolidation` (seed `feec76509ed2`).
...
- [ ] Evidence: `phase2/evidence/G-0160.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0161 (or finish at 1000)
