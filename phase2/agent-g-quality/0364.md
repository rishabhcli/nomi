# [G-0364] QA: invariant property tests on Consolidation
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Consolidation` (seed `08a5debf2b8d`).
...
- [ ] Evidence: `phase2/evidence/G-0364.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0365 (or finish at 1000)
