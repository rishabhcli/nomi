# [G-0214] QA: test flake dection on ScopeClassifier
...
As a **staff QA/security engineer**, apply **test flake dection** against `ScopeClassifier` (seed `c56fb47b8c6e`).
...
- [ ] Evidence: `phase2/evidence/G-0214.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0215 (or finish at 1000)
