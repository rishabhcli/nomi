# [G-0166] QA: test flake dection on FollowUp
...
As a **staff QA/security engineer**, apply **test flake dection** against `FollowUp` (seed `c3c94016f0a1`).
...
- [ ] Evidence: `phase2/evidence/G-0166.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0167 (or finish at 1000)
