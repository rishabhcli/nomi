# [G-0129] QA: silent catch eradication on ScopeClassifier
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `ScopeClassifier` (seed `9fb4ba9f7296`).
...
- [ ] Evidence: `phase2/evidence/G-0129.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0130 (or finish at 1000)
