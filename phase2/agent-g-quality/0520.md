# [G-0520] QA: invariant property tests on ScopeClassifier
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ScopeClassifier` (seed `90ee88b65b83`).
...
- [ ] Evidence: `phase2/evidence/G-0520.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0521 (or finish at 1000)
