# [G-0015] QA: BS-M12 transcript audit on LocalExtractor
...
As a **staff QA/security engineer**, apply **BS-M12 transcript audit** against `LocalExtractor` (seed `e088e6f3f354`).
...
- [ ] Evidence: `phase2/evidence/G-0015.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0016 (or finish at 1000)
