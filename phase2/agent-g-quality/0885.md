# [G-0885] QA: silent catch eradication on EvidenceGathering
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `EvidenceGathering` (seed `a9b6d14098a1`).
...
- [ ] Evidence: `phase2/evidence/G-0885.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0886 (or finish at 1000)
