# [G-0298] QA: test flake dection on NotchReducer
...
As a **staff QA/security engineer**, apply **test flake dection** against `NotchReducer` (seed `c9063401cc2f`).
...
- [ ] Evidence: `phase2/evidence/G-0298.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0299 (or finish at 1000)
