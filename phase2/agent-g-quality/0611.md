# [G-0611] QA: use-case harness isolation on Coverage
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `Coverage` (seed `db674aa18b3f`).
...
- [ ] Evidence: `phase2/evidence/G-0611.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0612 (or finish at 1000)
