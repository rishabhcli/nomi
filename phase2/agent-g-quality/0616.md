# [G-0616] QA: invariant property tests on ContextAssembler
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ContextAssembler` (seed `8cf56cb044af`).
...
- [ ] Evidence: `phase2/evidence/G-0616.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0617 (or finish at 1000)
