# [G-0208] QA: invariant property tests on ContextAssembler
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ContextAssembler` (seed `3a121bde373c`).
...
- [ ] Evidence: `phase2/evidence/G-0208.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0209 (or finish at 1000)
