# [G-0688] QA: invariant property tests on Profile
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Profile` (seed `1bef70c23902`).
...
- [ ] Evidence: `phase2/evidence/G-0688.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0689 (or finish at 1000)
