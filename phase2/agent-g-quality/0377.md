# [G-0377] QA: egress injection attempts on AgenticGrep
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `AgenticGrep` (seed `e87366dd514e`).
...
- [ ] Evidence: `phase2/evidence/G-0377.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0378 (or finish at 1000)
