# [G-0689] QA: egress injection attempts on NotchReducer
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `NotchReducer` (seed `5e972c493297`).
...
- [ ] Evidence: `phase2/evidence/G-0689.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0690 (or finish at 1000)
