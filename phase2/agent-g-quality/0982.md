# [G-0982] QA: test flake dection on FollowUp
...
As a **staff QA/security engineer**, apply **test flake dection** against `FollowUp` (seed `2750838c6e6b`).
...
- [ ] Evidence: `phase2/evidence/G-0982.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0983 (or finish at 1000)
