# [G-0582] QA: loopback spoof hostnames on ContextAssembler
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ContextAssembler` (seed `57b6c3462040`).
...
- [ ] Evidence: `phase2/evidence/G-0582.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0583 (or finish at 1000)
