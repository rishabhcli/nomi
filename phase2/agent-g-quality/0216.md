# [G-0216] QA: document error rate tracking on TimeWindow
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `TimeWindow` (seed `7a3421664a5b`).
...
- [ ] Evidence: `phase2/evidence/G-0216.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0217 (or finish at 1000)
