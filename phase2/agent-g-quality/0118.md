# [G-0118] QA: test flake dection on Coverage
...
As a **staff QA/security engineer**, apply **test flake dection** against `Coverage` (seed `2040a9052d51`).
...
- [ ] Evidence: `phase2/evidence/G-0118.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0119 (or finish at 1000)
