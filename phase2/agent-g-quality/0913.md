# [G-0913] QA: mutation testing mindset on TimeWindow
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `TimeWindow` (seed `f3d2dbaee069`).
...
- [ ] Evidence: `phase2/evidence/G-0913.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0914 (or finish at 1000)
