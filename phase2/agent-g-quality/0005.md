# [G-0005] QA: egress injection attempts on Ingestion
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `Ingestion` (seed `522494b2969d`).
...
**Targets:** `Ingestion.swift` + exhaustive test coverage expansion
...
- [ ] Evidence: `phase2/evidence/G-0005.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0006 (or finish at 1000)
