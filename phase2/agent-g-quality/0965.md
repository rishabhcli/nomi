# [G-0965] QA: egress injection attempts on FollowUp
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `FollowUp` (seed `6e3498917d25`).
...
- [ ] Evidence: `phase2/evidence/G-0965.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0966 (or finish at 1000)
