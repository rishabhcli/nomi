# [G-0676] QA: invariant property tests on FollowUp
...
As a **staff QA/security engineer**, apply **invariant property tests** against `FollowUp` (seed `ffe682cd4bac`).
...
- [ ] Evidence: `phase2/evidence/G-0676.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0677 (or finish at 1000)
