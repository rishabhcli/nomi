# [G-0626] QA: regression fixture expansion on CommandParser
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CommandParser` (seed `938b2bb64f9d`).
...
- [ ] Evidence: `phase2/evidence/G-0626.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0627 (or finish at 1000)
