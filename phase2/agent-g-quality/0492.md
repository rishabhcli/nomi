# [G-0492] QA: document error rate tracking on Coverage
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Coverage` (seed `6e2689b9a5f9`).
...
- [ ] Evidence: `phase2/evidence/G-0492.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0493 (or finish at 1000)
