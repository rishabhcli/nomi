# [G-0790] QA: test flake dection on Profile
...
As a **staff QA/security engineer**, apply **test flake dection** against `Profile` (seed `2b49f0141a3b`).
...
- [ ] Evidence: `phase2/evidence/G-0790.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0791 (or finish at 1000)
