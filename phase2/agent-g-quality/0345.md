# [G-0345] QA: silent catch eradication on Ingestion
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Ingestion` (seed `07c725e9e61f`).
...
- [ ] Evidence: `phase2/evidence/G-0345.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0346 (or finish at 1000)
