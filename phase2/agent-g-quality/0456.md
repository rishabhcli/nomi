# [G-0456] QA: document error rate tracking on CommandParser
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `CommandParser` (seed `55c0ecc06e5e`).
...
- [ ] Evidence: `phase2/evidence/G-0456.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0457 (or finish at 1000)
