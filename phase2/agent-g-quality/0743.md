# [G-0743] QA: use-case harness isolation on TimeWindow
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `TimeWindow` (seed `5928ec4bc06c`).
...
- [ ] Evidence: `phase2/evidence/G-0743.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0744 (or finish at 1000)
