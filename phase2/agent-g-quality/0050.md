# [G-0050] QA: regression fixture expansion on Coverage
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Coverage` (seed `fe15ac6ffdee`).
...
- [ ] Evidence: `phase2/evidence/G-0050.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0051 (or finish at 1000)
