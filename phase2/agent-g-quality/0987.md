# [G-0987] QA: BS-M12 transcript audit on EvidenceGathering
...
As a **staff QA/security engineer**, apply **BS-M12 transcript audit** against `EvidenceGathering` (seed `a636d63f886e`).
...
- [ ] Evidence: `phase2/evidence/G-0987.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0988 (or finish at 1000)
