# [G-0504] QA: document error rate tracking on QueryHistory
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryHistory` (seed `5d86c48cb0a8`).
...
- [ ] Evidence: `phase2/evidence/G-0504.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0505 (or finish at 1000)
