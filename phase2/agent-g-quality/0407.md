# [G-0407] QA: use-case harness isolation on Coverage
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `Coverage` (seed `9ad7d8d45b29`).
...
- [ ] Evidence: `phase2/evidence/G-0407.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0408 (or finish at 1000)
