# [G-0660] QA: document error rate tracking on CommandParser
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `CommandParser` (seed `328e81cf27f1`).
...
- [ ] Evidence: `phase2/evidence/G-0660.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0661 (or finish at 1000)
