# [G-0825] QA: silent catch eradication on NotchReducer
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `NotchReducer` (seed `5c2f48b4b09c`).
...
- [ ] Evidence: `phase2/evidence/G-0825.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0826 (or finish at 1000)
