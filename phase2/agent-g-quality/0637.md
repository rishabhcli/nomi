# [G-0637] QA: mutation testing mindset on Profile
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `Profile` (seed `6b02098c6812`).
...
- [ ] Evidence: `phase2/evidence/G-0637.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0638 (or finish at 1000)
