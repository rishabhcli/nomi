# [G-0493] QA: mutation testing mindset on QueryService
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `QueryService` (seed `c5a35d5af390`).
...
- [ ] Evidence: `phase2/evidence/G-0493.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0494 (or finish at 1000)
