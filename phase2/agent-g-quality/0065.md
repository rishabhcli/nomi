# [G-0065] QA: egress injection attempts on CommandParser
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CommandParser` (seed `5eade565d41a`).
...
- [ ] Evidence: `phase2/evidence/G-0065.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0066 (or finish at 1000)
