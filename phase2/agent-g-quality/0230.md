# [G-0230] QA: regression fixture expansion on NotchReducer
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `NotchReducer` (seed `f8cd624cfc82`).
...
- [ ] Evidence: `phase2/evidence/G-0230.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0231 (or finish at 1000)
