# [G-0237] QA: silent catch eradication on Coverage
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Coverage` (seed `a0424016f138`).
...
- [ ] Evidence: `phase2/evidence/G-0237.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0238 (or finish at 1000)
