# [G-0899] QA: use-case harness isolation on LocalExtractor
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `LocalExtractor` (seed `ceb36e750f47`).
...
- [ ] Evidence: `phase2/evidence/G-0899.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0900 (or finish at 1000)
