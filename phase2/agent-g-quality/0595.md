# [G-0595] QA: PII log redaction scan on QueryService
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `QueryService` (seed `76a4e74348fb`).
...
- [ ] Evidence: `phase2/evidence/G-0595.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0596 (or finish at 1000)
