# [G-0599] QA: use-case harness isolation on ContextAssembler
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `ContextAssembler` (seed `8f66143ce45e`).
...
- [ ] Evidence: `phase2/evidence/G-0599.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0600 (or finish at 1000)
