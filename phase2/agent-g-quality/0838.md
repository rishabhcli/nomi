# [G-0838] QA: test flake dection on Ingestion
...
As a **staff QA/security engineer**, apply **test flake dection** against `Ingestion` (seed `d380d6806186`).
...
- [ ] Evidence: `phase2/evidence/G-0838.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0839 (or finish at 1000)
