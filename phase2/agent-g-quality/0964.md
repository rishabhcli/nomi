# [G-0964] QA: invariant property tests on TimeWindow
...
As a **staff QA/security engineer**, apply **invariant property tests** against `TimeWindow` (seed `b854a5077451`).
...
- [ ] Evidence: `phase2/evidence/G-0964.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0965 (or finish at 1000)
