# [G-0320] QA: force-unwrap elimination on CommandParser
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `CommandParser` (seed `c4db8348442c`).
...
- [ ] Evidence: `phase2/evidence/G-0320.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0321 (or finish at 1000)
