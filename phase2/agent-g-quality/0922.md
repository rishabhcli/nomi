# [G-0922] QA: test flake dection on ContextAssembler
...
As a **staff QA/security engineer**, apply **test flake dection** against `ContextAssembler` (seed `233ae252d805`).
...
- [ ] Evidence: `phase2/evidence/G-0922.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0923 (or finish at 1000)
