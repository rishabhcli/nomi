# [G-0702] QA: loopback spoof hostnames on Ingestion
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `Ingestion` (seed `a0ff33e84b67`).
...
- [ ] Evidence: `phase2/evidence/G-0702.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0703 (or finish at 1000)
