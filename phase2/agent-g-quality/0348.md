# [G-0348] QA: document error rate tracking on Profile
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Profile` (seed `69b589502d72`).
...
- [ ] Evidence: `phase2/evidence/G-0348.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0349 (or finish at 1000)
