# [G-0102] QA: loopback spoof hostnames on QueryService
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `QueryService` (seed `f0816d4672ba`).
...
- [ ] Evidence: `phase2/evidence/G-0102.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0103 (or finish at 1000)
