# [G-0487] QA: PII log redaction scan on QueryHistory
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `QueryHistory` (seed `7140f7c6e81b`).
...
- [ ] Evidence: `phase2/evidence/G-0487.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0488 (or finish at 1000)
