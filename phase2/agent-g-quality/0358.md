# [G-0358] QA: test flake dection on EvidenceGathering
...
As a **staff QA/security engineer**, apply **test flake dection** against `EvidenceGathering` (seed `f1a13eb23279`).
...
- [ ] Evidence: `phase2/evidence/G-0358.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0359 (or finish at 1000)
