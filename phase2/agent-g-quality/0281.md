# [G-0281] QA: egress injection attempts on NotchReducer
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `NotchReducer` (seed `99cbc3e10afe`).
...
- [ ] Evidence: `phase2/evidence/G-0281.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0282 (or finish at 1000)
