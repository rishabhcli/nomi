# [G-0893] QA: egress injection attempts on NotchReducer
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `NotchReducer` (seed `096313153838`).
...
- [ ] Evidence: `phase2/evidence/G-0893.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0894 (or finish at 1000)
