# [G-0993] QA: silent catch eradication on Consolidation
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Consolidation` (seed `c29b2c897098`).
...
- [ ] Evidence: `phase2/evidence/G-0993.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0994 (or finish at 1000)
