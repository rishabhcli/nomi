# [G-0081] QA: silent catch eradication on FollowUp
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `FollowUp` (seed `3c358f38a8e8`).
...
- [ ] Evidence: `phase2/evidence/G-0081.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0082 (or finish at 1000)
