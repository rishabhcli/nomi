# [G-0244] QA: invariant property tests on ContentHash
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ContentHash` (seed `2798a3de27ca`).
...
- [ ] Evidence: `phase2/evidence/G-0244.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0245 (or finish at 1000)
