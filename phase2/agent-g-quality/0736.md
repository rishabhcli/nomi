# [G-0736] QA: invariant property tests on Ingestion
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Ingestion` (seed `440714fc5ca4`).
...
- [ ] Evidence: `phase2/evidence/G-0736.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0737 (or finish at 1000)
