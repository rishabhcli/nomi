# [G-0343] QA: PII log redaction scan on AgenticGrep
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `AgenticGrep` (seed `ebf408744a03`).
...
- [ ] Evidence: `phase2/evidence/G-0343.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0344 (or finish at 1000)
