# [G-0818] QA: regression fixture expansion on CitationVerifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CitationVerifier` (seed `f71e3d72b96f`).
...
- [ ] Evidence: `phase2/evidence/G-0818.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0819 (or finish at 1000)
