# [G-0953] QA: egress injection attempts on EvidenceGathering
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `EvidenceGathering` (seed `4b389399afdc`).
...
- [ ] Evidence: `phase2/evidence/G-0953.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0954 (or finish at 1000)
