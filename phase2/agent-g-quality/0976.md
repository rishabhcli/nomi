# [G-0976] QA: invariant property tests on Consolidation
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Consolidation` (seed `18636e9212dd`).
...
- [ ] Evidence: `phase2/evidence/G-0976.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0977 (or finish at 1000)
