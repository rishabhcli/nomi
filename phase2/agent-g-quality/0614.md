# [G-0614] QA: regression fixture expansion on CitationVerifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CitationVerifier` (seed `adaeb565d543`).
...
- [ ] Evidence: `phase2/evidence/G-0614.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0615 (or finish at 1000)
