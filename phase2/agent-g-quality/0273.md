# [G-0273] QA: silent catch eradication on EvidenceGathering
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `EvidenceGathering` (seed `d8bd1e18e519`).
...
- [ ] Evidence: `phase2/evidence/G-0273.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0274 (or finish at 1000)
