# [G-0489] QA: silent catch eradication on FollowUp
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `FollowUp` (seed `67d57831384f`).
...
- [ ] Evidence: `phase2/evidence/G-0489.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0490 (or finish at 1000)
