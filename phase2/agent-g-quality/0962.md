# [G-0962] QA: regression fixture expansion on ScopeClassifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ScopeClassifier` (seed `51af0a4e5898`).
...
- [ ] Evidence: `phase2/evidence/G-0962.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0963 (or finish at 1000)
