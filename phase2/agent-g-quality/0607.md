# [G-0607] QA: PII log redaction scan on TimeWindow
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `TimeWindow` (seed `ae934610255a`).
...
- [ ] Evidence: `phase2/evidence/G-0607.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0608 (or finish at 1000)
