# [G-0529] QA: mutation testing mindset on CitationVerifier
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CitationVerifier` (seed `6cea8e2e1e5c`).
...
- [ ] Evidence: `phase2/evidence/G-0529.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0530 (or finish at 1000)
