# [G-0603] QA: BS-M12 transcript audit on Profile
...
As a **staff QA/security engineer**, apply **BS-M12 transcript audit** against `Profile` (seed `3766b6ec4b70`).
...
- [ ] Evidence: `phase2/evidence/G-0603.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0604 (or finish at 1000)
