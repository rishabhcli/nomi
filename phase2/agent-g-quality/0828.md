# [G-0828] QA: document error rate tracking on TimeWindow
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `TimeWindow` (seed `273feb3f5904`).
...
- [ ] Evidence: `phase2/evidence/G-0828.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0829 (or finish at 1000)
