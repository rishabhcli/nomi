# [G-0340] QA: invariant property tests on QueryService
...
As a **staff QA/security engineer**, apply **invariant property tests** against `QueryService` (seed `ced669bcf063`).
...
- [ ] Evidence: `phase2/evidence/G-0340.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0341 (or finish at 1000)
