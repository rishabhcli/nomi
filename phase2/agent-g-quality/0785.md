# [G-0785] QA: egress injection attempts on AgenticGrep
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `AgenticGrep` (seed `a13ee5af47dd`).
...
- [ ] Evidence: `phase2/evidence/G-0785.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0786 (or finish at 1000)
