# [G-0549] QA: silent catch eradication on Ingestion
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Ingestion` (seed `2f1ed806bb80`).
...
- [ ] Evidence: `phase2/evidence/G-0549.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0550 (or finish at 1000)
