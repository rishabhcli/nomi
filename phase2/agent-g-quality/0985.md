# [G-0985] QA: mutation testing mindset on Coverage
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `Coverage` (seed `3d5ad9be9e8f`).
...
- [ ] Evidence: `phase2/evidence/G-0985.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0986 (or finish at 1000)
