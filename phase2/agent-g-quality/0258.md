# [G-0258] QA: loopback spoof hostnames on AgenticGrep
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `AgenticGrep` (seed `89b1e172e4cb`).
...
- [ ] Evidence: `phase2/evidence/G-0258.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0259 (or finish at 1000)
