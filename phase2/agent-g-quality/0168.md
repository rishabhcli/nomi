# [G-0168] QA: document error rate tracking on LocalExtractor
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `LocalExtractor` (seed `168de761505c`).
...
- [ ] Evidence: `phase2/evidence/G-0168.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0169 (or finish at 1000)
