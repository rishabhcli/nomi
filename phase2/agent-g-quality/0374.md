# [G-0374] QA: regression fixture expansion on QueryService
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `QueryService` (seed `fbff6fc7cc81`).
...
- [ ] Evidence: `phase2/evidence/G-0374.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0375 (or finish at 1000)
