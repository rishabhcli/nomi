# [G-0337] QA: mutation testing mindset on CommandParser
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CommandParser` (seed `ddbc581b09d6`).
...
- [ ] Evidence: `phase2/evidence/G-0337.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0338 (or finish at 1000)
