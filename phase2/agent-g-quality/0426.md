# [G-0426] QA: loopback spoof hostnames on EvidenceGathering
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `EvidenceGathering` (seed `a0934405a211`).
...
- [ ] Evidence: `phase2/evidence/G-0426.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0427 (or finish at 1000)
