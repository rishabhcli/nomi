# [G-0576] QA: document error rate tracking on LocalExtractor
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `LocalExtractor` (seed `245d73d6d7c3`).
...
- [ ] Evidence: `phase2/evidence/G-0576.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0577 (or finish at 1000)
