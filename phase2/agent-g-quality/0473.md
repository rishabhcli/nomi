# [G-0473] QA: egress injection attempts on CommandParser
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CommandParser` (seed `2c31d42d4ab4`).
...
- [ ] Evidence: `phase2/evidence/G-0473.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0474 (or finish at 1000)
