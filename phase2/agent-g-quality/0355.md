# [G-0355] QA: PII log redaction scan on LocalExtractor
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `LocalExtractor` (seed `6fa14d49f08c`).
...
- [ ] Evidence: `phase2/evidence/G-0355.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0356 (or finish at 1000)
