# [G-0308] QA: force-unwrap elimination on CitationVerifier
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `CitationVerifier` (seed `1b9d8cb24561`).
...
- [ ] Evidence: `phase2/evidence/G-0308.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0309 (or finish at 1000)
