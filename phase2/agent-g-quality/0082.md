# [G-0082] QA: test flake dection on CommandParser
...
As a **staff QA/security engineer**, apply **test flake dection** against `CommandParser` (seed `cc8e9ce7e5c9`).
...
- [ ] Evidence: `phase2/evidence/G-0082.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0083 (or finish at 1000)
