# [G-0725] QA: egress injection attempts on QueryHistory
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `QueryHistory` (seed `f7af05070cda`).
...
- [ ] Evidence: `phase2/evidence/G-0725.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0726 (or finish at 1000)
