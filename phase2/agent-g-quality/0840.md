# [G-0840] QA: document error rate tracking on Consolidation
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Consolidation` (seed `d1e4155fd952`).
...
- [ ] Evidence: `phase2/evidence/G-0840.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0841 (or finish at 1000)
