# [G-0952] QA: invariant property tests on QueryService
...
As a **staff QA/security engineer**, apply **invariant property tests** against `QueryService` (seed `7f4e3385634e`).
...
- [ ] Evidence: `phase2/evidence/G-0952.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0953 (or finish at 1000)
