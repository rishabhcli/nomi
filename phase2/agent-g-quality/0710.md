# [G-0710] QA: regression fixture expansion on FollowUp
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `FollowUp` (seed `a7e30fd5c31c`).
...
- [ ] Evidence: `phase2/evidence/G-0710.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0711 (or finish at 1000)
