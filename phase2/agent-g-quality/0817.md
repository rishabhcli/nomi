# [G-0817] QA: mutation testing mindset on EvidenceGathering
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `EvidenceGathering` (seed `84f23f03f016`).
...
- [ ] Evidence: `phase2/evidence/G-0817.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0818 (or finish at 1000)
