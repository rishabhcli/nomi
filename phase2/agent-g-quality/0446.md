# [G-0446] QA: regression fixture expansion on ContextAssembler
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContextAssembler` (seed `a04c64cd0c3d`).
...
- [ ] Evidence: `phase2/evidence/G-0446.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0447 (or finish at 1000)
