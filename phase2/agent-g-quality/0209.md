# [G-0209] QA: egress injection attempts on Ingestion
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `Ingestion` (seed `29edd76ddf5a`).
...
- [ ] Evidence: `phase2/evidence/G-0209.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0210 (or finish at 1000)
