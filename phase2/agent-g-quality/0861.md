# [G-0861] QA: silent catch eradication on QueryHistory
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryHistory` (seed `6ec53ed1a9ac`).
...
- [ ] Evidence: `phase2/evidence/G-0861.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0862 (or finish at 1000)
