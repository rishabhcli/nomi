# [G-0149] QA: egress injection attempts on FollowUp
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `FollowUp` (seed `4e6913097eab`).
...
- [ ] Evidence: `phase2/evidence/G-0149.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0150 (or finish at 1000)
