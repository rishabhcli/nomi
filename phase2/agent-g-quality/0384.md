# [G-0384] QA: document error rate tracking on ScopeClassifier
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ScopeClassifier` (seed `2f7ddc66662a`).
...
- [ ] Evidence: `phase2/evidence/G-0384.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0385 (or finish at 1000)
