# [G-0170] QA: regression fixture expansion on QueryService
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `QueryService` (seed `03dd2cbee341`).
...
- [ ] Evidence: `phase2/evidence/G-0170.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0171 (or finish at 1000)
