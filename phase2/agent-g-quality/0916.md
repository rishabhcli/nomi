# [G-0916] QA: invariant property tests on LocalExtractor
...
As a **staff QA/security engineer**, apply **invariant property tests** against `LocalExtractor` (seed `574507c40d3a`).
...
- [ ] Evidence: `phase2/evidence/G-0916.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0917 (or finish at 1000)
