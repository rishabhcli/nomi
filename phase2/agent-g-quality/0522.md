# [G-0522] QA: loopback spoof hostnames on TimeWindow
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `TimeWindow` (seed `79620392dab3`).
...
- [ ] Evidence: `phase2/evidence/G-0522.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0523 (or finish at 1000)
