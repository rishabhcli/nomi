# [G-0241] QA: mutation testing mindset on AgenticGrep
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `AgenticGrep` (seed `4f0356e1bdb9`).
...
- [ ] Evidence: `phase2/evidence/G-0241.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0242 (or finish at 1000)
