# [G-0642] QA: loopback spoof hostnames on FollowUp
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `FollowUp` (seed `9d21aaddfe4d`).
...
- [ ] Evidence: `phase2/evidence/G-0642.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0643 (or finish at 1000)
