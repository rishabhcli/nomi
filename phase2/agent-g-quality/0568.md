# [G-0568] QA: invariant property tests on Consolidation
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Consolidation` (seed `96475033c506`).
...
- [ ] Evidence: `phase2/evidence/G-0568.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0569 (or finish at 1000)
