# [G-0086] QA: regression fixture expansion on EvidenceGathering
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `EvidenceGathering` (seed `6c288283115d`).
...
**Targets:** `EvidenceGathering.swift` + exhaustive test coverage expansion
...
- [ ] Evidence: `phase2/evidence/G-0086.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0087 (or finish at 1000)
