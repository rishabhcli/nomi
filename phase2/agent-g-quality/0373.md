# [G-0373] QA: mutation testing mindset on Coverage
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `Coverage` (seed `bb2af84d304b`).
...
- [ ] Evidence: `phase2/evidence/G-0373.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0374 (or finish at 1000)
