# [G-0009] QA: silent catch eradication on NotchReducer
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `NotchReducer` (seed `aadebab66238`).
...
- [ ] Evidence: `phase2/evidence/G-0009.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0010 (or finish at 1000)
