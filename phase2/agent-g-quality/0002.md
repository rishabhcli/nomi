# [G-0002] QA: regression fixture expansion on CitationVerifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CitationVerifier` (seed `d576b289de2c`).
...
**Targets:** `CitationVerifier.swift` + exhaustive test coverage expansion
...
- [ ] Evidence: `phase2/evidence/G-0002.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0003 (or finish at 1000)
