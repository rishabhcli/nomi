# [G-0917] QA: egress injection attempts on Coverage
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `Coverage` (seed `1bba7d1c1de8`).
...
- [ ] Evidence: `phase2/evidence/G-0917.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0918 (or finish at 1000)
