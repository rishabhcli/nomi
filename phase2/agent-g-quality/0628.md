# [G-0628] QA: invariant property tests on Coverage
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Coverage` (seed `3fa8332ea8b1`).
...
- [ ] Evidence: `phase2/evidence/G-0628.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0629 (or finish at 1000)
