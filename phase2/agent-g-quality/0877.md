# [G-0877] QA: mutation testing mindset on ScopeClassifier
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `ScopeClassifier` (seed `9627038b6f00`).
...
- [ ] Evidence: `phase2/evidence/G-0877.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0878 (or finish at 1000)
