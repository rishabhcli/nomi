# [G-0265] QA: mutation testing mindset on ScopeClassifier
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `ScopeClassifier` (seed `7f75cd6f313f`).
...
- [ ] Evidence: `phase2/evidence/G-0265.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0266 (or finish at 1000)
