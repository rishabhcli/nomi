# [G-0182] QA: regression fixture expansion on TimeWindow
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `TimeWindow` (seed `f1ff00d059a0`).
...
- [ ] Evidence: `phase2/evidence/G-0182.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0183 (or finish at 1000)
