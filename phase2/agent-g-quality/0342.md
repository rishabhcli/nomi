# [G-0342] QA: loopback spoof hostnames on CitationVerifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CitationVerifier` (seed `7565c675a80c`).
...
- [ ] Evidence: `phase2/evidence/G-0342.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0343 (or finish at 1000)
