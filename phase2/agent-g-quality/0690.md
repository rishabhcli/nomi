# [G-0690] QA: loopback spoof hostnames on ScopeClassifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ScopeClassifier` (seed `79520a462a5b`).
...
- [ ] Evidence: `phase2/evidence/G-0690.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0691 (or finish at 1000)
