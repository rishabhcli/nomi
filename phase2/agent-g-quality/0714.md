# [G-0714] QA: loopback spoof hostnames on QueryService
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `QueryService` (seed `f51fd9490bad`).
...
- [ ] Evidence: `phase2/evidence/G-0714.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0715 (or finish at 1000)
