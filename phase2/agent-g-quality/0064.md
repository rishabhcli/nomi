# [G-0064] QA: invariant property tests on FollowUp
...
As a **staff QA/security engineer**, apply **invariant property tests** against `FollowUp` (seed `78b48c9e2435`).
...
- [ ] Evidence: `phase2/evidence/G-0064.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0065 (or finish at 1000)
