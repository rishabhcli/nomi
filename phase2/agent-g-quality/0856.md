# [G-0856] QA: invariant property tests on ContentHash
...
As a **staff QA/security engineer**, apply **invariant property tests** against `ContentHash` (seed `651304e037d0`).
...
- [ ] Evidence: `phase2/evidence/G-0856.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0857 (or finish at 1000)
