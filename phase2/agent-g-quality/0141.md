# [G-0141] QA: silent catch eradication on Ingestion
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Ingestion` (seed `3b0cf804bdc5`).
...
- [ ] Evidence: `phase2/evidence/G-0141.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0142 (or finish at 1000)
