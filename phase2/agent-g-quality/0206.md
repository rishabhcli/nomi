# [G-0206] QA: regression fixture expansion on CitationVerifier
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CitationVerifier` (seed `fcbb4824e2db`).
...
- [ ] Evidence: `phase2/evidence/G-0206.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0207 (or finish at 1000)
