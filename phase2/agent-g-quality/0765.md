# [G-0765] QA: silent catch eradication on QueryService
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryService` (seed `74c41c708e35`).
...
- [ ] Evidence: `phase2/evidence/G-0765.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0766 (or finish at 1000)
