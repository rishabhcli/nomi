# [G-0864] QA: document error rate tracking on CommandParser
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `CommandParser` (seed `85b21d671dfc`).
...
- [ ] Evidence: `phase2/evidence/G-0864.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0865 (or finish at 1000)
