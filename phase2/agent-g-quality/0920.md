# [G-0920] QA: force-unwrap elimination on CitationVerifier
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `CitationVerifier` (seed `387fb46ba5d9`).
...
- [ ] Evidence: `phase2/evidence/G-0920.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0921 (or finish at 1000)
