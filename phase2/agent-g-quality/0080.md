# [G-0080] QA: force-unwrap elimination on TimeWindow
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `TimeWindow` (seed `638709c5cceb`).
...
- [ ] Evidence: `phase2/evidence/G-0080.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0081 (or finish at 1000)
