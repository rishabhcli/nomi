# [G-0096] QA: document error rate tracking on QueryHistory
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryHistory` (seed `21fb14cd2f8b`).
...
- [ ] Evidence: `phase2/evidence/G-0096.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0097 (or finish at 1000)
