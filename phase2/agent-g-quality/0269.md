# [G-0269] QA: egress injection attempts on CommandParser
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `CommandParser` (seed `07798488e32c`).
...
- [ ] Evidence: `phase2/evidence/G-0269.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0270 (or finish at 1000)
