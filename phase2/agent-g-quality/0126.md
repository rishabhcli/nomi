# [G-0126] QA: loopback spoof hostnames on Consolidation
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `Consolidation` (seed `38038189f26b`).
...
- [ ] Evidence: `phase2/evidence/G-0126.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0127 (or finish at 1000)
