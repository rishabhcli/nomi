# [G-0472] QA: invariant property tests on FollowUp
...
As a **staff QA/security engineer**, apply **invariant property tests** against `FollowUp` (seed `700556d306aa`).
...
- [ ] Evidence: `phase2/evidence/G-0472.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0473 (or finish at 1000)
