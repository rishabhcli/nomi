# [G-0720] QA: document error rate tracking on ContentHash
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ContentHash` (seed `87b43ebd409b`).
...
- [ ] Evidence: `phase2/evidence/G-0720.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0721 (or finish at 1000)
