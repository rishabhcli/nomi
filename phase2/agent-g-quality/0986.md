# [G-0986] QA: regression fixture expansion on QueryService
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `QueryService` (seed `82b92ec1ab9b`).
...
- [ ] Evidence: `phase2/evidence/G-0986.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0987 (or finish at 1000)
