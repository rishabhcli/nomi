# [G-0588] QA: document error rate tracking on ScopeClassifier
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `ScopeClassifier` (seed `25865f78c834`).
...
- [ ] Evidence: `phase2/evidence/G-0588.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0589 (or finish at 1000)
