# [G-0581] QA: egress injection attempts on AgenticGrep
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `AgenticGrep` (seed `af8052daa735`).
...
- [ ] Evidence: `phase2/evidence/G-0581.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0582 (or finish at 1000)
