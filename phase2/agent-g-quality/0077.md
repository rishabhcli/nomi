# [G-0077] QA: egress injection attempts on NotchReducer
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `NotchReducer` (seed `33fbc0d077f8`).
...
- [ ] Evidence: `phase2/evidence/G-0077.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0078 (or finish at 1000)
