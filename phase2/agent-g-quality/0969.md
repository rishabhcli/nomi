# [G-0969] QA: silent catch eradication on QueryService
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryService` (seed `443948e356aa`).
...
- [ ] Evidence: `phase2/evidence/G-0969.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0970 (or finish at 1000)
