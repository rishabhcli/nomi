# [G-0955] QA: PII log redaction scan on AgenticGrep
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `AgenticGrep` (seed `3707b9d99f42`).
...
- [ ] Evidence: `phase2/evidence/G-0955.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0956 (or finish at 1000)
