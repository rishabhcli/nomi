# [G-0797] QA: egress injection attempts on LocalExtractor
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `LocalExtractor` (seed `2ac23c375e7d`).
...
- [ ] Evidence: `phase2/evidence/G-0797.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0798 (or finish at 1000)
