# [G-0530] QA: regression fixture expansion on AgenticGrep
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `AgenticGrep` (seed `9cca799c9183`).
...
- [ ] Evidence: `phase2/evidence/G-0530.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0531 (or finish at 1000)
