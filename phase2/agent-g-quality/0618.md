# [G-0618] QA: loopback spoof hostnames on ContentHash
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `ContentHash` (seed `c22815cbcaf5`).
...
- [ ] Evidence: `phase2/evidence/G-0618.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0619 (or finish at 1000)
