# [G-0604] QA: invariant property tests on NotchReducer
...
As a **staff QA/security engineer**, apply **invariant property tests** against `NotchReducer` (seed `7d947e2cc18c`).
...
- [ ] Evidence: `phase2/evidence/G-0604.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0605 (or finish at 1000)
