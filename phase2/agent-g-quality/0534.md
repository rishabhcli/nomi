# [G-0534] QA: loopback spoof hostnames on Consolidation
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `Consolidation` (seed `0f38a65a4674`).
...
- [ ] Evidence: `phase2/evidence/G-0534.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0535 (or finish at 1000)
