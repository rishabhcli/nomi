# [G-0228] QA: document error rate tracking on Consolidation
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `Consolidation` (seed `f75495f0ba7b`).
...
- [ ] Evidence: `phase2/evidence/G-0228.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0229 (or finish at 1000)
