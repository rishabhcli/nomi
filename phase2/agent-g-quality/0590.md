# [G-0590] QA: regression fixture expansion on TimeWindow
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `TimeWindow` (seed `554186991998`).
...
- [ ] Evidence: `phase2/evidence/G-0590.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0591 (or finish at 1000)
