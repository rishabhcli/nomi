# [G-0105] QA: silent catch eradication on AgenticGrep
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `AgenticGrep` (seed `d73d9ec60af3`).
...
- [ ] Evidence: `phase2/evidence/G-0105.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0106 (or finish at 1000)
