# [G-0242] QA: regression fixture expansion on ContextAssembler
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContextAssembler` (seed `7f356e7b71a2`).
...
- [ ] Evidence: `phase2/evidence/G-0242.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0243 (or finish at 1000)
