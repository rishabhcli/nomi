# [G-0254] QA: regression fixture expansion on Coverage
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Coverage` (seed `628677ae7f92`).
...
- [ ] Evidence: `phase2/evidence/G-0254.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0255 (or finish at 1000)
