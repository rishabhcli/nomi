# [G-0909] QA: silent catch eradication on Profile
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Profile` (seed `e2adea34aa7d`).
...
- [ ] Evidence: `phase2/evidence/G-0909.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0910 (or finish at 1000)
