# [G-0482] QA: regression fixture expansion on ContentHash
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContentHash` (seed `a0735fe0364a`).
...
- [ ] Evidence: `phase2/evidence/G-0482.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0483 (or finish at 1000)
