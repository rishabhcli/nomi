# [G-0052] QA: invariant property tests on EvidenceGathering
...
As a **staff QA/security engineer**, apply **invariant property tests** against `EvidenceGathering` (seed `438d6a8dfcbe`).
...
- [ ] Evidence: `phase2/evidence/G-0052.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0053 (or finish at 1000)
