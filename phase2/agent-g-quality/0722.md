# [G-0722] QA: regression fixture expansion on Profile
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Profile` (seed `4042b14ac939`).
...
- [ ] Evidence: `phase2/evidence/G-0722.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0723 (or finish at 1000)
