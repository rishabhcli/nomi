# [G-0033] QA: silent catch eradication on Coverage
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `Coverage` (seed `656c5e52517b`).
...
- [ ] Evidence: `phase2/evidence/G-0033.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0034 (or finish at 1000)
