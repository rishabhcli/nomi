# [G-0354] QA: loopback spoof hostnames on CommandParser
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CommandParser` (seed `54f537cbcf00`).
...
- [ ] Evidence: `phase2/evidence/G-0354.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0355 (or finish at 1000)
