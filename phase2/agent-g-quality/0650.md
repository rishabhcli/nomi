# [G-0650] QA: regression fixture expansion on ContextAssembler
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContextAssembler` (seed `b8be3954c526`).
...
- [ ] Evidence: `phase2/evidence/G-0650.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0651 (or finish at 1000)
