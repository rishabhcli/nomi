# [G-0131] QA: use-case harness isolation on TimeWindow
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `TimeWindow` (seed `17d7fb59b633`).
...
- [ ] Evidence: `phase2/evidence/G-0131.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0132 (or finish at 1000)
