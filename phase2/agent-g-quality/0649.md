# [G-0649] QA: mutation testing mindset on AgenticGrep
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `AgenticGrep` (seed `568f6f1a51f9`).
...
- [ ] Evidence: `phase2/evidence/G-0649.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0650 (or finish at 1000)
