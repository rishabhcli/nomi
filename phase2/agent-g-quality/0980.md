# [G-0980] QA: force-unwrap elimination on QueryHistory
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `QueryHistory` (seed `f86c89f2abd8`).
...
- [ ] Evidence: `phase2/evidence/G-0980.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0981 (or finish at 1000)
