# [G-0613] QA: mutation testing mindset on EvidenceGathering
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `EvidenceGathering` (seed `82e923910e7c`).
...
- [ ] Evidence: `phase2/evidence/G-0613.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0614 (or finish at 1000)
