# [G-0862] QA: test flake dection on TimeWindow
...
As a **staff QA/security engineer**, apply **test flake dection** against `TimeWindow` (seed `6fbda2130b4b`).
...
- [ ] Evidence: `phase2/evidence/G-0862.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0863 (or finish at 1000)
