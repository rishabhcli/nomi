# [G-0750] QA: loopback spoof hostnames on CitationVerifier
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `CitationVerifier` (seed `4b0c6e30b4f5`).
...
- [ ] Evidence: `phase2/evidence/G-0750.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0751 (or finish at 1000)
