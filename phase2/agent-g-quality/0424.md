# [G-0424] QA: invariant property tests on Coverage
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Coverage` (seed `ae3d1ae76103`).
...
- [ ] Evidence: `phase2/evidence/G-0424.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0425 (or finish at 1000)
