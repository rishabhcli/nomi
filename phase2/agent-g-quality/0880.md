# [G-0880] QA: invariant property tests on FollowUp
...
As a **staff QA/security engineer**, apply **invariant property tests** against `FollowUp` (seed `7ee5dd9dd3ef`).
...
- [ ] Evidence: `phase2/evidence/G-0880.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0881 (or finish at 1000)
