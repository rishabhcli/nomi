# [G-0191] QA: use-case harness isolation on ContextAssembler
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `ContextAssembler` (seed `2a581d95321d`).
...
- [ ] Evidence: `phase2/evidence/G-0191.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0192 (or finish at 1000)
