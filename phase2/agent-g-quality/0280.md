# [G-0280] QA: invariant property tests on Profile
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Profile` (seed `1be1676f8955`).
...
- [ ] Evidence: `phase2/evidence/G-0280.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0281 (or finish at 1000)
