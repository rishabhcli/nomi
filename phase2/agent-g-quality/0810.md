# [G-0810] QA: loopback spoof hostnames on QueryHistory
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `QueryHistory` (seed `917526b323e6`).
...
- [ ] Evidence: `phase2/evidence/G-0810.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0811 (or finish at 1000)
