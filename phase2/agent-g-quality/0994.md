# [G-0994] QA: test flake dection on Profile
...
As a **staff QA/security engineer**, apply **test flake dection** against `Profile` (seed `b3c663e3465e`).
...
- [ ] Evidence: `phase2/evidence/G-0994.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0995 (or finish at 1000)
