# [G-0850] QA: test flake dection on QueryService
...
As a **staff QA/security engineer**, apply **test flake dection** against `QueryService` (seed `471a4ab6ecee`).
...
- [ ] Evidence: `phase2/evidence/G-0850.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0851 (or finish at 1000)
