# [G-0868] QA: invariant property tests on EvidenceGathering
...
As a **staff QA/security engineer**, apply **invariant property tests** against `EvidenceGathering` (seed `914a6dde7dc2`).
...
- [ ] Evidence: `phase2/evidence/G-0868.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0869 (or finish at 1000)
