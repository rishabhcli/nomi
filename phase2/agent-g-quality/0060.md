# [G-0060] QA: document error rate tracking on NotchReducer
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `NotchReducer` (seed `096058948f40`).
...
- [ ] Evidence: `phase2/evidence/G-0060.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0061 (or finish at 1000)
