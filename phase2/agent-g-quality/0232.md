# [G-0232] QA: invariant property tests on QueryHistory
...
As a **staff QA/security engineer**, apply **invariant property tests** against `QueryHistory` (seed `aeaaf7f2c134`).
...
- [ ] Evidence: `phase2/evidence/G-0232.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0233 (or finish at 1000)
