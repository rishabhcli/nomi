# [G-0932] QA: force-unwrap elimination on CommandParser
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `CommandParser` (seed `de667fff9c66`).
...
- [ ] Evidence: `phase2/evidence/G-0932.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0933 (or finish at 1000)
