# [G-0349] QA: mutation testing mindset on NotchReducer
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `NotchReducer` (seed `0c16981133a5`).
...
- [ ] Evidence: `phase2/evidence/G-0349.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0350 (or finish at 1000)
