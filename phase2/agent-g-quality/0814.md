# [G-0814] QA: test flake dection on LocalExtractor
...
As a **staff QA/security engineer**, apply **test flake dection** against `LocalExtractor` (seed `73b33635fde0`).
...
- [ ] Evidence: `phase2/evidence/G-0814.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0815 (or finish at 1000)
