# [G-0284] QA: force-unwrap elimination on TimeWindow
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `TimeWindow` (seed `ef6286bb7e83`).
...
- [ ] Evidence: `phase2/evidence/G-0284.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0285 (or finish at 1000)
