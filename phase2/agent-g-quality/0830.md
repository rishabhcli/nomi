# [G-0830] QA: regression fixture expansion on CommandParser
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `CommandParser` (seed `ff9c623d345e`).
...
- [ ] Evidence: `phase2/evidence/G-0830.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0831 (or finish at 1000)
