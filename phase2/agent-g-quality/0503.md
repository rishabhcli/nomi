# [G-0503] QA: use-case harness isolation on ScopeClassifier
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `ScopeClassifier` (seed `977edcb76a57`).
...
- [ ] Evidence: `phase2/evidence/G-0503.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0504 (or finish at 1000)
