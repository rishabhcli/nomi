# [G-0154] QA: test flake dection on EvidenceGathering
...
As a **staff QA/security engineer**, apply **test flake dection** against `EvidenceGathering` (seed `79b7f1f84af2`).
...
- [ ] Evidence: `phase2/evidence/G-0154.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0155 (or finish at 1000)
