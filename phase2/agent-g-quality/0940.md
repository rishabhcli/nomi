# [G-0940] QA: invariant property tests on Ingestion
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Ingestion` (seed `f6ad96153909`).
...
- [ ] Evidence: `phase2/evidence/G-0940.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0941 (or finish at 1000)
