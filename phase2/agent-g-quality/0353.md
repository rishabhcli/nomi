# [G-0353] QA: egress injection attempts on FollowUp
...
As a **staff QA/security engineer**, apply **egress injection attempts** against `FollowUp` (seed `50e074a97082`).
...
- [ ] Evidence: `phase2/evidence/G-0353.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0354 (or finish at 1000)
