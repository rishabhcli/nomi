# [G-0801] QA: silent catch eradication on CitationVerifier
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `CitationVerifier` (seed `a8f2f6a3e624`).
...
- [ ] Evidence: `phase2/evidence/G-0801.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0802 (or finish at 1000)
