# [G-0034] QA: test flake dection on QueryService
...
As a **staff QA/security engineer**, apply **test flake dection** against `QueryService` (seed `83b76cb13c60`).
...
- [ ] Evidence: `phase2/evidence/G-0034.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0035 (or finish at 1000)
