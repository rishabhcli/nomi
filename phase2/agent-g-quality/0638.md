# [G-0638] QA: regression fixture expansion on NotchReducer
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `NotchReducer` (seed `f5ee6a0bcd74`).
...
- [ ] Evidence: `phase2/evidence/G-0638.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0639 (or finish at 1000)
