# [G-0659] QA: use-case harness isolation on FollowUp
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `FollowUp` (seed `58ac9f9e6bbe`).
...
- [ ] Evidence: `phase2/evidence/G-0659.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0660 (or finish at 1000)
