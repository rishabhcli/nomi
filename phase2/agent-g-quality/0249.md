# [G-0249] QA: silent catch eradication on QueryHistory
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `QueryHistory` (seed `c051ccf37443`).
...
- [ ] Evidence: `phase2/evidence/G-0249.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0250 (or finish at 1000)
