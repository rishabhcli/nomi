# [G-0403] QA: PII log redaction scan on TimeWindow
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `TimeWindow` (seed `3dc67bd931d0`).
...
- [ ] Evidence: `phase2/evidence/G-0403.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0404 (or finish at 1000)
