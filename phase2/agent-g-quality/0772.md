# [G-0772] QA: invariant property tests on Consolidation
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Consolidation` (seed `462f1ef91621`).
...
- [ ] Evidence: `phase2/evidence/G-0772.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0773 (or finish at 1000)
