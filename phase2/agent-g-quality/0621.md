# [G-0621] QA: silent catch eradication on NotchReducer
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `NotchReducer` (seed `dcd7d6c3fd38`).
...
- [ ] Evidence: `phase2/evidence/G-0621.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0622 (or finish at 1000)
