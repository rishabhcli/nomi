# [G-0466] QA: test flake dection on Consolidation
...
As a **staff QA/security engineer**, apply **test flake dection** against `Consolidation` (seed `32a9c39eed72`).
...
- [ ] Evidence: `phase2/evidence/G-0466.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0467 (or finish at 1000)
