# [G-0532] QA: invariant property tests on Ingestion
...
As a **staff QA/security engineer**, apply **invariant property tests** against `Ingestion` (seed `9bef05459773`).
...
- [ ] Evidence: `phase2/evidence/G-0532.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0533 (or finish at 1000)
