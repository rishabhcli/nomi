# [G-0326] QA: regression fixture expansion on AgenticGrep
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `AgenticGrep` (seed `e487604cc1c4`).
...
- [ ] Evidence: `phase2/evidence/G-0326.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0327 (or finish at 1000)
