# [G-0921] QA: silent catch eradication on AgenticGrep
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `AgenticGrep` (seed `633e163326fe`).
...
- [ ] Evidence: `phase2/evidence/G-0921.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0922 (or finish at 1000)
