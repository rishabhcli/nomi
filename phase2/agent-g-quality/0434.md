# [G-0434] QA: regression fixture expansion on NotchReducer
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `NotchReducer` (seed `59c7b6b97483`).
...
- [ ] Evidence: `phase2/evidence/G-0434.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0435 (or finish at 1000)
