# [G-0882] QA: loopback spoof hostnames on LocalExtractor
...
As a **staff QA/security engineer**, apply **loopback spoof hostnames** against `LocalExtractor` (seed `e40a420e1bc1`).
...
- [ ] Evidence: `phase2/evidence/G-0882.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0883 (or finish at 1000)
