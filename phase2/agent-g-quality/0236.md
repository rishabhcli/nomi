# [G-0236] QA: force-unwrap elimination on LocalExtractor
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `LocalExtractor` (seed `7d505604eaf6`).
...
- [ ] Evidence: `phase2/evidence/G-0236.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0237 (or finish at 1000)
