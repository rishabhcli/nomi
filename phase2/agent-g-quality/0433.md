# [G-0433] QA: mutation testing mindset on Profile
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `Profile` (seed `5f7c4284f83f`).
...
- [ ] Evidence: `phase2/evidence/G-0433.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0434 (or finish at 1000)
