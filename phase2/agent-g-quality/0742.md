# [G-0742] QA: test flake dection on QueryHistory
...
As a **staff QA/security engineer**, apply **test flake dection** against `QueryHistory` (seed `0a9897ba6eee`).
...
- [ ] Evidence: `phase2/evidence/G-0742.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0743 (or finish at 1000)
