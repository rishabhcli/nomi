# [G-0564] QA: document error rate tracking on AgenticGrep
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `AgenticGrep` (seed `37293453b7da`).
...
- [ ] Evidence: `phase2/evidence/G-0564.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0565 (or finish at 1000)
