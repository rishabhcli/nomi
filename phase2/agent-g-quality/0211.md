# [G-0211] QA: PII log redaction scan on Consolidation
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `Consolidation` (seed `db9ae1e424bc`).
...
- [ ] Evidence: `phase2/evidence/G-0211.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0212 (or finish at 1000)
