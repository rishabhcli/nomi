# [G-0970] QA: test flake dection on EvidenceGathering
...
As a **staff QA/security engineer**, apply **test flake dection** against `EvidenceGathering` (seed `044ad1270bfb`).
...
- [ ] Evidence: `phase2/evidence/G-0970.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0971 (or finish at 1000)
