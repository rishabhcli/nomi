# [G-0021] QA: silent catch eradication on ContextAssembler
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `ContextAssembler` (seed `24bdb8c26840`).
...
- [ ] Evidence: `phase2/evidence/G-0021.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0022 (or finish at 1000)
