# [G-0465] QA: silent catch eradication on ContentHash
...
As a **staff QA/security engineer**, apply **silent catch eradication** against `ContentHash` (seed `ec4add47e65c`).
...
- [ ] Evidence: `phase2/evidence/G-0465.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0466 (or finish at 1000)
