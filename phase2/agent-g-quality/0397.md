# [G-0397] QA: mutation testing mindset on ContentHash
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `ContentHash` (seed `00e86634eb6b`).
...
- [ ] Evidence: `phase2/evidence/G-0397.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0398 (or finish at 1000)
