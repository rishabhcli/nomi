# [G-0371] QA: use-case harness isolation on CommandParser
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `CommandParser` (seed `021e51a36565`).
...
- [ ] Evidence: `phase2/evidence/G-0371.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0372 (or finish at 1000)
