# [G-0711] QA: BS-M12 transcript audit on CommandParser
...
As a **staff QA/security engineer**, apply **BS-M12 transcript audit** against `CommandParser` (seed `066c5394ed0f`).
...
- [ ] Evidence: `phase2/evidence/G-0711.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0712 (or finish at 1000)
