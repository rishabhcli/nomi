# [G-0140] QA: force-unwrap elimination on ContextAssembler
...
As a **staff QA/security engineer**, apply **force-unwrap elimination** against `ContextAssembler` (seed `fa86cd8d1ea5`).
...
- [ ] Evidence: `phase2/evidence/G-0140.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0141 (or finish at 1000)
