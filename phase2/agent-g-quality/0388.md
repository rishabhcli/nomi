# [G-0388] QA: invariant property tests on CommandParser
...
As a **staff QA/security engineer**, apply **invariant property tests** against `CommandParser` (seed `dc1397e48a88`).
...
- [ ] Evidence: `phase2/evidence/G-0388.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0389 (or finish at 1000)
