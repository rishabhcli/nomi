# [G-0949] QA: mutation testing mindset on CommandParser
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `CommandParser` (seed `4e252d95bad7`).
...
- [ ] Evidence: `phase2/evidence/G-0949.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0950 (or finish at 1000)
