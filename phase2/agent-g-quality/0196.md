# [G-0196] QA: invariant property tests on NotchReducer
...
As a **staff QA/security engineer**, apply **invariant property tests** against `NotchReducer` (seed `9ba33d4117ef`).
...
- [ ] Evidence: `phase2/evidence/G-0196.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0197 (or finish at 1000)
