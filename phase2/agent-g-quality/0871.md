# [G-0871] QA: PII log redaction scan on ContextAssembler
...
As a **staff QA/security engineer**, apply **PII log redaction scan** against `ContextAssembler` (seed `1cfb74be1b96`).
...
- [ ] Evidence: `phase2/evidence/G-0871.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0872 (or finish at 1000)
