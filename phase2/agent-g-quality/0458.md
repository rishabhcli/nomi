# [G-0458] QA: regression fixture expansion on Coverage
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Coverage` (seed `b73512512d0e`).
...
- [ ] Evidence: `phase2/evidence/G-0458.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0459 (or finish at 1000)
