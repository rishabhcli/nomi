# [G-0408] QA: document error rate tracking on QueryService
...
As a **staff QA/security engineer**, apply **document error rate tracking** against `QueryService` (seed `15f001258ad1`).
...
- [ ] Evidence: `phase2/evidence/G-0408.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0409 (or finish at 1000)
