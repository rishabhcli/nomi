# [G-0866] QA: regression fixture expansion on Coverage
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `Coverage` (seed `77a3b84393da`).
...
- [ ] Evidence: `phase2/evidence/G-0866.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0867 (or finish at 1000)
