# [G-0205] QA: mutation testing mindset on EvidenceGathering
...
As a **staff QA/security engineer**, apply **mutation testing mindset** against `EvidenceGathering` (seed `460fa4671e82`).
...
- [ ] Evidence: `phase2/evidence/G-0205.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0206 (or finish at 1000)
