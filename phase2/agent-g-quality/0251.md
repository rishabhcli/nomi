# [G-0251] QA: use-case harness isolation on FollowUp
...
As a **staff QA/security engineer**, apply **use-case harness isolation** against `FollowUp` (seed `646b32506ea4`).
...
- [ ] Evidence: `phase2/evidence/G-0251.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0252 (or finish at 1000)
