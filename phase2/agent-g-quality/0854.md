# [G-0854] QA: regression fixture expansion on ContextAssembler
...
As a **staff QA/security engineer**, apply **regression fixture expansion** against `ContextAssembler` (seed `eefac8ff32a5`).
...
- [ ] Evidence: `phase2/evidence/G-0854.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0855 (or finish at 1000)
