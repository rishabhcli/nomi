# [G-0658] QA: test flake dection on TimeWindow
...
As a **staff QA/security engineer**, apply **test flake dection** against `TimeWindow` (seed `60c8ac882e32`).
...
- [ ] Evidence: `phase2/evidence/G-0658.md` with **raw** command output
- [ ] No `XCTAssertTrue(true)`; no batch automation scripts created
- [ ] Offline + loopback invariants preserved
- [ ] **Do not commit** — advance to G-0659 (or finish at 1000)
